...
Nadia's Stage-0, Stage-1, Stage-2, and Stage-3 console surfaces are metadata-only inside the Panel and do not launch an external host process or model runtime.
