...
Nadia's Stage-0, Stage-1, Stage-2, Stage-3, and Stage-4 console surfaces are metadata-only inside the Panel and do not launch an external host process or model runtime.
