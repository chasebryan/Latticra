...
impl LatticraConsoleConfig {
    ...
    pub fn validate(&self) -> Result<(), String> {
        ...
        let authority_labels = [
            ...
            (
                "LC services contract profile",
                self.services_contract_profile.as_str(),
            ),
            (
...
pub fn render_plan(config: &InstallerConfig) -> String {
    ...
    let _ = writeln!(
        ...
        config.lc.workspace_contract_profile
    );
    let _ = writeln!(out, "workspace_contract_status=metadata-only-contract");
    let _ = writeln!(out, "workspace_contract_present=1");
    let _ = writeln!(
        out,
        "namespace_contract_profile={}",
        config.lc.namespace_contract_profile
    );
    let _ = writeln!(out, "namespace_contract_status=metadata-only-contract");
    let _ = writeln!(out, "namespace_contract_present=1");
    let _ = writeln!(
        out,
    ...
    let _ = writeln!(
        ...
        config.lc.services_contract_profile
    );
    let _ = writeln!(out, "services_contract_status=metadata-only-contract");
    let _ = writeln!(out, "services_contract_present=1");
    let _ = writeln!(
        out,
    ...
    let _ = writeln!(
        ...
        config.lc.require_workspace_contract
    );
    let _ = writeln!(
        out,
        "namespace_contract_required={}",
        config.lc.require_namespace_contract
    );
    let _ = writeln!(
        out,
        "rootfs_contract_required={}",
        config.lc.require_rootfs_contract
    );
    let _ = writeln!(
        out,
    ...
    let _ = writeln!(
        ...
        config.lc.require_services_contract
    );
    let _ = writeln!(
        out,
        "service_schema_contract_required={}",
        config.lc.require_service_schema_contract
    );
    let _ = writeln!(
        out,
    ...
    let _ = writeln!(
        ...
        config.lc.require_service_runtime_contract
    );
    let _ = writeln!(
        out,
