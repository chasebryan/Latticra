...
impl LatticraInstallerApp {
    ...
    fn run_console_command(&mut self) {
        ...
        match parts.as_slice() {
            ...
            ["nadia"] | ["nadia", "status"] => {
                ...
                self.push_console(
                    "stage=19 tokenizer-manifest-contract; tokenizer_manifest_loaded=0 prompt_tokenized=0",
                );
                self.push_console(
    ...
    fn show_components(&mut self, ui: &mut egui::Ui) {
        ...
        checkbox_note(
            ...
            "Stage-19 tokenizer-manifest contract with metadata-only Console surfaces.",
        );
        checkbox_note(
            ui,
