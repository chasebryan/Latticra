...
static int default_request_is_stable(void) {
    ...
    EXPECT_TRUE(request.runtime_entry_recovery_audit_review_disposition_review_observation_view_request.
            requested_recovery_audit_review_disposition_review_observation_view_count == 4u,
...
static int recovery_audit_review_disposition_review_closeout_observation_view_is_metadata_only(void) {
    latticra_kernel_runtime_entry_recovery_audit_review_disposition_review_closeout_observation_view_request_t
        request;
    ...
    EXPECT_TRUE(strcmp(result.recovery_audit_review_disposition_review_closeout_observation_view_status,
    ...
    EXPECT_TRUE(strcmp(result.runtime_entry_recovery_audit_review_disposition_review_observation_view.
            recovery_audit_review_disposition_review_observation_view_status,
            "runtime-entry-recovery-audit-review-disposition-review-observation-view-seed-ready") == 0,
    ...
    EXPECT_TRUE(result.recovery_audit_review_disposition_review_closeout_observation_view_count == 4u,
    ...
    EXPECT_TRUE(result.host_effect_allowed == 0,
        "host effect denied");
    EXPECT_TRUE(result.evidence_level == 53u, "result evidence level");

    EXPECT_TRUE(strcmp(result.recovery_audit_review_disposition_review_closeout_observation_views[0].
            process_label, "kernel-report-process-metadata") == 0,
        "entry zero process");
    EXPECT_TRUE(strcmp(result.recovery_audit_review_disposition_review_closeout_observation_views[0].
            recovery_audit_review_disposition_review_closeout_observation_view_class,
            "kernel-report-runtime-entry-recovery-audit-review-disposition-review-closeout-observation-view") == 0,
        "entry zero class");
    EXPECT_TRUE(result.recovery_audit_review_disposition_review_closeout_observation_views[0].
    ...
    EXPECT_TRUE(result.recovery_audit_review_disposition_review_closeout_observation_views[0].
            recovery_audit_review_disposition_review_observation_view_token == 0ul,
    ...
    EXPECT_TRUE(result.recovery_audit_review_disposition_review_closeout_observation_views[0].
            recovery_audit_review_disposition_review_observation_slot == 19456ul,
    ...
    EXPECT_TRUE(result.recovery_audit_review_disposition_review_closeout_observation_views[0].
            recovery_audit_review_disposition_review_slot == 40ul,
    ...
    EXPECT_TRUE(result.recovery_audit_review_disposition_review_closeout_observation_views[0].
            recovery_audit_review_disposition_review_declared == 1,
        "recovery audit review disposition review declared");
    EXPECT_TRUE(result.recovery_audit_review_disposition_review_closeout_observation_views[0].
            recovery_audit_review_disposition_review_observation_declared == 1,
    ...
    EXPECT_TRUE(result.recovery_audit_review_disposition_review_closeout_observation_views[0].
            recovery_audit_review_disposition_review_planned == 0,
        "recovery audit review disposition review not planned");
    EXPECT_TRUE(result.recovery_audit_review_disposition_review_closeout_observation_views[0].
            recovery_audit_review_disposition_review_observation_planned == 0,
    ...
    EXPECT_TRUE(result.recovery_audit_review_disposition_review_closeout_observation_views[0].no_effect == 1,
        "entry no effect");
    EXPECT_TRUE(result.recovery_audit_review_disposition_review_closeout_observation_views[0].
            evidence_level == 53u,
...
static int recovery_audit_review_disposition_review_closeout_observation_view_caps_count(void) {
    latticra_kernel_runtime_entry_recovery_audit_review_disposition_review_closeout_observation_view_request_t
        request;
    latticra_kernel_runtime_entry_recovery_audit_review_disposition_review_closeout_observation_view_result_t
        result;
    ...
    request.requested_recovery_audit_review_disposition_review_closeout_observation_view_count = 99u;
    request.runtime_entry_recovery_audit_review_disposition_review_observation_view_request.
        requested_recovery_audit_review_disposition_review_observation_view_count = 99u;
    request.runtime_entry_recovery_audit_review_disposition_review_observation_view_request.
        runtime_entry_recovery_audit_review_disposition_observation_view_request.
    ...
    EXPECT_TRUE(result.recovery_audit_review_disposition_review_closeout_observation_view_count ==
    ...
    EXPECT_TRUE(strcmp(result.recovery_audit_review_disposition_review_closeout_observation_views[4].
            recovery_audit_review_disposition_review_closeout_observation_view_class,
            "reserved-runtime-entry-recovery-audit-review-disposition-review-closeout-observation-view") == 0,
        "reserved class");
    EXPECT_TRUE(result.recovery_audit_review_disposition_review_closeout_observation_views[4].
            recovery_audit_review_disposition_review_closeout_observation_view_token == 41004ul,
...
static int report_is_deterministic(void) {
    ...
    latticra_kernel_runtime_entry_recovery_audit_review_disposition_review_closeout_observation_view_result_t
        result;
    char report[
        LATTICRA_KERNEL_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_CLOSEOUT_OBSERVATION_VIEW_REPORT_MAX];
    ...
    EXPECT_TRUE(strstr(report,
        ...
        "report title");
    EXPECT_TRUE(strstr(report,
            "recovery_audit_review_disposition_review_closeout_observation_view_status=runtime-entry-recovery-audit-review-disposition-review-closeout-observation-view-seed-ready\n") != 0,
        "status emitted");
    EXPECT_TRUE(strstr(report,
            "runtime_entry_recovery_audit_review_disposition_review_observation_view_status=runtime-entry-recovery-audit-review-disposition-review-observation-view-seed-ready\n") != 0,
    ...
    EXPECT_TRUE(strstr(report, "evidence_level=53\n") != 0,
        "evidence emitted");
    EXPECT_TRUE(strstr(report,
            "recovery_audit_review_disposition_review_closeout_observation_view[0].recovery_audit_review_disposition_review_closeout_observation_slot=20480\n") != 0,
        "entry audit review disposition review observation slot emitted");
    EXPECT_TRUE(strstr(report,
            "recovery_audit_review_disposition_review_closeout_observation_view[0].recovery_audit_review_disposition_review_observation_slot=19456\n") != 0,
        "entry audit review disposition observation slot emitted");
    EXPECT_TRUE(strstr(report,
            "recovery_audit_review_disposition_review_closeout_observation_view[0].recovery_audit_review_observation_slot=17408\n") != 0,
        "entry audit review observation slot emitted");
    EXPECT_TRUE(strstr(report,
            "recovery_audit_review_disposition_review_closeout_observation_view[0].recovery_audit_review_disposition_review_closeout_slot=41\n") != 0,
        "entry audit review disposition review closeout slot emitted");
    EXPECT_TRUE(strstr(report,
            "recovery_audit_review_disposition_review_closeout_observation_view[0].recovery_audit_review_disposition_review_slot=40\n") != 0,
        "entry audit review disposition review slot emitted");
    EXPECT_TRUE(strstr(report,
            "recovery_audit_review_disposition_review_closeout_observation_view[0].recovery_audit_review_disposition_slot=39\n") != 0,
        "entry audit review disposition slot emitted");
    EXPECT_TRUE(strstr(report,
            "recovery_audit_review_disposition_review_closeout_observation_view[0].recovery_audit_review_slot=38\n") != 0,
        "entry audit review slot emitted");
    EXPECT_TRUE(strstr(report,
            "recovery_audit_review_disposition_review_closeout_observation_view[0].recovery_audit_review_disposition_review_closeout_declared=1\n") != 0,
        "entry audit review disposition review closeout declared emitted");
    EXPECT_TRUE(strstr(report,
            "recovery_audit_review_disposition_review_closeout_observation_view[0].recovery_audit_review_disposition_review_closeout_planned=0\n") != 0,
        "entry audit review disposition review closeout not planned emitted");
    EXPECT_TRUE(strstr(report,
            "recovery_audit_review_disposition_review_closeout_observation_view[0].recovery_audit_review_disposition_review_closeout_observation_allowed=0\n") != 0,
        "entry audit review disposition review observation denied emitted");
    EXPECT_TRUE(strstr(report,
            "recovery_audit_review_disposition_review_closeout_observation_view[0].recovery_audit_review_disposition_review_closeout_allowed=0\n") != 0,
        "entry audit review disposition review closeout denied emitted");
    EXPECT_TRUE(strstr(report,
            "recovery_audit_review_disposition_review_closeout_observation_view[0].recovery_audit_review_disposition_review_allowed=0\n") != 0,
        "entry audit review disposition review denied emitted");
    EXPECT_TRUE(strstr(report,
            "recovery_audit_review_disposition_review_closeout_observation_view[0].recovery_audit_review_disposition_review_observation_allowed=0\n") != 0,
        "entry audit review disposition observation denied emitted");
    EXPECT_TRUE(strstr(report,
            "recovery_audit_review_disposition_review_closeout_observation_view[0].recovery_audit_review_disposition_allowed=0\n") != 0,
        "entry audit review disposition denied emitted");
    EXPECT_TRUE(strstr(report,
            "recovery_audit_review_disposition_review_closeout_observation_view[0].recovery_audit_review_observation_allowed=0\n") != 0,
        "entry audit review observation denied emitted");
    EXPECT_TRUE(strstr(report,
            "recovery_audit_review_disposition_review_closeout_observation_view[0].no_effect=1\n") != 0,
...
int main(void) {
    ...
    if (recovery_audit_review_disposition_review_closeout_observation_view_is_metadata_only() != 0) {
        return 1;
    }
    if (recovery_audit_review_disposition_review_closeout_observation_view_caps_count() != 0) return 1;
    if (report_is_deterministic() != 0) return 1;
    if (null_guards_are_safe() != 0) return 1;

    puts("kernel_runtime_entry_recovery_audit_review_disposition_review_closeout_observation_view: ok");
    return 0;
}
