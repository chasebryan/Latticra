...
static int lat_pipeline_diagnostic_integration_reports_valid_pipeline(void) {
    ...
    EXPECT_TRUE(diagnostic.pipeline_span.start_line == 1u, "valid pipeline span line");
    EXPECT_TRUE(diagnostic.pipeline_span.start_column == 1u, "valid pipeline span column");
    ...
    EXPECT_TRUE(diagnostic.lowering_first_declaration_kind == LATTICRA_LAT_DECLARATION_STATE, "valid lowering first declaration kind");
    EXPECT_STR_EQ(diagnostic.lowering_first_declaration_name, "RootCell", "valid lowering first declaration name");
    EXPECT_STR_EQ(diagnostic.lowering_first_declaration_source, "", "valid lowering first declaration source");
    EXPECT_TRUE(diagnostic.lowering_first_declaration_parse_index == 0u, "valid lowering first declaration parse index");
    EXPECT_TRUE(diagnostic.lowering_first_declaration_first_clause_index == 0u, "valid lowering first declaration clause start");
    EXPECT_TRUE(diagnostic.lowering_first_declaration_clause_count == 9u, "valid lowering first declaration clause count");
    EXPECT_TRUE(diagnostic.lowering_first_declaration_source_index == LATTICRA_LAT_MODEL_NO_INDEX, "valid lowering first declaration source index");
    ...
    EXPECT_TRUE(strstr(report, "lowering_first_declaration_name=RootCell\n") != 0, "valid first declaration name report");
    EXPECT_TRUE(strstr(report, "lowering_first_declaration_source=\n") != 0, "valid first declaration source report");
    EXPECT_TRUE(strstr(report, "lowering_first_declaration_parse_index=0\n") != 0, "valid first declaration parse index report");
    EXPECT_TRUE(strstr(report, "lowering_first_declaration_first_clause_index=0\n") != 0, "valid first declaration clause start report");
    EXPECT_TRUE(strstr(report, "lowering_first_declaration_clause_count=9\n") != 0, "valid first declaration clause count report");
    EXPECT_TRUE(strstr(report, "lowering_first_declaration_source_index=") != 0, "valid first declaration source index report");
