...
static int lat_pipeline_diagnostic_integration_reports_valid_pipeline(void) {
    ...
    EXPECT_TRUE(latticra_lat_pipeline_diagnostics_evaluate(&pipeline, &semantic, &diagnostic) == LATTICRA_STATUS_OK, "valid diagnostic evaluate");
...
static int lat_pipeline_diagnostic_integration_reports_parse_failure(void) {
    ...
    EXPECT_TRUE(latticra_lat_pipeline_diagnostics_evaluate(&pipeline, &semantic, &diagnostic) == LATTICRA_STATUS_OK, "parse diagnostic evaluate");
...
static int lat_pipeline_diagnostic_integration_reports_semantic_failure(void) {
    ...
    EXPECT_TRUE(latticra_lat_pipeline_diagnostics_evaluate(&pipeline, &semantic, &diagnostic) == LATTICRA_STATUS_OK, "semantic diagnostic evaluate");
