...
require_contains 'The reset removes managed command wrappers, the Panel desktop entry, known Panel icons, and the guarded local prefix.' "$readme"
...
require_contains 'This is the guarded start-fresh path for new Panel specifications.' "$installer_readme"
