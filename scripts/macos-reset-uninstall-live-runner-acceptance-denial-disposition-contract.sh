...
usage() {
  cat <<'USAGE'
Usage:
  macos-reset-uninstall-live-runner-acceptance-denial-disposition-contract.sh

Emits the no-effect macOS reset/uninstall live-runner acceptance-denial
disposition contract. It records the reviewed closed-gate denial as stdout
...
reset_uninstall_live_runner_acceptance_denial_disposition_contract_status=ok
...
live_runner_acceptance_denial_disposition_source=macos-reset-uninstall-live-runner-acceptance-denial-review-contract
