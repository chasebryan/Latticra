...
require_contains 'request_freshness_status_added=1' "$status_file"
...
require_contains 'signed request status/workflow guard alignment' "$status_file"
require_contains 'sh scripts/test-latticra-seal-request-freshness-status.sh' .github/workflows/latticra-seal-request-freshness-status.yml
require_contains 'actions/checkout@34e114876b0b11c390a56381ad16ebd13914f8d5' .github/workflows/latticra-seal-request-freshness-status.yml
...
require_contains 'request_freshness_predecessor_parameter_schema_status_present=1' README.md
...
require_contains 'request freshness status record now ties that report-only freshness checkpoint to the guarded parameter schema status predecessor' README.md
...
require_contains 'Seal request freshness predecessor status alignment' STATUS.md
...
require_contains 'request_freshness_predecessor_parameter_schema_status_present=1' STATUS.md
...
require_contains 'request_freshness_predecessor_parameter_schema_status_present=1' docs/status/README.md
require_contains 'Latticra Seal request freshness status/public-entry alignment' docs/status/CURRENT_STATUS.md
require_contains 'Latticra Seal request freshness predecessor status alignment' docs/status/CURRENT_STATUS.md
...
require_contains 'Latticra Seal request freshness predecessor status alignment' docs/FOUNDATION_INDEX.md
require_contains 'Latticra Seal request freshness status/public-entry alignment' docs/project_notes/CURRENT_DIRECTION.md
require_contains 'Latticra Seal request freshness predecessor status alignment' docs/project_notes/CURRENT_DIRECTION.md
...
require_contains 'Latticra Seal request freshness predecessor status alignment' docs/project_notes/UPCOMING_WORK.md
