...
tmpdir="$(mktemp -d "${TMPDIR:-/tmp}/test-latticra-seal-runtime-gate.XXXXXX")"
...
cc $CFLAGS \
  ...
  -o "$tmpdir/latticra-seal-runtime-gate-invariants"

"$tmpdir/latticra-seal-runtime-gate-invariants"
