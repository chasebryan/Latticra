...
require_contains 'deterministic local report surface for the local capability registry schema' docs/LATTICRA_SEAL_LOCAL_CAPABILITY_REGISTRY_SCHEMA_IMPLEMENTATION.md
