...
standalone_service_runtime_report="$tmpdir/standalone-service-runtime.txt"
standalone_processes_report="$tmpdir/standalone-processes.txt"
...
lc_service_runtime_report="$tmpdir/lc-service-runtime.txt"
lc_processes_report="$tmpdir/lc-processes.txt"
...
grep -Fq 'service_runtime_contract_profile = "lc-service-runtime-v0"' installer/configs/lc-standalone.installer.toml
grep -Fq 'processes_contract_profile = "lc-processes-v0"' installer/configs/lc-standalone.installer.toml
grep -Fq 'require_processes_contract = true' installer/configs/lc-standalone.installer.toml
...
grep -Fq 'LC_REQUIRE_PROCESSES_CONTRACT=$(cfg_section lc require_processes_contract true)' installer/scripts/latticra-installer-apply.sh
...
grep -Fq 'service_runtime_contract_present=1' "$plan"
grep -Fq 'processes_contract_present=1' "$plan"
...
grep -Fq 'lc_service_runtime_contract_present=true' "$receipt_dir/latest-receipt.txt"
grep -Fq 'lc_processes_contract_present=true' "$receipt_dir/latest-receipt.txt"
...
grep -Fq 'service_runtime_contract_present=1' "$standalone_plan"
grep -Fq 'processes_contract_present=1' "$standalone_plan"
...
grep -Fq 'lc_service_runtime_contract_present=true' "$standalone_receipts/latest-receipt.txt"
grep -Fq 'lc_processes_contract_present=true' "$standalone_receipts/latest-receipt.txt"
grep -Fq 'lc_rootfs_contract_present=true' "$standalone_receipts/latest-receipt.txt"
...
test -f "$standalone_prefix/share/latticra/lc/services/runtime.toml"
test -f "$standalone_prefix/share/latticra/lc/processes/contract.toml"
...
grep -Fq 'service_runtime_contract_present=1' "$standalone_local_plan"
grep -Fq 'processes_contract_present=1' "$standalone_local_plan"
...
grep -Fq 'lc_service_runtime_contract_present=true' "$standalone_local_receipts/latest-receipt.txt"
grep -Fq 'lc_processes_contract_present=true' "$standalone_local_receipts/latest-receipt.txt"
...
grep -Fq 'service_runtime_contract_profile = "lc-service-runtime-v0"' "$standalone_prefix/share/latticra/lc/install/config.toml"
grep -Fq 'service_runtime_contract_present = true' "$standalone_prefix/share/latticra/lc/install/config.toml"
grep -Fq 'processes_contract_profile = "lc-processes-v0"' "$standalone_prefix/share/latticra/lc/install/config.toml"
grep -Fq 'processes_contract_present = true' "$standalone_prefix/share/latticra/lc/install/config.toml"
...
grep -Fq 'name=lc service-runtime category=core effect=none capability=lc.service.runtime.contract' "$standalone_prefix/share/latticra/lc/commands/seed-registry.txt"
grep -Fq 'name=lc processes category=core effect=none capability=lc.processes.contract' "$standalone_prefix/share/latticra/lc/commands/seed-registry.txt"
...
grep -Fq 'command_surface = "lc service-runtime"' "$standalone_prefix/share/latticra/lc/services/runtime.toml"
grep -Fq 'command_surface = "lc processes"' "$standalone_prefix/share/latticra/lc/processes/contract.toml"
grep -Fq 'process_spawn_allowed = false' "$standalone_prefix/share/latticra/lc/processes/contract.toml"
grep -Fq 'process_supervision_allowed = false' "$standalone_prefix/share/latticra/lc/processes/contract.toml"
grep -Fq 'host_process_launch_allowed = false' "$standalone_prefix/share/latticra/lc/processes/contract.toml"
...
HOME="$standalone_home" "$standalone_home/.local/bin/latticra-lc" service-runtime > "$standalone_service_runtime_report"
HOME="$standalone_home" "$standalone_home/.local/bin/latticra-lc" processes > "$standalone_processes_report"
...
grep -Fq 'service_runtime_contract_present=1' "$standalone_lc_report"
grep -Fq 'processes_contract_present=1' "$standalone_lc_report"
...
grep -Fq 'LATTICRA CONSOLE SERVICE RUNTIME CONTRACT' "$standalone_service_runtime_report"
grep -Fq 'service_runtime_profile=lc-service-runtime-v0' "$standalone_service_runtime_report"
grep -Fq 'service_runtime_file=runtime.toml' "$standalone_service_runtime_report"
grep -Fq 'service_runtime_handoff_allowed=0' "$standalone_service_runtime_report"
grep -Fq 'service_executor_allowed=0' "$standalone_service_runtime_report"
grep -Fq 'service_supervision_allowed=0' "$standalone_service_runtime_report"
grep -Fq 'command_surface=lc service-runtime' "$standalone_service_runtime_report"
grep -Fq 'host_process_launch_allowed=0' "$standalone_service_runtime_report"
grep -Fq 'LATTICRA CONSOLE PROCESSES CONTRACT' "$standalone_processes_report"
grep -Fq 'processes_profile=lc-processes-v0' "$standalone_processes_report"
grep -Fq 'processes_file=contract.toml' "$standalone_processes_report"
grep -Fq 'process_table_present=0' "$standalone_processes_report"
grep -Fq 'process_spawn_allowed=0' "$standalone_processes_report"
grep -Fq 'process_signal_allowed=0' "$standalone_processes_report"
grep -Fq 'process_supervision_allowed=0' "$standalone_processes_report"
grep -Fq 'command_surface=lc processes' "$standalone_processes_report"
grep -Fq 'host_process_launch_allowed=0' "$standalone_processes_report"
...
test -f "$prefix/share/latticra/lc/services/runtime.toml"
...
grep -Fq 'service_runtime_contract_present = true' "$prefix/share/latticra/lc/install/config.toml"
grep -Fq 'command_surface = "lc service-runtime"' "$prefix/share/latticra/lc/services/runtime.toml"
grep -Fq 'processes_contract_present = true' "$prefix/share/latticra/lc/install/config.toml"
grep -Fq 'command_surface = "lc processes"' "$prefix/share/latticra/lc/processes/contract.toml"
...
grep -Fq 'name=lc service-runtime category=core effect=none capability=lc.service.runtime.contract' "$prefix/share/latticra/lc/commands/seed-registry.txt"
grep -Fq 'name=lc processes category=core effect=none capability=lc.processes.contract' "$prefix/share/latticra/lc/commands/seed-registry.txt"
...
grep -Fq 'lc_service_runtime_contract_present=true' "$live_receipts/latest-receipt.txt"
grep -Fq 'lc_processes_contract_present=true' "$live_receipts/latest-receipt.txt"
...
HOME="$home" "$home/.local/bin/$lc_wrapper" service-runtime > "$lc_service_runtime_report"
HOME="$home" "$home/.local/bin/$lc_wrapper" processes > "$lc_processes_report"
...
grep -Fq 'service_runtime_contract_present=1' "$lc_report"
grep -Fq 'processes_contract_present=1' "$lc_report"
...
grep -Fq "  $lc_wrapper service-runtime" "$lc_man"
grep -Fq "  $lc_wrapper processes" "$lc_man"
...
grep -Fq 'LATTICRA CONSOLE SERVICE RUNTIME CONTRACT' "$lc_service_runtime_report"
grep -Fq 'command_surface=lc service-runtime' "$lc_service_runtime_report"
grep -Fq 'service_runtime_handoff_allowed=0' "$lc_service_runtime_report"
grep -Fq 'service_executor_allowed=0' "$lc_service_runtime_report"
grep -Fq 'service_supervision_allowed=0' "$lc_service_runtime_report"
grep -Fq 'LATTICRA CONSOLE PROCESSES CONTRACT' "$lc_processes_report"
grep -Fq 'command_surface=lc processes' "$lc_processes_report"
grep -Fq 'process_table_present=0' "$lc_processes_report"
grep -Fq 'process_spawn_allowed=0' "$lc_processes_report"
grep -Fq 'process_supervision_allowed=0' "$lc_processes_report"
...
grep -Fq 'ok: LC service runtime registry command' "$verify_log"
grep -Fq 'ok: LC processes registry command' "$verify_log"
...
grep -Fq 'ok: LC wrapper service runtime report' "$verify_log"
grep -Fq 'ok: LC wrapper processes report' "$verify_log"
