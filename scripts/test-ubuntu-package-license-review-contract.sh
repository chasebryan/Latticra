...
require_contains 'candidate_source_package_license=AGPL-3.0-or-later AND Apache-2.0 AND CC-BY-4.0' "$contract"
require_contains 'candidate_expression_applied_to_packaging=1' "$contract"
