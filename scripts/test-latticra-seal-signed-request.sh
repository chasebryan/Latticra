...
tmpdir="$(mktemp -d "${TMPDIR:-/tmp}/test-latticra-seal-signed-request.XXXXXX")"
...
cc $CFLAGS \
  ...
  -o "$tmpdir/latticra-seal-signed-request-invariants"

"$tmpdir/latticra-seal-signed-request-invariants"
