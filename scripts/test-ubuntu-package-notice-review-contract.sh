...
require_contains 'Status: no-effect notice review contract' "$contract"
...
require_contains 'ubuntu_package_notice_review_status=blocked-pending-notice-review' "$contract"
require_contains 'ubuntu_package_notice_inventory_present=1' "$contract"
require_contains 'ubuntu_package_notice_inventory_report_present=1' "$contract"
require_contains 'ubuntu_doc_payload_license_review_contract_present=1' "$contract"
require_contains 'ubuntu_doc_payload_license_review_status=resolved-cc-by-4.0' "$contract"
...
require_contains 'Broader notice obligations remain blocked until the package notice review is promoted.' "$license_contract"
