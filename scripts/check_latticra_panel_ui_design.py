...
checks = [
    ...
    (ui, 'First-run path', 'dashboard first-run path'),
    (ui, 'Primary actions', 'plain-language primary action panel'),
    (ui, "fn local_write_status_label(dry_run: bool, guarded_local_ack: bool) -> &'static str", 'readable local-write status labels'),
