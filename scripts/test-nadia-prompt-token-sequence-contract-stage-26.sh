...
require_contains 'Stage-26 can define future context-window assembly review requirements' "$foundation"
require_contains 'Stage-27 can define future prompt-evaluation-input review requirements' "$foundation"
