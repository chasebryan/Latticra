...
Options:
  ...
  --disposition-family <label>                              Planned release receipt review disposition family label
  --disposition-format <label>                              Planned release receipt review disposition format label
...
disposition contract metadata only. It verifies the Stage-36 release receipt
review contract and records future disposition-release requirements before
any review-disposition record, disposition decision, disposition findings,
receipt signing, receipt publication, model-output recording, runtime
invocation, prompt evaluation, dialogue generation, token generation,
inference, tool execution, source mutation, training, distillation, download,
or network use.
USAGE
}
...
require_field stage 36-prompt-evaluation-result-release-receipt-review-contract "release receipt review prerequisite stage must be Stage-36"
require_field prompt_evaluation_result_release_receipt_review_contract_status contract_only "release receipt review prerequisite must remain contract-only"
require_field prompt_evaluation_result_release_receipt_review_stage contract-only "release receipt review prerequisite stage must remain contract-only"
require_field prompt_evaluation_result_release_receipt_review_authority 0 "release receipt review authority must remain denied"
require_field prompt_evaluation_result_release_receipt_review_allowed 0 "release receipt review must remain disallowed"
require_field prompt_evaluation_result_release_receipt_review_recorded 0 "release receipt review must not be recorded"
require_field prompt_evaluation_result_release_receipt_review_created 0 "release receipt review must not be created"
require_field prompt_evaluation_result_release_receipt_review_performed 0 "release receipt review must not be performed"
require_field prompt_evaluation_result_release_receipt_review_metadata_present 1 "release receipt review metadata must be present"
require_field prompt_evaluation_result_release_receipt_review_decision blocked_contract_only "release receipt review decision must remain blocked"
require_field prompt_evaluation_result_release_receipt_review_evidence_present 1 "release receipt review evidence must be present"
require_field prompt_evaluation_result_release_receipt_review_plan_recorded 1 "release receipt review plan must be recorded"
require_field prompt_evaluation_result_release_receipt_review_result_recorded 0 "release receipt review result must remain absent"
require_field prompt_evaluation_result_release_receipt_review_runtime_invoked 0 "release receipt review runtime must not be invoked"
require_field requires_prompt_evaluation_result_release_receipt_contract 1 "release receipt contract must be required"
require_field requires_future_prompt_evaluation_result_release_receipt_review_disposition_contract 1 "future release receipt review disposition contract must be required"
...
require_field prompt_evaluation_result_release_receipt_review_decision_recorded 0 "release receipt review decision must not be recorded"
require_field prompt_evaluation_result_release_receipt_review_findings_recorded 0 "release receipt review findings must not be recorded"
require_field prompt_evaluation_result_release_receipt_review_applied 0 "release receipt review disposition must not be applied"
require_field prompt_evaluation_result_release_receipt_record_created 0 "release receipt record must not be created"
require_field prompt_evaluation_result_release_receipt_signed 0 "release receipt must not be signed"
require_field prompt_evaluation_result_release_receipt_published 0 "release receipt must not be published"
