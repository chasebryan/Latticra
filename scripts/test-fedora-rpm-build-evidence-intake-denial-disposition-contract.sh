...
fail() {
  printf 'fedora rpm build-evidence intake denial disposition contract: %s\n' "$1" >&2
  exit 1
}
...
doc='docs/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CONTRACT.md'
status='docs/status/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CONTRACT_STATUS.md'
index='docs/status/README.md'
docs_readme='docs/README.md'
readme='README.md'
packaging_readme='packaging/fedora/README.md'
test_script='scripts/test-fedora-rpm-build-evidence-intake-denial-disposition-contract.sh'
workflow='.github/workflows/fedora-rpm-build-evidence-intake-denial-disposition-contract.yml'
...
require_contains 'Status: active RPM build-evidence intake denial disposition contract' "$doc"
...
require_contains 'Status: rpm-build-evidence-intake-denial-disposition/status alignment' "$status"
...
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_contract_present=1' "$closeout_doc"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_contract_present=1' "$closeout_status"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_contract_present=1' "$closeout_test"
...
require_contains 'FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CONTRACT_STATUS.md' "$index"
require_contains 'Current Fedora RPM build-evidence intake denial disposition contract checkpoint' "$index"
require_contains 'The Fedora RPM build-evidence intake denial disposition contract is present and closes the upheld denied intake state while re-request authority remains closed' "$index"

require_contains 'FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CONTRACT.md' "$docs_readme"
require_contains 'docs/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CONTRACT.md' "$readme"
require_contains 'docs/status/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CONTRACT_STATUS.md' "$readme"
require_contains 'The Fedora RPM build-evidence intake denial disposition contract is present' "$readme"

require_contains 'docs/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CONTRACT.md' "$packaging_readme"
require_contains 'scripts/test-fedora-rpm-build-evidence-intake-denial-disposition-contract.sh' "$packaging_readme"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_contract_present=1' "$packaging_readme"
require_contains 'build_evidence_intake_denial_disposition_state=closed-upheld-no-effect' "$packaging_readme"
...
require_contains 'Add a Fedora RPM build-evidence intake denial disposition closeout archive gate review disposition closeout archive gate review contract before any reviewed archive gate disposition closeout archive gate can be relaxed or re-requested.' "$review_doc"
require_contains 'Add a Fedora RPM build-evidence intake denial disposition closeout archive gate review disposition closeout archive gate review contract before any reviewed archive gate disposition closeout archive gate can be relaxed or re-requested.' "$review_status"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_contract_present=1' "$matrix_script"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_contract_present=1' "$matrix_status"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_contract_present=1' "$matrix_test"
...
require_contains 'name: Fedora RPM Build Evidence Intake Denial Disposition Contract' "$workflow"
...
require_contains 'sh scripts/test-fedora-rpm-build-evidence-intake-denial-disposition-contract.sh' "$workflow"
...
printf 'fedora_rpm_build_evidence_intake_denial_disposition_contract: ok\n'
