...
usage() {
  cat <<'USAGE'
Usage:
  macos-reset-uninstall-live-runner-acceptance-denial-disposition-review-contract.sh

Emits the no-effect macOS reset/uninstall live-runner acceptance-denial
disposition review contract. It reviews the recorded no-effect disposition as
...
reset_uninstall_live_runner_acceptance_denial_disposition_review_contract_status=ok
...
live_runner_acceptance_denial_disposition_review_source=macos-reset-uninstall-live-runner-acceptance-denial-disposition-contract
live_runner_acceptance_denial_disposition_review_source_contract=macos-reset-uninstall-live-runner-acceptance-denial-disposition-contract
...
live_runner_acceptance_denial_disposition_review_disposition_decision=closed-gate-denial-disposed-no-dispatch
...
live_runner_acceptance_denial_disposition_review_disposition_requires_future_review=1
