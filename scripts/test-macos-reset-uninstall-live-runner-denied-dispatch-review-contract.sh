...
require_contains 'next_lane=macos-reset-uninstall-live-runner-acceptance-gate-contract' "$transcript_script"
require_contains 'Add a macOS reset/uninstall live-runner acceptance-gate contract that requires passed preflight, complete evidence, and explicit effect authorization before dispatch.' "$transcript_doc"
