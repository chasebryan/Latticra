...
require_contains 'Add a macOS reset/uninstall live-runner acceptance-denial review contract that reviews the closed gate transcript without enabling dispatch or deletion.' "$doc"
...
require_contains 'next_lane=macos-reset-uninstall-live-runner-acceptance-denial-review-contract' "$transcript_script"
require_contains 'Add a macOS reset/uninstall live-runner acceptance-denial review contract that reviews the closed gate transcript without enabling dispatch or deletion.' "$transcript_doc"
