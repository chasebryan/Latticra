...
require_contains 'Status: runtime boundary refinement implementation with Lat pipeline span and comment evidence' docs/RUNTIME_BOUNDARY_REFINEMENT_IMPLEMENTATION.md
