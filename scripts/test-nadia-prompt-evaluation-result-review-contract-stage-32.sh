...
require_contains '| Nadia offline AI foundation | 73% |' "$readme"
...
require_contains '| Nadia offline AI foundation | 73% |' "$root_status"
require_contains '| Nadia offline AI foundation | 73% |' "$current_status"
...
require_contains 'stage=39-prompt-evaluation-result-release-receipt-review-disposition-release-receipt-contract' "$apply_script"
require_contains 'stage=39-prompt-evaluation-result-release-receipt-review-disposition-release-receipt-contract' "$panel_config"
