...
require_contains '| Nadia offline AI foundation | 69% |' "$readme"
...
require_contains '| Nadia offline AI foundation | 69% |' "$root_status"
require_contains '| Nadia offline AI foundation | 69% |' "$current_status"
...
require_contains 'Stage-31, Stage-32, Stage-33, Stage-34, and Stage-35 console surfaces are metadata-only' "$ui_model"
...
require_contains 'stage=35-prompt-evaluation-result-release-receipt-contract' "$apply_script"
require_contains 'stage=35-prompt-evaluation-result-release-receipt-contract' "$panel_config"
