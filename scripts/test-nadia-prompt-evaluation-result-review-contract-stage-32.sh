...
require_contains '| Nadia offline AI foundation | 70% |' "$readme"
...
require_contains '| Nadia offline AI foundation | 70% |' "$root_status"
require_contains '| Nadia offline AI foundation | 70% |' "$current_status"
...
require_contains 'stage=36-prompt-evaluation-result-release-receipt-review-contract' "$apply_script"
require_contains 'stage=36-prompt-evaluation-result-release-receipt-review-contract' "$panel_config"
