...
grep -Fq 'queue[0].process_label=kernel-report-process-metadata' "$report_txt"
grep -Fq 'queue[0].scheduler_slot_label=kernel-report-metadata' "$report_txt"
grep -Fq 'queue[0].queue_class=kernel-report-run-queue-entry' "$report_txt"
