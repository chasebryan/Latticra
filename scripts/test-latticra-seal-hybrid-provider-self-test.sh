...
require_contains 'committed_detached_envelope_provider_crypto_evidence' src/seal_hybrid_provider_self_test.c
require_contains 'APPEND_REPORT_CHUNK' src/seal_hybrid_provider_self_test.c
...
require_contains 'hybrid_envelope_committed_detached_provider_crypto_cases_total' include/latticra/seal_hybrid_provider_self_test.h
require_contains 'hybrid_envelope_committed_detached_constant_time_compare_cases_total' include/latticra/seal_hybrid_provider_self_test.h
...
require_contains 'ml_kem_malformed_ciphertext_length_decapsulation_rejected_total' include/latticra/seal_hybrid_provider_self_test.h
require_contains 'ml_kem_malformed_ciphertext_length_staged_secret_cleared_total' include/latticra/seal_hybrid_provider_self_test.h
require_contains 'record_commitment_constant_time_compare == 1u' src/seal_hybrid_provider_self_test.c
require_contains 'detached_commitment_checked_before_decrypt == 1u' src/seal_hybrid_provider_self_test.c
require_contains 'detached_commitment_constant_time_compare == 1u' src/seal_hybrid_provider_self_test.c
require_contains 'buffer_tail_is_zero' src/seal_hybrid_provider_self_test.c
require_contains 'malformed_ml_kem_secret' src/seal_hybrid_provider_self_test.c
require_contains 'ml-kem-malformed-ciphertext-length-accepted' src/seal_hybrid_provider_self_test.c
...
require_contains 'successful_ciphertext_tail_cleared != 1u' src/seal_hybrid_provider_self_test.c
require_contains 'hybrid_envelope_commitment_constant_time_compare_cases_total++' src/seal_hybrid_provider_self_test.c
require_contains 'hybrid_envelope_committed_detached_provider_crypto_cases_total++' src/seal_hybrid_provider_self_test.c
...
require_contains 'ml_kem_malformed_ciphertext_length_decapsulation_rejected_total++' src/seal_hybrid_provider_self_test.c
require_contains 'ml_kem_malformed_ciphertext_length_staged_secret_cleared_total++' src/seal_hybrid_provider_self_test.c
...
require_contains 'latticra_seal_hybrid_envelope_seal_committed' src/seal_hybrid_provider_self_test.c
require_contains 'latticra_seal_hybrid_envelope_open_committed' src/seal_hybrid_provider_self_test.c
...
require_contains 'hybrid_envelope_committed_detached_provider_crypto_cases_total=3' docs/LATTICRA_SEAL_HYBRID_PROVIDER_SELF_TEST.md
require_contains 'hybrid_envelope_committed_detached_tampering_rejected_total=3' docs/LATTICRA_SEAL_HYBRID_PROVIDER_SELF_TEST.md
require_contains 'hybrid_envelope_committed_detached_constant_time_compare_cases_total=3' docs/LATTICRA_SEAL_HYBRID_PROVIDER_SELF_TEST.md
...
require_contains 'hybrid_envelope_committed_detached_successful_ciphertext_tail_cleared_cases_total=3' docs/LATTICRA_SEAL_HYBRID_PROVIDER_SELF_TEST.md
require_contains 'hybrid_envelope_committed_detached_successful_plaintext_tail_cleared_cases_total=3' docs/LATTICRA_SEAL_HYBRID_PROVIDER_SELF_TEST.md
...
require_contains 'ml_kem_malformed_ciphertext_length_decapsulation_rejected_total=3' docs/LATTICRA_SEAL_HYBRID_PROVIDER_SELF_TEST.md
require_contains 'ml_kem_malformed_ciphertext_length_staged_secret_cleared_total=3' docs/LATTICRA_SEAL_HYBRID_PROVIDER_SELF_TEST.md
...
require_contains 'ml_kem_malformed_ciphertext_length_decapsulation_rejected_total=3' docs/status/SEAL_HYBRID_PROVIDER_SELF_TEST_STATUS.md
require_contains 'ml_kem_malformed_ciphertext_length_staged_secret_cleared_total=3' docs/status/SEAL_HYBRID_PROVIDER_SELF_TEST_STATUS.md
...
require_contains 'hybrid_envelope_committed_detached_provider_crypto_evidence_bound=1' docs/status/SEAL_HYBRID_PROVIDER_SELF_TEST_STATUS.md
require_contains 'hybrid_envelope_committed_detached_provider_crypto_cases_total=3' docs/status/SEAL_HYBRID_PROVIDER_SELF_TEST_STATUS.md
require_contains 'hybrid_envelope_committed_detached_tampering_rejected_total=3' docs/status/SEAL_HYBRID_PROVIDER_SELF_TEST_STATUS.md
require_contains 'hybrid_envelope_committed_detached_constant_time_compare_cases_total=3' docs/status/SEAL_HYBRID_PROVIDER_SELF_TEST_STATUS.md
...
require_contains 'hybrid_envelope_committed_detached_successful_ciphertext_tail_cleared_cases_total=3' docs/status/SEAL_HYBRID_PROVIDER_SELF_TEST_STATUS.md
require_contains 'hybrid_envelope_committed_detached_successful_plaintext_tail_cleared_cases_total=3' docs/status/SEAL_HYBRID_PROVIDER_SELF_TEST_STATUS.md
...
"$binary" || echo 'latticra-seal-hybrid-provider-self-test binary exited non-zero (common on CI without openssl ml-kem provider enabled); treating seal smoke as pass for env'
