...
require_file() {
  file="$1"
  if [ ! -f "$file" ]; then
    printf 'latticra seal panel dashboard view model implementation plan status: missing file: %s\n' "$file" >&2
    exit 1
  fi
}
...
require_contains() {
  ...
  if ! grep -Fq -- "$pattern" "$file"; then
    printf 'latticra seal panel dashboard view model implementation plan status: missing required pattern in %s: %s\n' "$file" "$pattern" >&2
    exit 1
  fi
}

status_file="docs/status/SEAL_PANEL_DASHBOARD_VIEW_MODEL_IMPLEMENTATION_PLAN_STATUS.md"
plan="docs/LATTICRA_SEAL_PANEL_DASHBOARD_VIEW_MODEL_IMPLEMENTATION_PLAN.md"
contract_status="docs/status/SEAL_PANEL_DASHBOARD_VIEW_MODEL_CONTRACT_STATUS.md"
...
require_file scripts/test-latticra-seal-panel-dashboard-view-model-implementation-plan.sh
...
require_file .github/workflows/latticra-seal-panel-dashboard-view-model-implementation-plan-status.yml

require_contains 'Status: status record for the Latticra Seal Panel dashboard view-model implementation plan' "$status_file"
require_contains 'seal_panel_dashboard_view_model_implementation_plan_present=1' "$status_file"
require_contains 'seal_panel_dashboard_view_model_implementation_plan_status_present=1' "$status_file"
require_contains 'seal_panel_dashboard_view_model_predecessor_contract_status_present=1' "$status_file"
require_contains 'seal_panel_dashboard_view_model_plan_profile=latticra-seal-panel-dashboard-view-model-implementation-plan/0.1' "$status_file"
require_contains 'seal_panel_dashboard_view_model_profile=latticra-seal-panel-dashboard-view-model/0.1' "$status_file"
require_contains 'seal_panel_dashboard_view_model_mode=implementation-plan-only' "$status_file"
...
require_contains 'view_model_source_count_max=16' "$status_file"
...
require_contains 'deterministic_fixture_planned=1' "$status_file"
require_contains 'bounded_key_value_scan_planned=1' "$status_file"
...
require_contains 'seal_panel_dashboard_view_model_implementation_plan_present=1' README.md
require_contains 'seal_panel_dashboard_view_model_implementation_plan_status_present=1' README.md
require_contains 'panel_dashboard_view_model_implementation_plan_predecessor_contract_status_present=1' README.md
require_contains 'docs/LATTICRA_SEAL_PANEL_DASHBOARD_VIEW_MODEL_IMPLEMENTATION_PLAN.md' README.md
require_contains 'docs/status/SEAL_PANEL_DASHBOARD_VIEW_MODEL_IMPLEMENTATION_PLAN_STATUS.md' README.md
require_contains 'Latest Seal Panel dashboard view-model implementation plan note: 2026-05-27 CDT' STATUS.md
require_contains 'Latest Seal Panel dashboard view-model implementation plan note: 2026-05-27 CDT' docs/status/CURRENT_STATUS.md
require_contains 'panel_dashboard_view_model_implementation_plan_present=1' STATUS.md
require_contains 'panel_dashboard_view_model_implementation_plan_status_present=1' docs/status/CURRENT_STATUS.md
require_contains 'LATTICRA_SEAL_PANEL_DASHBOARD_VIEW_MODEL_IMPLEMENTATION_PLAN.md' docs/FOUNDATION_INDEX.md
require_contains 'SEAL_PANEL_DASHBOARD_VIEW_MODEL_IMPLEMENTATION_PLAN_STATUS.md' docs/status/README.md
require_contains 'Latticra Seal Panel dashboard view-model implementation plan' docs/project_notes/CURRENT_DIRECTION.md
require_contains 'Latticra Seal Panel dashboard view-model implementation plan' docs/project_notes/UPCOMING_WORK.md
require_contains 'docs/status/SEAL_PANEL_DASHBOARD_VIEW_MODEL_IMPLEMENTATION_PLAN_STATUS.md' docs/project_notes/README.md
...
printf 'latticra seal panel dashboard view model implementation plan status: ok\n'
