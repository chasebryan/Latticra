...
require_contains 'final_state=timer-source-ready' docs/status/KERNEL_LIFECYCLE_EVIDENCE_STATUS.md
...
require_contains 'final_state=timer-source-ready' docs/status/README.md
