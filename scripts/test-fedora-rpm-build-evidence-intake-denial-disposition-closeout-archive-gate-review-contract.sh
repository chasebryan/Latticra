...
fail() {
  printf 'fedora rpm build-evidence intake denial disposition closeout archive gate review contract: %s\n' "$1" >&2
  exit 1
}
...
doc='docs/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_CONTRACT.md'
status='docs/status/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_CONTRACT_STATUS.md'
index='docs/status/README.md'
docs_readme='docs/README.md'
readme='README.md'
packaging_readme='packaging/fedora/README.md'
test_script='scripts/test-fedora-rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-contract.sh'
workflow='.github/workflows/fedora-rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-contract.yml'
review_disposition_doc='docs/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CONTRACT.md'
review_disposition_status='docs/status/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CONTRACT_STATUS.md'
review_disposition_test='scripts/test-fedora-rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-contract.sh'
review_disposition_workflow='.github/workflows/fedora-rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-contract.yml'
...
for file in \
  ...
  "$test_script" \
  "$workflow" \
  "$review_disposition_doc" \
  "$review_disposition_status" \
  "$review_disposition_test" \
  "$review_disposition_workflow" \
  "$archive_gate_doc" \
  "$archive_gate_status" \
  "$archive_gate_test" \
...
require_contains 'Status: active RPM build-evidence intake denial disposition closeout archive gate review contract' "$doc"
require_contains 'documentation-only and static' "$doc"
require_contains 'write archive records' "$doc"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_contract_present=1' "$doc"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_contract_present=1' "$doc"
require_contains 'rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_contract_present=1' "$doc"
...
require_contains 'denial_archive_gate_review_decision=uphold-closed-archive-gate' "$doc"
require_contains 'denial_archive_gate_present=1' "$doc"
require_contains 'denial_archive_gate_state=closed-no-effect' "$doc"
require_contains 'denial_archive_gate_decision=deny-archive-and-re-request' "$doc"
...
for review_field in \
  'denial_archive_gate_review_identifier' \
  ...
  'denial_archive_gate_review_decision' \
  'denial_archive_gate_review_reason' \
  'denial_archive_gate_review_reviewer' \
...
require_contains 'Status: rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review/status alignment' "$status"
require_contains 'Date: 2026-05-28' "$status"
require_contains 'archive gate review upholds the closed Fedora build-evidence intake denial archive gate' "$status"
...
require_contains 'FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_CONTRACT_STATUS.md' "$index"
require_contains 'Current Fedora RPM build-evidence intake denial disposition closeout archive gate review contract checkpoint' "$index"
require_contains 'The Fedora RPM build-evidence intake denial disposition closeout archive gate review contract is present and upholds the closed archive gate while archive-record writes and re-request authority remain closed' "$index"

require_contains 'FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_CONTRACT.md' "$docs_readme"
require_contains 'docs/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_CONTRACT.md' "$readme"
require_contains 'docs/status/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_CONTRACT_STATUS.md' "$readme"
require_contains 'The Fedora RPM build-evidence intake denial disposition closeout archive gate review contract is present' "$readme"

require_contains 'docs/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_CONTRACT.md' "$packaging_readme"
require_contains 'scripts/test-fedora-rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-contract.sh' "$packaging_readme"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_contract_present=1' "$packaging_readme"
require_contains 'build_evidence_intake_denial_disposition_closeout_archive_gate_review_state=reviewed-upheld-no-effect' "$packaging_readme"
require_contains 'denial_archive_gate_review_present=1' "$packaging_readme"
require_contains 'denial_archive_gate_review_decision=uphold-closed-archive-gate' "$packaging_readme"

require_contains "$doc" "$archive_gate_doc"
require_contains "$doc" "$archive_gate_status"
require_contains "$test_script" "$archive_gate_doc"
require_contains "$workflow" "$archive_gate_doc"
require_contains "$review_disposition_doc" "$doc"
require_contains "$review_disposition_status" "$doc"
require_contains "$review_disposition_test" "$doc"
require_contains "$review_disposition_workflow" "$doc"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_contract_present=1' "$review_disposition_doc"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_contract_present=1' "$review_disposition_status"
require_contains 'Add a Fedora RPM build-evidence intake denial disposition closeout archive gate review disposition closeout archive gate review contract before any reviewed archive gate disposition closeout archive gate can be relaxed or re-requested.' "$archive_gate_doc"
require_contains 'Add a Fedora RPM build-evidence intake denial disposition closeout archive gate review disposition closeout archive gate review contract before any reviewed archive gate disposition closeout archive gate can be relaxed or re-requested.' "$archive_gate_status"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_contract_present=1' "$archive_gate_test"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_contract_present=1' "$matrix"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_contract_present=1' "$matrix_script"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_contract_present=1' "$matrix_status"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_contract_present=1' "$matrix_test"
...
require_contains 'name: Fedora RPM Build Evidence Intake Denial Disposition Closeout Archive Gate Review Contract' "$workflow"
...
require_contains 'sh scripts/test-fedora-rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-contract.sh' "$workflow"
...
printf 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_contract: ok\n'
