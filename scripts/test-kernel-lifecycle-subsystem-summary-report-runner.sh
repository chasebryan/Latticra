...
grep -Fq 'final_state=run-queue-ready' "$report_txt"
...
grep -Fq 'lifecycle_step_count=14' "$report_txt"
grep -Fq 'lifecycle_state_change_count=14' "$report_txt"
...
grep -Fq 'subsystem[2].lifecycle_relation=run-queue-ready' "$report_txt"
