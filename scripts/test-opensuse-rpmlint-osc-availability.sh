...
require_contains 'Add openSUSE RPM build-evidence intake denial disposition closeout archive gate review contract' docs/OPENSUSE_RPMLINT_OSC_AVAILABILITY.md
