...
require_contains 'No model runtime, model weights, tool execution, training, or network authority.' "$manifest"
...
require_contains 'No model runtime, model weights, tool execution, training, or network authority are installed.' "$installer_readme"
require_contains 'Nadia offline AI foundation' "$ui_model"
require_contains "Nadia's Stage-0 console surface is metadata-only" "$ui_model"
