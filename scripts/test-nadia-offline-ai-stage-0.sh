...
require_contains 'No sexual user functionality, dialogue generation, prompt text receipt' "$manifest"
require_contains 'prompt-evaluation result release receipt review disposition recording' "$manifest"
require_contains 'receipt signing, receipt publication, model-output recording' "$manifest"
require_contains 'prompt evaluation, inference, tool execution, model installation, training, distillation, source mutation, or network authority.' "$manifest"
...
require_contains 'No sexual user functionality, dialogue generation, prompt text receipt' "$installer_readme"
