...
require_contains 'system_name=Latticra Nadia' "$foundation"
...
require_contains 'No sexual user functionality, prompt evaluation, inference, tool execution, model installation, training, distillation, source mutation, or network authority.' "$manifest"
...
require_contains 'No sexual user functionality, inference, prompt evaluation, tool execution, model installation, training, distillation, source mutation, or network authority are installed.' "$installer_readme"
require_contains 'Nadia offline AI foundation' "$ui_model"
require_contains "Nadia's Stage-0, Stage-1, Stage-2, Stage-3, Stage-4, Stage-5, Stage-6, and Stage-7 console surfaces are metadata-only" "$ui_model"
