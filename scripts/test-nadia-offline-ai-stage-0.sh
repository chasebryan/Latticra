...
require_contains 'No sexual user functionality, dialogue generation, prompt text receipt, prompt source reading, prompt buffer allocation, prompt tokenization, prompt materialization, prompt evaluation, inference, tool execution, model installation, training, distillation, source mutation, or network authority.' "$manifest"
...
require_contains "Nadia's Stage-0, Stage-1, Stage-2, Stage-3, Stage-4, Stage-5, Stage-6, Stage-7, Stage-8, Stage-9, Stage-10, Stage-11, Stage-12, Stage-13, Stage-14, Stage-15, and Stage-16 console surfaces are metadata-only" "$ui_model"
