...
require_contains 'implementation_name=Nadiav0.0.1' "$foundation"
require_contains 'documentation_code_name=Nadiav0.0.1' "$foundation"
require_contains 'system_name=Latticra Nadiav0.0.1' "$foundation"
...
require_contains 'nadia_system_name=Latticra Nadiav0.0.1' "$status"
require_contains 'implementation_name=Nadiav0.0.1' "$status"
...
require_contains 'No sexual user functionality, prompt materialization, prompt evaluation, inference, tool execution, model installation, training, distillation, source mutation, or network authority.' "$manifest"
...
require_contains 'implementation_name=Nadiav0.0.1' "$panel_ui"
