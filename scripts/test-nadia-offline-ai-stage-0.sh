...
require_contains 'No model runtime, model weights, training, source mutation, or network authority.' "$manifest"
...
require_contains 'model_runtime_present=0 model_weights_installed=0' "$panel_ui"
...
require_contains 'No model runtime, model weights, training, source mutation, or network authority are installed.' "$installer_readme"
require_contains 'Nadia offline AI foundation' "$ui_model"
require_contains "Nadia's Stage-0 and Stage-1 console surfaces are metadata-only" "$ui_model"
