...
label='debian/freebsd/openbsd package build-evidence intake denial chain archive gate review contract'
...
contract='docs/DEBIAN_FREEBSD_OPENBSD_PACKAGE_BUILD_EVIDENCE_INTAKE_DENIAL_CHAIN_ARCHIVE_GATE_REVIEW_CONTRACT.md'
predecessor_contract='docs/DEBIAN_FREEBSD_OPENBSD_PACKAGE_BUILD_EVIDENCE_INTAKE_DENIAL_CHAIN_ARCHIVE_GATE_CONTRACT.md'
...
workflow='.github/workflows/debian-freebsd-openbsd-package-build-evidence-intake-denial-chain-archive-gate-review-contract.yml'
...
require_contains 'Status: active package build-evidence intake denial disposition closeout archive gate review disposition closeout archive gate review disposition closeout archive gate review disposition closeout archive gate review disposition closeout archive gate review contract' "$contract"
require_contains 'documentation-only and static' "$contract"
require_contains 'does not run package build tools' "$contract"
require_contains 'shortened continuation filename `DEBIAN_FREEBSD_OPENBSD_PACKAGE_BUILD_EVIDENCE_INTAKE_DENIAL_CHAIN_ARCHIVE_GATE_REVIEW_CONTRACT.md`' "$contract"
...
require_contains 'Add a Debian, FreeBSD, and OpenBSD package build-evidence intake denial chain archive gate review disposition contract before any upheld archive gate review can be disposed, archived, or re-requested.' "$contract"
require_contains 'docs/DEBIAN_FREEBSD_OPENBSD_PACKAGE_BUILD_EVIDENCE_INTAKE_DENIAL_CHAIN_ARCHIVE_GATE_REVIEW_DISPOSITION_CONTRACT.md' "$contract"
require_contains 'scripts/test-debian-freebsd-openbsd-package-build-evidence-intake-denial-chain-archive-gate-review-disposition-contract.sh' "$contract"
...
require_contains 'DEBIAN_FREEBSD_OPENBSD_PACKAGE_BUILD_EVIDENCE_INTAKE_DENIAL_CHAIN_ARCHIVE_GATE_REVIEW_CONTRACT.md' docs/README.md
require_contains 'DEBIAN_FREEBSD_OPENBSD_PACKAGE_BUILD_EVIDENCE_INTAKE_DENIAL_CHAIN_ARCHIVE_GATE_REVIEW_CONTRACT.md' docs/status/README.md
require_contains 'Run Debian FreeBSD OpenBSD package build evidence intake denial chain archive gate review contract guard' "$workflow"
require_contains 'sh scripts/test-debian-freebsd-openbsd-package-build-evidence-intake-denial-chain-archive-gate-review-contract.sh' "$workflow"
