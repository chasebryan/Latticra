...
require_contains 'stage=33-prompt-evaluation-result-disposition-contract' "$apply_script"
require_contains 'stage=33-prompt-evaluation-result-disposition-contract' "$panel_config"
