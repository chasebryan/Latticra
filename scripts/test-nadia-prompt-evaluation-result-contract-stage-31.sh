...
require_contains '| Nadia offline AI foundation | 67% |' "$readme"
...
require_contains '| Nadia offline AI foundation | 67% |' "$root_status"
require_contains '| Nadia offline AI foundation | 67% |' "$current_status"
...
require_contains 'Stage-31 and Stage-32 console surfaces are metadata-only' "$ui_model"
...
require_contains 'stage=32-prompt-evaluation-result-review-contract' "$apply_script"
require_contains 'stage=32-prompt-evaluation-result-review-contract' "$panel_config"
