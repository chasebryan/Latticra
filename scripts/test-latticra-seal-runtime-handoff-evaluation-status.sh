...
require_contains 'readme_links_runtime_handoff_evaluation_contract=1' "$status_file"
require_contains 'readme_links_runtime_handoff_evaluation_implementation=1' "$status_file"
require_contains 'readme_links_runtime_handoff_evaluation_status=1' "$status_file"
require_contains 'root_status_mentions_runtime_handoff_evaluation_status=1' "$status_file"
require_contains 'status_index_links_runtime_handoff_evaluation_status=1' "$status_file"
require_contains 'foundation_index_links_runtime_handoff_evaluation_status=1' "$status_file"
require_contains 'project_notes_mark_runtime_handoff_evaluation_status_complete=1' "$status_file"
...
require_contains 'runtime_handoff_evaluation_added=1' "$status_file"
...
require_contains 'seal runtime handoff evaluation status: ok' "$status_file"
require_contains 'seal runtime handoff evaluation invariants: ok' "$status_file"
require_contains 'runtime handoff report surface status/public-entry alignment' "$status_file"
