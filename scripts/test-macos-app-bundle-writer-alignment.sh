...
require_contains 'macos_dry_run_writer_candidate_integration_present=1' "$doc"
...
require_contains 'macos_verification_transcript_contract_present=1' "$writer_status"
...
require_contains 'macos_verification_transcript_contract_present=1' "$implementation_status"
