...
require_contains 'Panel signed-updater state transition denial disposition' "$transcript_doc"
require_contains 'Panel signed-updater state transition denial disposition' "$transcript_status"
require_contains 'Panel signed-updater state transition denial disposition' "$state_validation_doc"
require_contains 'Panel signed-updater state transition denial disposition' "$state_validation_status"
require_contains 'Panel signed-updater state transition denial disposition' "$state_contract_doc"
require_contains 'Panel signed-updater state transition denial disposition' "$state_contract_status"
require_contains 'Panel signed-updater state transition denial disposition' "$manifest_validation_doc"
require_contains 'Panel signed-updater state transition denial disposition' "$manifest_validation_status"
require_contains 'Panel signed-updater state transition denial disposition' "$manifest_contract_doc"
require_contains 'Panel signed-updater state transition denial disposition' "$manifest_contract_status"
...
require_contains 'panel-signed-updater-state-transition-denial-disposition' "$transcript_script"
require_contains 'panel-signed-updater-state-transition-denial-disposition' "$transcript_test"
require_contains 'panel-signed-updater-state-transition-denial-disposition' "$state_validation_script"
require_contains 'panel-signed-updater-state-transition-denial-disposition' "$state_validation_test"
require_contains 'panel-signed-updater-state-transition-denial-disposition' "$state_contract_script"
require_contains 'panel-signed-updater-state-transition-denial-disposition' "$state_contract_test"
require_contains 'panel-signed-updater-state-transition-denial-disposition' "$manifest_validation_script"
require_contains 'panel-signed-updater-state-transition-denial-disposition' "$manifest_validation_test"
require_contains 'panel-signed-updater-state-transition-denial-disposition' "$manifest_contract_script"
require_contains 'panel-signed-updater-state-transition-denial-disposition' "$manifest_contract_test"
