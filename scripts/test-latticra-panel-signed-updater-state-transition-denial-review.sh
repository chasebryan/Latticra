...
require_contains 'Panel signed-updater state transition denial disposition closeout' "$transcript_doc"
require_contains 'Panel signed-updater state transition denial disposition closeout' "$transcript_status"
...
require_contains 'panel-signed-updater-state-transition-denial-disposition-closeout' "$transcript_script"
require_contains 'panel-signed-updater-state-transition-denial-disposition-closeout' "$transcript_test"
