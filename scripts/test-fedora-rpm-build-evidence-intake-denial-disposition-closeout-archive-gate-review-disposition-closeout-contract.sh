...
fail() {
  printf 'fedora rpm build-evidence intake denial disposition closeout archive gate review disposition closeout contract: %s\n' "$1" >&2
  exit 1
}
...
doc='docs/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_CONTRACT.md'
status='docs/status/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_CONTRACT_STATUS.md'
index='docs/status/README.md'
docs_readme='docs/README.md'
readme='README.md'
packaging_readme='packaging/fedora/README.md'
test_script='scripts/test-fedora-rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-closeout-contract.sh'
workflow='.github/workflows/fedora-rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-closeout-contract.yml'
archive_gate_review_disposition_closeout_archive_gate_doc='docs/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_CONTRACT.md'
archive_gate_review_disposition_closeout_archive_gate_status='docs/status/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_CONTRACT_STATUS.md'
archive_gate_review_disposition_closeout_archive_gate_test='scripts/test-fedora-rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-closeout-archive-gate-contract.sh'
archive_gate_review_disposition_closeout_archive_gate_workflow='.github/workflows/fedora-rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-closeout-archive-gate-contract.yml'
archive_gate_review_disposition_doc='docs/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CONTRACT.md'
archive_gate_review_disposition_status='docs/status/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CONTRACT_STATUS.md'
archive_gate_review_disposition_test='scripts/test-fedora-rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-contract.sh'
...
for file in \
  ...
  "$test_script" \
  "$workflow" \
  "$archive_gate_review_disposition_closeout_archive_gate_doc" \
  "$archive_gate_review_disposition_closeout_archive_gate_status" \
  "$archive_gate_review_disposition_closeout_archive_gate_test" \
  "$archive_gate_review_disposition_closeout_archive_gate_workflow" \
  "$archive_gate_review_disposition_doc" \
  "$archive_gate_review_disposition_status" \
  "$archive_gate_review_disposition_test" \
...
require_contains 'Status: active RPM build-evidence intake denial disposition closeout archive gate review disposition closeout contract' "$doc"
require_contains 'documentation-only and static' "$doc"
require_contains 'write archive records' "$doc"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_contract_present=1' "$doc"
require_contains 'rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_contract_present=1' "$doc"
require_contains 'build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_state=closed-out-upheld-no-effect' "$doc"
...
require_contains 'denial_archive_gate_review_disposition_closeout_present=1' "$doc"
require_contains 'denial_archive_gate_review_disposition_closeout_state=closed-out-upheld-no-effect' "$doc"
require_contains 'denial_archive_gate_review_disposition_closeout_decision=closeout-upheld-archive-gate-review-disposition' "$doc"
...
require_contains 'fedora_build_evidence_intake_denial_archive_gate_review_disposition_closeout_present=1' "$doc"
require_contains 'fedora_build_evidence_intake_denial_archive_gate_review_disposition_closed_out=1' "$doc"
...
for closeout_field in \
  'denial_archive_gate_review_disposition_closeout_identifier' \
  ...
  'denial_archive_gate_review_disposition_closeout_decision' \
  'denial_archive_gate_review_disposition_closeout_reason' \
  'denial_archive_gate_review_disposition_closeout_reviewer' \
...
require_contains 'Status: rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-closeout/status alignment' "$status"
require_contains 'Date: 2026-05-28' "$status"
require_contains 'archive gate review disposition closeout records the disposed Fedora build-evidence intake denial archive gate review as closed out' "$status"
...
require_contains 'FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_CONTRACT_STATUS.md' "$index"
require_contains 'Current Fedora RPM build-evidence intake denial disposition closeout archive gate review disposition closeout contract checkpoint' "$index"
require_contains 'The Fedora RPM build-evidence intake denial disposition closeout archive gate review disposition closeout contract is present and records the reviewed archive gate disposition as closed out while archive-record writes and re-request authority remain closed' "$index"

require_contains 'FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_CONTRACT.md' "$docs_readme"
require_contains 'docs/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_CONTRACT.md' "$readme"
require_contains 'docs/status/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_CONTRACT_STATUS.md' "$readme"
require_contains 'The Fedora RPM build-evidence intake denial disposition closeout archive gate review disposition closeout contract is present' "$readme"

require_contains 'docs/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_CONTRACT.md' "$packaging_readme"
require_contains 'scripts/test-fedora-rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-closeout-contract.sh' "$packaging_readme"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_contract_present=1' "$packaging_readme"
require_contains 'build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_state=closed-out-upheld-no-effect' "$packaging_readme"
require_contains 'denial_archive_gate_review_disposition_closeout_present=1' "$packaging_readme"
require_contains 'denial_archive_gate_review_disposition_closeout_decision=closeout-upheld-archive-gate-review-disposition' "$packaging_readme"

require_contains "$doc" "$archive_gate_review_disposition_doc"
require_contains "$status" "$archive_gate_review_disposition_doc"
require_contains "$test_script" "$archive_gate_review_disposition_doc"
require_contains "$workflow" "$archive_gate_review_disposition_doc"
require_contains "$doc" "$archive_gate_review_disposition_status"
require_contains "$status" "$archive_gate_review_disposition_status"
require_contains "$archive_gate_review_disposition_closeout_archive_gate_doc" "$doc"
require_contains "$archive_gate_review_disposition_closeout_archive_gate_status" "$doc"
require_contains "$archive_gate_review_disposition_closeout_archive_gate_test" "$doc"
require_contains "$archive_gate_review_disposition_closeout_archive_gate_workflow" "$doc"
require_contains "$archive_gate_review_disposition_closeout_archive_gate_doc" "$status"
require_contains "$archive_gate_review_disposition_closeout_archive_gate_status" "$status"
require_contains 'Add a Fedora RPM build-evidence intake denial disposition closeout archive gate review disposition closeout archive gate review contract before any reviewed archive gate disposition closeout archive gate can be relaxed or re-requested.' "$archive_gate_review_disposition_doc"
require_contains 'Add a Fedora RPM build-evidence intake denial disposition closeout archive gate review disposition closeout archive gate review contract before any reviewed archive gate disposition closeout archive gate can be relaxed or re-requested.' "$archive_gate_review_disposition_status"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_contract_present=1' "$archive_gate_review_disposition_test"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_archive_gate_contract_present=1' "$archive_gate_review_disposition_closeout_archive_gate_doc"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_archive_gate_contract_present=1' "$archive_gate_review_disposition_closeout_archive_gate_status"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_archive_gate_contract_present=1' "$archive_gate_review_disposition_closeout_archive_gate_test"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_archive_gate_contract_present=1' "$matrix"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_contract_present=1' "$matrix_script"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_archive_gate_contract_present=1' "$matrix_script"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_contract_present=1' "$matrix_status"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_archive_gate_contract_present=1' "$matrix_status"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_contract_present=1' "$matrix_test"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_archive_gate_contract_present=1' "$matrix_test"
...
require_contains 'name: Fedora RPM Evidence Denial Gate Review Disposition Closeout' "$workflow"
...
require_contains 'sh scripts/test-fedora-rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-closeout-contract.sh' "$workflow"
...
printf 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_contract: ok\n'
