...
require_file() {
  file="$1"
  if [ ! -f "$file" ]; then
    printf 'ubuntu ppa/archive publication evidence intake denial disposition closeout archive gate review disposition contract: missing file: %s\n' "$file" >&2
    exit 1
  fi
}
...
require_contains() {
  ...
  if ! grep -Fq -- "$pattern" "$file"; then
    printf 'ubuntu ppa/archive publication evidence intake denial disposition closeout archive gate review disposition contract: missing required pattern in %s: %s\n' "$file" "$pattern" >&2
    exit 1
  fi
}
...
require_no_ubuntu_artifacts() {
  ...
  if find "$dir" \( -name '*.deb' -o -name '*.dsc' -o -name '*.changes' -o -name '*.build' -o -name '*.buildinfo' \) -print | grep -q .; then
    printf 'ubuntu ppa/archive publication evidence intake denial disposition closeout archive gate review disposition contract: unexpected Ubuntu package artifact under %s\n' "$dir" >&2
    exit 1
  fi
}

contract='docs/UBUNTU_PPA_ARCHIVE_PUBLICATION_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CONTRACT.md'
...
workflow='.github/workflows/ubuntu-ppa-archive-publication-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-contract.yml'
archive_gate_review_disposition_closeout_workflow='.github/workflows/ubuntu-ppa-archive-publication-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-closeout-contract.yml'
...
require_file "$archive_gate_review_disposition_closeout_workflow"
require_file README.md
require_file docs/QUICK_START_CHEATSHEET.md
require_file packaging/ubuntu/README.md

require_contains 'Status: no-effect publication evidence intake denial disposition closeout archive gate review disposition contract' "$contract"
...
require_contains 'ubuntu_ppa_archive_publication_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_contract_present=1' "$contract"
require_contains 'ubuntu_publication_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_contract_present=1' "$contract"
...
require_contains 'publication_evidence_denial_archive_gate_review_disposition_closeout_decision=closeout-upheld-archive-gate-review-disposition' "$contract"
...
require_contains 'publication_evidence_denial_archive_gate_review_disposition_identifier' "$contract"
...
require_contains 'publication_evidence_denial_archive_gate_review_disposition_decision' "$contract"
require_contains 'publication_evidence_denial_archive_gate_review_disposition_reason' "$contract"
require_contains 'publication_evidence_denial_archive_gate_review_disposition_reviewer' "$contract"
...
require_contains 'ubuntu_ppa_archive_publication_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_contract: ok' "$contract"
...
do
  require_contains 'ubuntu_ppa_archive_publication_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_contract_present=1' "$file"
  require_contains 'ubuntu_publication_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_contract_present=1' "$file"
  require_contains 'publication_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_state=disposed-upheld-no-effect' "$file"
  require_contains 'publication_evidence_denial_archive_gate_review_disposition_present=1' "$file"
  require_contains 'publication_evidence_denial_archive_gate_review_disposition_state=disposed-upheld-no-effect' "$file"
  require_contains 'publication_evidence_denial_archive_gate_review_disposition_decision=dispose-upheld-closed-archive-gate-review' "$file"
...
require_contains 'ubuntu_publication_evidence_intake_denial_archive_gate_review_disposition_present=1' "$status"
require_contains 'ubuntu_publication_evidence_intake_denial_archive_gate_review_disposed=1' "$status"
require_contains 'ubuntu_publication_denial_archive_record_write_allowed=0' "$status"
require_contains 'ubuntu_publication_evidence_intake_denial_archive_gate_review_disposition_present=1' packaging/ubuntu/README.md
require_contains 'ubuntu_publication_evidence_intake_denial_archive_gate_review_disposed=1' packaging/ubuntu/README.md
...
require_contains 'Ubuntu PPA Evidence Intake Denial Archive Gate Review Disposition Contract' "$workflow"
require_contains 'Run Ubuntu PPA archive publication evidence intake denial disposition closeout archive gate review disposition guard' "$workflow"
require_contains 'sh scripts/test-ubuntu-ppa-archive-publication-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-contract.sh' "$workflow"
require_contains 'Ubuntu PPA Evidence Intake Denial Archive Gate Review Disposition Closeout Contract' "$archive_gate_review_disposition_closeout_workflow"
require_contains 'Run Ubuntu PPA archive publication evidence intake denial disposition closeout archive gate review disposition closeout guard' "$archive_gate_review_disposition_closeout_workflow"
require_contains 'sh scripts/test-ubuntu-ppa-archive-publication-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-closeout-contract.sh' "$archive_gate_review_disposition_closeout_workflow"

require_no_ubuntu_artifacts packaging/ubuntu

sh -n "$0"

printf 'ubuntu_ppa_archive_publication_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_contract: ok\n'
