...
require_file() {
  file="$1"
  if [ ! -f "$file" ]; then
    printf 'seal signer handoff status: missing file: %s\n' "$file" >&2
    exit 1
  fi
}
...
require_contains() {
  ...
  if ! grep -Fq -- "$pattern" "$file"; then
    printf 'seal signer handoff status: missing required pattern in %s: %s\n' "$file" "$pattern" >&2
    exit 1
  fi
}

status_file="docs/status/SEAL_SIGNER_HANDOFF_STATUS.md"
...
require_contains 'Status: status record for Latticra Seal signer handoff metadata' "$status_file"
...
require_contains 'signer_handoff_predecessor_signing_authorization_status_present=1' "$status_file"
require_contains 'readme_links_signer_handoff_status=1' "$status_file"
require_contains 'root_status_mentions_signer_handoff_status=1' "$status_file"
require_contains 'status_index_links_signer_handoff_status=1' "$status_file"
require_contains 'foundation_index_links_signer_handoff_status=1' "$status_file"
...
require_contains 'status=signer-handoff-metadata' "$status_file"
require_contains 'signer_handoff_status_added=1' "$status_file"
...
require_contains 'signer invocation status/workflow guard alignment' "$status_file"

require_contains 'DENIED_CRYPTO_GRADUATION_GATE' include/latticra/seal_signer_handoff.h
require_contains 'denied-crypto-graduation-gate' src/seal_signer_handoff.c
require_contains 'crypto_graduation_gate_present=%u' src/seal_signer_handoff.c
require_contains 'standard_expectations_met=%u' src/seal_signer_handoff.c

require_contains 'SEAL_SIGNER_HANDOFF_STATUS.md' README.md
...
require_contains 'latticra_seal_signer_handoff_status_present=1' README.md
require_contains 'signer-handoff status record now ties that metadata-only checkpoint to the guarded signing-authorization status predecessor' README.md
require_contains 'signer-handoff status record now preserves crypto graduation evidence from the guarded signing-authorization predecessor without invoking a signer' README.md
require_contains 'signer_handoff_crypto_graduation_gate_present=1' README.md
require_contains 'signer_handoff_crypto_graduation_gate_passed=1' README.md
require_contains 'signer_handoff_standard_expectations_met=1' README.md
require_contains 'signer_handoff_authority_promotion_allowed=0' README.md
...
require_contains 'seal_signer_handoff_status_present=1' README.md
...
require_contains 'Seal signer handoff predecessor status alignment' STATUS.md
require_contains 'signer_handoff_predecessor_signing_authorization_status_present=1' STATUS.md
require_contains 'signer_handoff_crypto_graduation_gate_present=1' STATUS.md
require_contains 'signer_handoff_crypto_graduation_gate_passed=1' STATUS.md
require_contains 'signer_handoff_standard_expectations_met=1' STATUS.md
require_contains 'signer_handoff_authority_promotion_allowed=0' STATUS.md
...
require_contains 'SEAL_SIGNER_HANDOFF_STATUS.md' docs/status/README.md
require_contains 'seal_signer_handoff_status_present=1' docs/status/README.md
require_contains 'signer_handoff_predecessor_signing_authorization_status_present=1' docs/status/README.md
require_contains 'signer_handoff_crypto_graduation_gate_present=1' docs/status/README.md
require_contains 'signer_handoff_crypto_graduation_gate_passed=1' docs/status/README.md
require_contains 'signer_handoff_standard_expectations_met=1' docs/status/README.md
require_contains 'signer_handoff_authority_promotion_allowed=0' docs/status/README.md
...
require_contains 'Latticra Seal signer handoff predecessor status alignment' docs/status/CURRENT_STATUS.md
require_contains 'signer_handoff_predecessor_signing_authorization_status_present=1' docs/status/CURRENT_STATUS.md
require_contains 'signer_handoff_crypto_graduation_gate_present=1' docs/status/CURRENT_STATUS.md
require_contains 'signer_handoff_crypto_graduation_gate_passed=1' docs/status/CURRENT_STATUS.md
require_contains 'signer_handoff_standard_expectations_met=1' docs/status/CURRENT_STATUS.md
require_contains 'signer_handoff_authority_promotion_allowed=0' docs/status/CURRENT_STATUS.md
...
require_contains 'Latticra Seal signer handoff predecessor status alignment' docs/FOUNDATION_INDEX.md
require_contains 'signer handoff metadata implementation with crypto graduation evidence carry-forward' docs/FOUNDATION_INDEX.md
...
require_contains 'Latticra Seal signer handoff predecessor status alignment' docs/project_notes/CURRENT_DIRECTION.md
...
require_contains 'Latticra Seal signer handoff predecessor status alignment' docs/project_notes/UPCOMING_WORK.md
require_contains 'docs/status/SEAL_SIGNER_HANDOFF_STATUS.md' docs/project_notes/README.md
require_contains 'sh scripts/test-latticra-seal-signer-handoff-status.sh' .github/workflows/latticra-seal-signer-handoff-status.yml

sh scripts/test-latticra-seal-signing-authorization-status.sh

printf 'seal signer handoff status: ok\n'
