...
require_contains 'ubuntu_package_notice_review_status=blocked-pending-doc-license-and-notice-review' "$notice_contract"
require_contains 'doc_payload_license_decision_recorded=0' "$doc_license_contract"
