...
require_contains 'future_iso_build_command=<grub-mkrescue-compatible-binary>' "$doc"
...
require_contains 'input_bundle_manifest_generator_present=1' "$script"
...
require_contains 'future_iso_build_command=$GRUB_MKRESCUE_Q' "$script"
...
require_output_contains "$default_output" 'input_bundle_manifest_generator_present=1'
