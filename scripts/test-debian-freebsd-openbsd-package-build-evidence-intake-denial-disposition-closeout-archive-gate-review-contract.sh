...
require_file() {
  file="$1"
  if [ ! -f "$file" ]; then
    printf 'debian/freebsd/openbsd package build-evidence intake denial disposition closeout archive gate review contract: missing file: %s\n' "$file" >&2
    exit 1
  fi
}
...
require_contains() {
  ...
  if ! grep -Fq -- "$pattern" "$file"; then
    printf 'debian/freebsd/openbsd package build-evidence intake denial disposition closeout archive gate review contract: missing required pattern in %s: %s\n' "$file" "$pattern" >&2
    exit 1
  fi
}
...
require_absent_file() {
  file="$1"
  if [ -e "$file" ]; then
    printf 'debian/freebsd/openbsd package build-evidence intake denial disposition closeout archive gate review contract: unexpected file exists: %s\n' "$file" >&2
    exit 1
  fi
}

contract='docs/DEBIAN_FREEBSD_OPENBSD_PACKAGE_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_CONTRACT.md'
...
require_file .github/workflows/debian-freebsd-openbsd-package-build-evidence-intake-denial-disposition-closeout-archive-gate-review-contract.yml

require_contains 'Status: active package build-evidence intake denial disposition closeout archive gate review contract' "$contract"
require_contains 'documentation-only and static' "$contract"
require_contains 'debian_freebsd_openbsd_package_build_evidence_intake_denial_disposition_closeout_archive_gate_review_contract_present=1' "$contract"
require_contains 'package_build_evidence_intake_denial_disposition_closeout_archive_gate_review_contract_present=1' "$contract"
...
require_contains 'denial_archive_gate_review_decision=uphold-closed-archive-gate' "$contract"
...
require_contains 'denial_archive_gate_decision=deny-archive-and-re-request' "$contract"
...
require_contains 'denial_archive_gate_review_identifier' "$contract"
...
require_contains 'denial_archive_gate_review_decision' "$contract"
require_contains 'denial_archive_gate_review_reason' "$contract"
require_contains 'denial_archive_gate_review_reviewer' "$contract"
...
require_contains 'debian_build_evidence_intake_denial_archive_gate_review_present=1' "$contract"
...
require_contains 'freebsd_build_evidence_intake_denial_archive_gate_review_present=1' "$contract"
...
require_contains 'openbsd_build_evidence_intake_denial_archive_gate_review_present=1' "$contract"
...
require_contains 'Add a Debian, FreeBSD, and OpenBSD package build-evidence intake denial disposition closeout archive gate review disposition contract' "$contract"
require_contains 'debian_freebsd_openbsd_package_build_evidence_intake_denial_disposition_closeout_archive_gate_review_contract: ok' "$contract"
...
require_contains 'DEBIAN_FREEBSD_OPENBSD_PACKAGE_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_CONTRACT.md' docs/README.md
require_contains 'DEBIAN_FREEBSD_OPENBSD_PACKAGE_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_CONTRACT.md' docs/status/README.md
...
for file in \
  ...
  README.md
do
  require_contains 'debian_freebsd_openbsd_package_build_evidence_intake_denial_disposition_closeout_archive_gate_review_contract_present=1' "$file"
  require_contains 'build_evidence_intake_denial_disposition_closeout_archive_gate_review_state=reviewed-upheld-no-effect' "$file"
  require_contains 'denial_archive_gate_review_present=1' "$file"
...
require_contains 'debian_build_evidence_intake_denial_archive_gate_review_present=1' docs/status/DEBIAN_ECOSYSTEM_INTEGRATION_STATUS.md
require_contains 'debian_build_evidence_intake_denial_archive_gate_reviewed=1' docs/status/DEBIAN_ECOSYSTEM_INTEGRATION_STATUS.md
require_contains 'debian_denial_archive_record_write_allowed=0' docs/status/DEBIAN_ECOSYSTEM_INTEGRATION_STATUS.md
require_contains 'freebsd_build_evidence_intake_denial_archive_gate_review_present=1' docs/status/FREEBSD_ECOSYSTEM_INTEGRATION_STATUS.md
require_contains 'freebsd_build_evidence_intake_denial_archive_gate_reviewed=1' docs/status/FREEBSD_ECOSYSTEM_INTEGRATION_STATUS.md
require_contains 'freebsd_denial_archive_record_write_allowed=0' docs/status/FREEBSD_ECOSYSTEM_INTEGRATION_STATUS.md
require_contains 'openbsd_build_evidence_intake_denial_archive_gate_review_present=1' docs/status/OPENBSD_ECOSYSTEM_INTEGRATION_STATUS.md
require_contains 'openbsd_build_evidence_intake_denial_archive_gate_reviewed=1' docs/status/OPENBSD_ECOSYSTEM_INTEGRATION_STATUS.md
require_contains 'openbsd_denial_archive_record_write_allowed=0' docs/status/OPENBSD_ECOSYSTEM_INTEGRATION_STATUS.md

require_contains 'debian_build_evidence_intake_denial_archive_gate_review_present=1' packaging/debian/README.md
require_contains 'debian_build_evidence_intake_denial_archive_gate_reviewed=1' packaging/debian/README.md
require_contains 'freebsd_build_evidence_intake_denial_archive_gate_review_present=1' packaging/freebsd/README.md
require_contains 'freebsd_build_evidence_intake_denial_archive_gate_reviewed=1' packaging/freebsd/README.md
require_contains 'openbsd_build_evidence_intake_denial_archive_gate_review_present=1' packaging/openbsd/README.md
require_contains 'openbsd_build_evidence_intake_denial_archive_gate_reviewed=1' packaging/openbsd/README.md
...
require_contains 'Run Debian FreeBSD OpenBSD package build evidence intake denial disposition closeout archive gate review contract guard' .github/workflows/debian-freebsd-openbsd-package-build-evidence-intake-denial-disposition-closeout-archive-gate-review-contract.yml
require_contains 'sh scripts/test-debian-freebsd-openbsd-package-build-evidence-intake-denial-disposition-closeout-archive-gate-review-contract.sh' .github/workflows/debian-freebsd-openbsd-package-build-evidence-intake-denial-disposition-closeout-archive-gate-review-contract.yml

sh -n "$0"

printf 'debian_freebsd_openbsd_package_build_evidence_intake_denial_disposition_closeout_archive_gate_review_contract: ok\n'
