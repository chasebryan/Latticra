...
require_contains 'docs/UBUNTU_PUBLICATION_NON_CLAIM_REVIEW_CONTRACT.md' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'publication_non_claim_review_contract_present=1' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'publication_non_claim_review_status=blocked-pending-launchpad-build-result-evidence' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'publication_scope_recorded=0' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'publication_target_type_recorded=0' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'publication_claims_reviewed=0' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'publication_readiness_non_claims_reviewed=0' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'ubuntu_publication_non_claim_review_unblocked=0' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'docs/UBUNTU_PPA_ARCHIVE_PUBLICATION_PROMOTION_BLOCKER_MATRIX_CONTRACT.md' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'ppa_archive_publication_promotion_blocker_matrix_contract_present=1' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'publication_promotion_blocker_matrix_state=blocked-no-effect' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'ubuntu_publication_promotion_blocker_matrix_unblocked=0' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'ubuntu_publication_promotion_blocked=1' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'ubuntu_platform_publication_evidence_accepted=0' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'ubuntu_publication_result_promoted=0' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'docs/UBUNTU_PPA_ARCHIVE_PUBLICATION_EVIDENCE_INTAKE_DENIAL_CONTRACT.md' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'docs/UBUNTU_PPA_ARCHIVE_PUBLICATION_EVIDENCE_INTAKE_DENIAL_REVIEW_CONTRACT.md' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'ppa_archive_publication_evidence_intake_denial_contract_present=1' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'ubuntu_ppa_archive_publication_evidence_intake_denial_contract_present=1' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'ubuntu_publication_evidence_intake_denial_contract_present=1' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'ubuntu_ppa_archive_publication_evidence_intake_denial_review_contract_present=1' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'ubuntu_publication_evidence_intake_denial_review_contract_present=1' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'publication_evidence_intake_denial_state=denied-no-effect' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'publication_evidence_intake_denial_review_state=reviewed-upheld-no-effect' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'publication_evidence_denial_review_present=1' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'publication_evidence_denial_review_decision=uphold-denial' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'publication_evidence_denial_re_request_allowed=0' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'ubuntu_publication_evidence_intake_denied=1' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'ubuntu_publication_evidence_intake_denial_upheld=1' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'ubuntu_publication_evidence_intake_allowed=0' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'ubuntu_publication_evidence_intake_requested=0' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'publication_transcript_intake_accepted=0' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'ppa_creation_evidence_accepted=0' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'launchpad_publication_evidence_accepted=0' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
require_contains 'ubuntu_archive_submission_evidence_accepted=0' docs/UBUNTU_LOCAL_DEB_STATIC_VALIDATION.md
...
require_contains 'publication_scope_recorded=0' packaging/ubuntu/README.md
require_contains 'publication_target_type_recorded=0' packaging/ubuntu/README.md
require_contains 'publication_claims_reviewed=0' packaging/ubuntu/README.md
require_contains 'publication_readiness_non_claims_reviewed=0' packaging/ubuntu/README.md
...
require_contains 'ppa_archive_publication_evidence_intake_denial_contract_present=1' packaging/ubuntu/README.md
