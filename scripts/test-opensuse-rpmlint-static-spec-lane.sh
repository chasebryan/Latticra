...
require_contains 'docs/OPENSUSE_LOCAL_RPM_BUILD_GATE_CONTRACT.md' docs/OPENSUSE_RPMLINT_STATIC_SPEC_LANE.md
require_contains 'docs/OPENSUSE_LOCAL_RPM_BUILD_ENVIRONMENT_CONTRACT.md' docs/OPENSUSE_RPMLINT_STATIC_SPEC_LANE.md
require_contains 'docs/OPENSUSE_RPM_ARTIFACT_NAMING_CONTRACT.md' docs/OPENSUSE_RPMLINT_STATIC_SPEC_LANE.md
require_contains 'docs/OPENSUSE_RPM_PAYLOAD_INSPECTION_CONTRACT.md' docs/OPENSUSE_RPMLINT_STATIC_SPEC_LANE.md
...
require_contains 'Add openSUSE RPM build-evidence intake denial review contract' docs/OPENSUSE_RPMLINT_STATIC_SPEC_LANE.md
