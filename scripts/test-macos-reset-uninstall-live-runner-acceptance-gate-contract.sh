...
require_contains 'next_lane=macos-reset-uninstall-live-runner-acceptance-denial-transcript-contract' "$review_script"
require_contains 'Add a macOS reset/uninstall live-runner acceptance-denial transcript contract that records the closed acceptance gate without dispatching effects.' "$review_doc"
