...
require_contains 'network_authority_denied=1' "$SCRIPT"
require_contains 'network_fetch_authority=0' "$SCRIPT"
require_contains 'network_fetch_authority_denied=1' "$SCRIPT"
...
require_contains 'network_authority_denied=1' "$TMP_DIR/dry-run.out"
require_contains 'network_fetch_authority=0' "$TMP_DIR/dry-run.out"
require_contains 'network_fetch_authority_denied=1' "$TMP_DIR/dry-run.out"
require_contains 'network_performed=0' "$TMP_DIR/dry-run.out"
...
require_contains 'network_authority_denied=1' "$RECEIPTS/latest-reset-receipt.txt"
require_contains 'network_fetch_authority=0' "$RECEIPTS/latest-reset-receipt.txt"
require_contains 'network_fetch_authority_denied=1' "$RECEIPTS/latest-reset-receipt.txt"
require_contains 'network_performed=0' "$RECEIPTS/latest-reset-receipt.txt"
...
require_contains 'network_authority_denied=1' "$TMP_DIR/reset.out"
require_contains 'network_fetch_authority=0' "$TMP_DIR/reset.out"
require_contains 'network_fetch_authority_denied=1' "$TMP_DIR/reset.out"
require_contains 'network_performed=0' "$TMP_DIR/reset.out"
...
require_contains 'network_authority_denied=1' "$TMP_DIR/uninstall-dry-run.out"
require_contains 'network_fetch_authority=0' "$TMP_DIR/uninstall-dry-run.out"
require_contains 'network_fetch_authority_denied=1' "$TMP_DIR/uninstall-dry-run.out"
require_contains 'network_performed=0' "$TMP_DIR/uninstall-dry-run.out"
...
require_contains 'network_authority_denied=1' "$RECEIPTS/latest-uninstall-receipt.txt"
require_contains 'network_fetch_authority=0' "$RECEIPTS/latest-uninstall-receipt.txt"
require_contains 'network_fetch_authority_denied=1' "$RECEIPTS/latest-uninstall-receipt.txt"
require_contains 'network_performed=0' "$RECEIPTS/latest-uninstall-receipt.txt"
