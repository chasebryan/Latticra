...
tmpdir="$(mktemp -d "${TMPDIR:-/tmp}/latticra-kernel-runtime-entry-process-return-observation-view-report.XXXXXX")"
trap 'rm -rf "$tmpdir"' EXIT INT HUP TERM

report_bin="$tmpdir/latticra-kernel-runtime-entry-process-return-observation-view-report"
report_txt="$tmpdir/latticra-kernel-runtime-entry-process-return-observation-view-report.txt"
...
grep -Fq 'LATTICRA KERNEL RUNTIME ENTRY PROCESS RETURN OBSERVATION VIEW REPORT' "$report_txt"
grep -Fq 'process_return_observation_view_status=runtime-entry-process-return-observation-view-seed-ready' "$report_txt"
...
grep -Fq 'process_return_observation_view[0].process_label=kernel-report-process-metadata' "$report_txt"
grep -Fq 'process_return_observation_view[0].process_return_observation_view_class=kernel-report-runtime-entry-process-return-observation-view' "$report_txt"
grep -Fq 'process_return_observation_view[0].process_return_observation_view_token=0' "$report_txt"
grep -Fq 'process_return_observation_view[0].scheduler_return_observation_view_token=0' "$report_txt"
grep -Fq 'process_return_observation_view[0].scheduler_return_slot=6144' "$report_txt"
grep -Fq 'process_return_observation_view[0].process_return_slot=7168' "$report_txt"
grep -Fq 'process_return_observation_view[0].process_return_epoch_slot=19' "$report_txt"
grep -Fq 'process_return_observation_view[0].process_return_reason_slot=20' "$report_txt"
grep -Fq 'process_return_observation_view[0].process_state_slot=21' "$report_txt"
grep -Fq 'process_return_observation_view[0].process_return_observation_view_declared=1' "$report_txt"
grep -Fq 'process_return_observation_view[0].process_return_observation_declared=1' "$report_txt"
grep -Fq 'process_return_observation_view[0].process_return_declared=1' "$report_txt"
grep -Fq 'process_return_observation_view[0].process_return_observation_view_planned=0' "$report_txt"
grep -Fq 'process_return_observation_view[0].process_state_read_planned=0' "$report_txt"
grep -Fq 'process_return_observation_view[0].runtime_entry_process_return_observation_view_allowed=0' "$report_txt"
grep -Fq 'process_return_observation_view[0].process_return_observation_allowed=0' "$report_txt"
grep -Fq 'process_return_observation_view[0].no_effect=1' "$report_txt"

printf 'kernel_runtime_entry_process_return_observation_view_report_runner: ok\n'
