...
require_contains 'status_rollup_status_added=1' "$status_file"
...
require_contains 'status rollup status guard workflow' "$status_file"
require_contains 'agentic automation security status/workflow guard alignment' "$status_file"

require_contains 'SEAL_STATUS_ROLLUP_STATUS.md' README.md
require_contains 'status rollup status record now ties that metadata-only rollup checkpoint to the guarded runtime handoff status predecessor' README.md
...
require_contains 'status_rollup_predecessor_runtime_handoff_status_present=1' README.md
require_contains 'Seal status rollup status/public-entry alignment' STATUS.md
require_contains 'Seal status rollup predecessor status alignment' STATUS.md
...
require_contains 'status_rollup_predecessor_runtime_handoff_status_present=1' STATUS.md
...
require_contains 'status_rollup_predecessor_runtime_handoff_status_present=1' docs/status/README.md
require_contains 'Latticra Seal status rollup status/public-entry alignment' docs/status/CURRENT_STATUS.md
require_contains 'Latticra Seal status rollup predecessor status alignment' docs/status/CURRENT_STATUS.md
require_contains 'status_rollup_predecessor_runtime_handoff_status_present=1' docs/status/CURRENT_STATUS.md
...
require_contains 'Latticra Seal status rollup predecessor status alignment' docs/FOUNDATION_INDEX.md
require_contains 'Latticra Seal status rollup status/public-entry alignment' docs/project_notes/CURRENT_DIRECTION.md
require_contains 'Latticra Seal status rollup predecessor status alignment' docs/project_notes/CURRENT_DIRECTION.md
...
require_contains 'Latticra Seal status rollup predecessor status alignment' docs/project_notes/UPCOMING_WORK.md
...
require_contains 'Latticra Seal status rollup predecessor status alignment' docs/project_notes/README.md
require_contains 'docs/status/SEAL_RUNTIME_HANDOFF_STATUS.md' docs/project_notes/README.md
require_contains 'sh scripts/test-latticra-seal-status-rollup-status.sh' .github/workflows/latticra-seal-status-rollup-status.yml
