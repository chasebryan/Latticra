...
require_contains 'panel-signed-updater-state-transition-denial-disposition' "$contract_script"
require_contains 'panel-signed-updater-state-transition-denial-disposition' "$contract_test"
