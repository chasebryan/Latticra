...
require_contains 'Panel signed-updater state transition denial disposition review' "$contract_doc"
require_contains 'Panel signed-updater state transition denial disposition review' "$contract_status"
...
require_contains 'panel-signed-updater-state-transition-denial-disposition-review' "$contract_script"
require_contains 'panel-signed-updater-state-transition-denial-disposition-review' "$contract_test"
