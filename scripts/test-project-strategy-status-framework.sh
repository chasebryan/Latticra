...
require_contains 'Lat language grammar implementation plan' docs/FOUNDATION_INDEX.md
...
require_contains 'Lat grammar planning' docs/strategy/2026-05-15-2249-cdt-national-security-open-system-strategy.md
require_contains 'Lat language grammar implementation plan' docs/strategy/2026-05-15-2249-cdt-national-security-open-system-strategy.md
...
require_contains '71%' docs/strategy/2026-05-15-2249-cdt-national-security-open-system-strategy.md
...
require_contains '71%' docs/status/CURRENT_STATUS.md
...
require_contains 'Lat language grammar contract' docs/status/CURRENT_STATUS.md
require_contains 'LIR execution' docs/status/CURRENT_STATUS.md
require_contains 'Lat parser implementation' docs/status/CURRENT_STATUS.md
...
require_contains 'Lat language grammar contract' docs/status/ANNOUNCEMENTS.md
require_contains 'sh scripts/test-lat-language-grammar-contract.sh' docs/status/ANNOUNCEMENTS.md
require_contains 'Lat language grammar implementation plan' docs/status/ANNOUNCEMENTS.md
...
require_contains 'Lat language grammar implementation plan' docs/project_notes/CURRENT_DIRECTION.md
...
require_contains 'Lat language grammar implementation plan' docs/project_notes/UPCOMING_WORK.md
...
require_contains 'LATTICRA_LIR_NODE_MAX 96u' docs/LIR_SHAPE_IMPLEMENTATION.md
require_contains 'lir_shape_accepts_semantically_valid_l_ui_fixture' docs/LIR_SHAPE_IMPLEMENTATION.md
...
require_contains 'lat_grammar_accepts_minimal_module' docs/LAT_LANGUAGE_GRAMMAR_CONTRACT.md
