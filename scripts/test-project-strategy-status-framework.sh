...
require_contains 'LIR shape contract' STATUS.md
...
require_contains 'LIR shape contract' docs/FOUNDATION_INDEX.md
...
require_contains 'LIR shape contract' docs/strategy/2026-05-15-2249-cdt-national-security-open-system-strategy.md
...
require_contains 'sh scripts/test-l-ui-semantic-validation.sh' docs/status/ANNOUNCEMENTS.md
...
require_contains 'LIR shape contract' docs/project_notes/CURRENT_DIRECTION.md
...
require_contains 'LIR shape contract' docs/project_notes/UPCOMING_WORK.md
...
require_contains 'Status: initial implementation contract' docs/L_UI_SEMANTIC_VALIDATION_IMPLEMENTATION.md
