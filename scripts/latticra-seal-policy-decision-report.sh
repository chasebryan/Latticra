...
tmpdir="$(mktemp -d "${TMPDIR:-/tmp}/latticra-seal-policy-decision-report.XXXXXX")"
...
cc $CFLAGS \
  ...
  -o "$tmpdir/latticra-seal-policy-decision-report"

"$tmpdir/latticra-seal-policy-decision-report"
