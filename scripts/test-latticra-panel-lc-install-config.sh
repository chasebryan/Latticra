...
require_contains 'service_schema_contract_profile = "lc-service-schema-v0"' "$default_config"
require_contains 'require_service_schema_contract = true' "$default_config"
require_contains 'service_definitions_contract_profile = "lc-service-definitions-v0"' "$default_config"
require_contains 'require_service_definitions_contract = true' "$default_config"
require_contains 'service_plan_contract_profile = "lc-service-plan-v0"' "$default_config"
require_contains 'require_service_plan_contract = true' "$default_config"
require_contains 'service_runtime_contract_profile = "lc-service-runtime-v0"' "$default_config"
require_contains 'require_service_runtime_contract = true' "$default_config"
require_contains 'processes_contract_profile = "lc-processes-v0"' "$default_config"
require_contains 'require_processes_contract = true' "$default_config"
...
require_contains 'service_schema_contract_profile = "lc-service-schema-v0"' "$standalone_config"
require_contains 'service_definitions_contract_profile = "lc-service-definitions-v0"' "$standalone_config"
require_contains 'service_plan_contract_profile = "lc-service-plan-v0"' "$standalone_config"
require_contains 'service_runtime_contract_profile = "lc-service-runtime-v0"' "$standalone_config"
require_contains 'processes_contract_profile = "lc-processes-v0"' "$standalone_config"
require_contains 'require_processes_contract = true' "$standalone_config"
...
require_contains 'LC_SERVICE_SCHEMA_CONTRACT_PROFILE=$(cfg_section lc service_schema_contract_profile lc-service-schema-v0)' "$apply"
require_contains 'LC_SERVICE_DEFINITIONS_CONTRACT_PROFILE=$(cfg_section lc service_definitions_contract_profile lc-service-definitions-v0)' "$apply"
require_contains 'LC_SERVICE_PLAN_CONTRACT_PROFILE=$(cfg_section lc service_plan_contract_profile lc-service-plan-v0)' "$apply"
require_contains 'LC_SERVICE_RUNTIME_CONTRACT_PROFILE=$(cfg_section lc service_runtime_contract_profile lc-service-runtime-v0)' "$apply"
require_contains 'LC_PROCESSES_CONTRACT_PROFILE=$(cfg_section lc processes_contract_profile lc-processes-v0)' "$apply"
require_contains 'LC_REQUIRE_PROCESSES_CONTRACT=$(cfg_section lc require_processes_contract true)' "$apply"
...
require_contains 'echo "  \$LC_COMMAND_WRAPPER service-schema"' "$apply"
require_contains 'echo "  \$LC_COMMAND_WRAPPER service-definitions"' "$apply"
require_contains 'echo "  \$LC_COMMAND_WRAPPER service-plan"' "$apply"
require_contains 'echo "  \$LC_COMMAND_WRAPPER service-runtime"' "$apply"
require_contains 'echo "  \$LC_COMMAND_WRAPPER processes"' "$apply"
...
require_contains 'share/latticra/lc/services/definitions.toml' "$manifest"
require_contains 'share/latticra/lc/services/plan.toml' "$manifest"
require_contains 'share/latticra/lc/services/runtime.toml' "$manifest"
require_contains 'share/latticra/lc/processes/contract.toml' "$manifest"
...
require_contains 'service_schema_contract_present=1' "$tmp/plan.txt"
require_contains 'service_definitions_contract_present=1' "$tmp/plan.txt"
require_contains 'service_plan_contract_present=1' "$tmp/plan.txt"
require_contains 'service_runtime_contract_present=1' "$tmp/plan.txt"
require_contains 'processes_contract_present=1' "$tmp/plan.txt"
...
require_contains 'lc_service_schema_contract_present=true' "$tmp/receipts/latest-receipt.txt"
require_contains 'lc_service_definitions_contract_present=true' "$tmp/receipts/latest-receipt.txt"
require_contains 'lc_service_plan_contract_present=true' "$tmp/receipts/latest-receipt.txt"
require_contains 'lc_service_runtime_contract_present=true' "$tmp/receipts/latest-receipt.txt"
require_contains 'lc_processes_contract_present=true' "$tmp/receipts/latest-receipt.txt"
...
require_contains 'service_schema_contract_profile=lc-service-schema-v0' "$tmp/standalone-plan.txt"
require_contains 'service_schema_contract_present=1' "$tmp/standalone-plan.txt"
require_contains 'service_definitions_contract_profile=lc-service-definitions-v0' "$tmp/standalone-plan.txt"
require_contains 'service_definitions_contract_present=1' "$tmp/standalone-plan.txt"
require_contains 'service_plan_contract_profile=lc-service-plan-v0' "$tmp/standalone-plan.txt"
require_contains 'service_plan_contract_present=1' "$tmp/standalone-plan.txt"
require_contains 'service_runtime_contract_profile=lc-service-runtime-v0' "$tmp/standalone-plan.txt"
require_contains 'service_runtime_contract_present=1' "$tmp/standalone-plan.txt"
require_contains 'processes_contract_profile=lc-processes-v0' "$tmp/standalone-plan.txt"
require_contains 'processes_contract_present=1' "$tmp/standalone-plan.txt"
...
require_contains 'lc_service_schema_contract_present=true' "$tmp/standalone-receipts/latest-receipt.txt"
require_contains 'lc_service_definitions_contract_present=true' "$tmp/standalone-receipts/latest-receipt.txt"
require_contains 'lc_service_plan_contract_present=true' "$tmp/standalone-receipts/latest-receipt.txt"
require_contains 'lc_service_runtime_contract_present=true' "$tmp/standalone-receipts/latest-receipt.txt"
require_contains 'lc_processes_contract_present=true' "$tmp/standalone-receipts/latest-receipt.txt"
