...
require_file docs/SECURITY_VALIDATION_ASSESSMENT_BASELINE.md
...
require_file scripts/test-security-validation-assessment-baseline.sh
...
require_contains 'NIST SP 800-115, SP 800-37 Rev. 2, and SP 800-53A Rev. 5' "$doc"
