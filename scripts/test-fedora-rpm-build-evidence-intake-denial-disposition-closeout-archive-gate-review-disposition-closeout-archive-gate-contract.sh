...
fail() {
  printf 'fedora rpm build-evidence intake denial disposition closeout archive gate review disposition closeout archive gate contract: %s\n' "$1" >&2
  exit 1
}
...
doc='docs/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_CONTRACT.md'
status='docs/status/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_CONTRACT_STATUS.md'
index='docs/status/README.md'
docs_readme='docs/README.md'
readme='README.md'
packaging_readme='packaging/fedora/README.md'
test_script='scripts/test-fedora-rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-closeout-archive-gate-contract.sh'
workflow='.github/workflows/fedora-rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-closeout-archive-gate-contract.yml'
archive_gate_review_disposition_closeout_doc='docs/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_CONTRACT.md'
archive_gate_review_disposition_closeout_status='docs/status/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_CONTRACT_STATUS.md'
archive_gate_review_disposition_closeout_test='scripts/test-fedora-rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-closeout-contract.sh'
...
for file in \
  ...
  "$test_script" \
  "$workflow" \
  "$archive_gate_review_disposition_closeout_doc" \
  "$archive_gate_review_disposition_closeout_status" \
  "$archive_gate_review_disposition_closeout_test" \
...
require_contains 'Status: active RPM build-evidence intake denial disposition closeout archive gate review disposition closeout archive gate contract' "$doc"
require_contains 'documentation-only and static' "$doc"
require_contains 'write archive records' "$doc"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_archive_gate_contract_present=1' "$doc"
require_contains 'rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_archive_gate_contract_present=1' "$doc"
require_contains 'build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_archive_gate_state=closed-no-effect' "$doc"
...
require_contains 'denial_archive_gate_review_disposition_closeout_archive_gate_present=1' "$doc"
require_contains 'denial_archive_gate_review_disposition_closeout_archive_gate_state=closed-no-effect' "$doc"
require_contains 'denial_archive_gate_review_disposition_closeout_archive_gate_decision=deny-archive-and-re-request' "$doc"
...
require_contains 'fedora_build_evidence_intake_denial_archive_gate_review_disposition_closeout_archive_gate_present=1' "$doc"
require_contains 'fedora_build_evidence_intake_denial_archive_gate_review_disposition_closeout_archive_gate_closed=1' "$doc"
...
for gate_field in \
  'denial_archive_gate_review_disposition_closeout_archive_gate_identifier' \
  ...
  'denial_archive_gate_review_disposition_closeout_archive_gate_decision' \
  'denial_archive_gate_review_disposition_closeout_archive_gate_reason' \
  'denial_archive_gate_review_disposition_closeout_archive_gate_reviewer' \
...
require_contains 'Status: rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-closeout-archive-gate/status alignment' "$status"
require_contains 'Date: 2026-05-28' "$status"
require_contains 'archive gate keeps the disposed and closed-out Fedora build-evidence intake denial archive gate review unarchived' "$status"
...
require_contains 'FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_CONTRACT_STATUS.md' "$index"
require_contains 'Current Fedora RPM build-evidence intake denial disposition closeout archive gate review disposition closeout archive gate contract checkpoint' "$index"
require_contains 'The Fedora RPM build-evidence intake denial disposition closeout archive gate review disposition closeout archive gate contract is present and keeps the reviewed archive gate disposition closeout unarchived while archive-record writes and re-request authority remain closed' "$index"

require_contains 'FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_CONTRACT.md' "$docs_readme"
require_contains 'docs/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_CONTRACT.md' "$readme"
require_contains 'docs/status/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_CONTRACT_STATUS.md' "$readme"
require_contains 'The Fedora RPM build-evidence intake denial disposition closeout archive gate review disposition closeout archive gate contract is present' "$readme"

require_contains 'docs/FEDORA_RPM_BUILD_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_CONTRACT.md' "$packaging_readme"
require_contains 'scripts/test-fedora-rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-closeout-archive-gate-contract.sh' "$packaging_readme"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_archive_gate_contract_present=1' "$packaging_readme"
require_contains 'build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_archive_gate_state=closed-no-effect' "$packaging_readme"
require_contains 'denial_archive_gate_review_disposition_closeout_archive_gate_present=1' "$packaging_readme"
require_contains 'denial_archive_gate_review_disposition_closeout_archive_gate_decision=deny-archive-and-re-request' "$packaging_readme"

require_contains "$doc" "$archive_gate_review_disposition_closeout_doc"
require_contains "$status" "$archive_gate_review_disposition_closeout_doc"
require_contains "$test_script" "$archive_gate_review_disposition_closeout_doc"
require_contains "$workflow" "$archive_gate_review_disposition_closeout_doc"
require_contains "$doc" "$archive_gate_review_disposition_closeout_status"
require_contains "$status" "$archive_gate_review_disposition_closeout_status"
require_contains 'Add a Fedora RPM build-evidence intake denial disposition closeout archive gate review disposition closeout archive gate review contract before any reviewed archive gate disposition closeout archive gate can be relaxed or re-requested.' "$archive_gate_review_disposition_closeout_doc"
require_contains 'Add a Fedora RPM build-evidence intake denial disposition closeout archive gate review disposition closeout archive gate review contract before any reviewed archive gate disposition closeout archive gate can be relaxed or re-requested.' "$archive_gate_review_disposition_closeout_status"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_archive_gate_review_contract_present=1' "$doc"
require_contains 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_archive_gate_contract_present=1' "$archive_gate_review_disposition_closeout_test"
...
require_contains 'name: Fedora RPM Evidence Denial Archive Gate Closeout Contract' "$workflow"
...
require_contains 'sh scripts/test-fedora-rpm-build-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-closeout-archive-gate-contract.sh' "$workflow"
...
printf 'fedora_rpm_build_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_archive_gate_contract: ok\n'
