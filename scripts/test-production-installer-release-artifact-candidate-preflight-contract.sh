...
require_contains 'RELEASE_ARTIFACT_CANDIDATE_PREFLIGHT_PASSED=0' "$script"
require_contains 'release_artifact_candidate_preflight_passed=$RELEASE_ARTIFACT_CANDIDATE_PREFLIGHT_PASSED' "$script"
