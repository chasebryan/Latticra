...
tmpdir="$(mktemp -d "${TMPDIR:-/tmp}/latticra-kernel-runtime-entry-post-resume-observation-view-report.XXXXXX")"
trap 'rm -rf "$tmpdir"' EXIT INT HUP TERM

report_bin="$tmpdir/latticra-kernel-runtime-entry-post-resume-observation-view-report"
report_txt="$tmpdir/latticra-kernel-runtime-entry-post-resume-observation-view-report.txt"
...
grep -Fq 'LATTICRA KERNEL RUNTIME ENTRY POST RESUME OBSERVATION VIEW REPORT' "$report_txt"
grep -Fq 'post_resume_observation_view_status=runtime-entry-post-resume-observation-view-seed-ready' "$report_txt"
...
grep -Fq 'post_resume_observation_view[0].process_label=kernel-report-process-metadata' "$report_txt"
grep -Fq 'post_resume_observation_view[0].post_resume_observation_view_class=kernel-report-runtime-entry-post-resume-observation-view' "$report_txt"
grep -Fq 'post_resume_observation_view[0].post_resume_observation_view_token=0' "$report_txt"
grep -Fq 'post_resume_observation_view[0].user_mode_resume_view_token=0' "$report_txt"
grep -Fq 'post_resume_observation_view[0].syscall_number=512' "$report_txt"
grep -Fq 'post_resume_observation_view[0].resume_slot=4096' "$report_txt"
grep -Fq 'post_resume_observation_view[0].observation_slot=5120' "$report_txt"
grep -Fq 'post_resume_observation_view[0].instruction_pointer_slot=13' "$report_txt"
grep -Fq 'post_resume_observation_view[0].stack_pointer_slot=14' "$report_txt"
grep -Fq 'post_resume_observation_view[0].cpu_mode_slot=15' "$report_txt"
grep -Fq 'post_resume_observation_view[0].observation_epoch_slot=16' "$report_txt"
grep -Fq 'post_resume_observation_view[0].user_mode_resume_view_declared=1' "$report_txt"
grep -Fq 'post_resume_observation_view[0].post_resume_observation_view_declared=1' "$report_txt"
grep -Fq 'post_resume_observation_view[0].post_resume_observation_declared=1' "$report_txt"
grep -Fq 'post_resume_observation_view[0].instruction_pointer_observation_declared=1' "$report_txt"
grep -Fq 'post_resume_observation_view[0].post_resume_observation_view_planned=0' "$report_txt"
grep -Fq 'post_resume_observation_view[0].post_resume_observation_planned=0' "$report_txt"
grep -Fq 'post_resume_observation_view[0].instruction_pointer_read_planned=0' "$report_txt"
grep -Fq 'post_resume_observation_view[0].runtime_entry_post_resume_observation_view_allowed=0' "$report_txt"
grep -Fq 'post_resume_observation_view[0].post_resume_observation_allowed=0' "$report_txt"
grep -Fq 'post_resume_observation_view[0].instruction_pointer_read_allowed=0' "$report_txt"
grep -Fq 'post_resume_observation_view[0].no_effect=1' "$report_txt"

printf 'kernel_runtime_entry_post_resume_observation_view_report_runner: ok\n'
