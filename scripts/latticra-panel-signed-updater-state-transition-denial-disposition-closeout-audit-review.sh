...
usage() {
  cat <<'USAGE'
Usage:
  latticra-panel-signed-updater-state-transition-denial-disposition-closeout-audit-review.sh

Emits the no-effect review for the Latticra Panel signed updater state
transition denial disposition closeout audit. It does not transition update
state, stage updates, write review files, write receipts, mutate host state, or
...
signed_updater_state_transition_denial_disposition_closeout_audit_review_status=ok
repo_root=$ROOT
