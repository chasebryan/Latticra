...
usage() {
  cat <<'USAGE'
Usage:
  latticra-panel-signed-updater-state-transition-denial-disposition-closeout-audit-review-disposition-review.sh

Emits the no-effect review for the Latticra Panel signed updater state
transition denial disposition closeout audit review disposition. It does not
transition update state, stage updates, write review files, write receipts,
...
signed_updater_state_transition_denial_disposition_closeout_audit_review_disposition_review_status=ok
repo_root=$ROOT
