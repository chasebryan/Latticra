...
grep -Fq 'log[52].from=runtime-entry-recovery-audit-review-disposition-review-closeout-archive-gate-review-observation-view-ready' "$report_txt"
grep -Fq 'log[52].to=runtime-entry-recovery-audit-review-disposition-review-closeout-archive-gate-review-disposition-observation-view-ready' "$report_txt"
grep -Fq 'log[52].state_change_performed=1' "$report_txt"
grep -Fq 'log[52].external_effect_performed=0' "$report_txt"
grep -Fq 'log[53].from=runtime-entry-recovery-audit-review-disposition-review-closeout-archive-gate-review-disposition-observation-view-ready' "$report_txt"
