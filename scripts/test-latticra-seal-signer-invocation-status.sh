...
require_contains 'signer_invocation_crypto_graduation_gate_absent_requires_neutral_metadata=1' "$status_file"
...
require_contains 'crypto_graduation_gate_passed == 0u' src/seal_signer_invocation.c
require_contains 'crypto_graduation_gate_present=%u' src/seal_signer_invocation.c
require_contains 'standard_expectations_met=%u' src/seal_signer_invocation.c
...
require_contains 'signer-invocation status record now preserves crypto graduation evidence from the guarded signer-handoff predecessor without invoking a signer' README.md
require_contains 'signer_invocation_crypto_graduation_gate_present=1' README.md
require_contains 'signer_invocation_crypto_graduation_gate_passed=1' README.md
require_contains 'signer_invocation_standard_expectations_met=1' README.md
require_contains 'signer_invocation_authority_promotion_allowed=0' README.md
...
require_contains 'signer_invocation_crypto_graduation_gate_present=1' STATUS.md
require_contains 'signer_invocation_crypto_graduation_gate_passed=1' STATUS.md
require_contains 'signer_invocation_standard_expectations_met=1' STATUS.md
require_contains 'signer_invocation_authority_promotion_allowed=0' STATUS.md
...
require_contains 'signer_invocation_crypto_graduation_gate_present=1' docs/status/README.md
require_contains 'signer_invocation_crypto_graduation_gate_passed=1' docs/status/README.md
require_contains 'signer_invocation_standard_expectations_met=1' docs/status/README.md
require_contains 'signer_invocation_authority_promotion_allowed=0' docs/status/README.md
...
require_contains 'signer_invocation_crypto_graduation_gate_present=1' docs/status/CURRENT_STATUS.md
require_contains 'signer_invocation_crypto_graduation_gate_passed=1' docs/status/CURRENT_STATUS.md
require_contains 'signer_invocation_standard_expectations_met=1' docs/status/CURRENT_STATUS.md
require_contains 'signer_invocation_authority_promotion_allowed=0' docs/status/CURRENT_STATUS.md
...
require_contains 'signer invocation metadata implementation with crypto graduation evidence carry-forward' docs/FOUNDATION_INDEX.md
