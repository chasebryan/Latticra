...
require_contains 'scripts/test-latticra-prevention-surface-consistency.sh' "$doc"
require_contains 'packaging/fedora/latticra.spec' "$doc"
require_contains 'docs/FEDORA_VM_CLI_TRANSCRIPT_CONTRACT.md' "$doc"
require_contains 'sh scripts/test-latticra-prevention-surface-consistency.sh' "$doc"
...
require_contains 'usage: latticra [--status|--version|--report|--prevention-research|--prevention-boundary|--prevention-evidence|--prevention-gate|--prevention-fixtures|--prevention-method <id>]' "$doc"
require_contains 'LATTICRA PREVENTION RESEARCH REPORT' "$doc"
require_contains 'LATTICRA PREVENTION BOUNDARY REPORT' "$doc"
require_contains 'LATTICRA PREVENTION EVIDENCE REPORT' "$doc"
require_contains 'LATTICRA PREVENTION GATE REPORT' "$doc"
require_contains 'LATTICRA PREVENTION FIXTURE REPORT' "$doc"
...
require_contains 'source_owasp_input_validation=https://cheatsheetseries.owasp.org/cheatsheets/Input_Validation_Cheat_Sheet.html' "$doc"
require_contains 'source_owasp_asvs=https://owasp.org/www-project-application-security-verification-standard/' "$doc"
...
require_contains 'input_validation_position=early-syntactic-and-semantic-gate' "$doc"
require_contains 'input_validation_not_primary_sql_xss_defense=1' "$doc"
require_contains 'allowlist_validation_primary_required=1' "$doc"
require_contains 'server_side_validation_required=1' "$doc"
require_contains 'canonicalization_before_validation_required=1' "$doc"
require_contains 'schema_or_type_validation_required=1' "$doc"
...
require_contains 'evidence_schema_version=1' "$doc"
require_contains 'evidence_source_sink_map_required=1' "$doc"
require_contains 'evidence_method_selection_required=1' "$doc"
require_contains 'evidence_negative_case_required=1' "$doc"
require_contains 'evidence_safe_api_trace_required=1' "$doc"
require_contains 'gate_unmapped_boundary_blocks_release=1' "$doc"
require_contains 'gate_missing_negative_fixture_blocks_release=1' "$doc"
require_contains 'gate_missing_safe_api_trace_blocks_release=1' "$doc"
require_contains 'gate_secret_capture_blocks_release=1' "$doc"
require_contains 'evidence_fail_closed_result_required=1' "$doc"
require_contains 'evidence_no_secret_capture_required=1' "$doc"
require_contains 'fixture_schema_version=1' "$doc"
require_contains 'fixture_set_count=16' "$doc"
require_contains 'fixture_sql=data-value-separator-rejection' "$doc"
require_contains 'fixture_os_command=separator-and-option-smuggling-rejection' "$doc"
require_contains 'fixture_payload_strings_in_report=0' "$doc"
require_contains 'fixture_ci_gate_required=1' "$doc"
...
require_contains 'local_prevention_surface_consistency_guard_passed=1' "$doc"
...
require_contains 'cli_prevention_evidence_command_recorded=1' "$doc"
require_contains 'cli_prevention_gate_command_recorded=1' "$doc"
require_contains 'cli_prevention_fixtures_command_recorded=1' "$doc"
...
require_contains 'cli_prevention_evidence_validation_performed=1' "$doc"
require_contains 'cli_prevention_gate_validation_performed=1' "$doc"
require_contains 'cli_prevention_fixtures_validation_performed=1' "$doc"
...
require_contains 'canonicalization_before_validation_required=1' "$runner"
...
require_contains 'gate_missing_method_blocks_release=1' "$runner"
require_contains 'gate_missing_repeatability_blocks_release=1' "$runner"
...
require_contains 'fixture_regression_on_new_boundary_required=1' "$runner"
require_contains 'cli_prevention_gate_command_recorded=1' "$runner"
...
require_contains 'cli_prevention_evidence_validation_performed=1' "$runner"
require_contains 'cli_prevention_gate_validation_performed=1' "$runner"
require_contains 'cli_prevention_fixtures_validation_performed=1' "$runner"
...
require_contains 'local_prevention_surface_consistency_guard_passed=1' "$runner"
