...
tmpdir="$(mktemp -d "${TMPDIR:-/tmp}/latticra-kernel-runtime-entry-syscall-exit-view-report.XXXXXX")"
trap 'rm -rf "$tmpdir"' EXIT INT HUP TERM

report_bin="$tmpdir/latticra-kernel-runtime-entry-syscall-exit-view-report"
report_txt="$tmpdir/latticra-kernel-runtime-entry-syscall-exit-view-report.txt"
...
grep -Fq 'LATTICRA KERNEL RUNTIME ENTRY SYSCALL EXIT VIEW REPORT' "$report_txt"
grep -Fq 'syscall_exit_view_status=runtime-entry-syscall-exit-view-seed-ready' "$report_txt"
...
grep -Fq 'syscall_exit_view_count=4' "$report_txt"
...
grep -Fq 'syscall_exit_view[0].process_label=kernel-report-process-metadata' "$report_txt"
grep -Fq 'syscall_exit_view[0].syscall_exit_view_class=kernel-report-runtime-entry-syscall-exit-view' "$report_txt"
grep -Fq 'syscall_exit_view[0].syscall_exit_view_token=0' "$report_txt"
grep -Fq 'syscall_exit_view[0].syscall_return_view_token=0' "$report_txt"
grep -Fq 'syscall_exit_view[0].syscall_number=512' "$report_txt"
grep -Fq 'syscall_exit_view[0].handler_slot=0' "$report_txt"
grep -Fq 'syscall_exit_view[0].dispatch_slot=1024' "$report_txt"
grep -Fq 'syscall_exit_view[0].return_slot=2048' "$report_txt"
grep -Fq 'syscall_exit_view[0].exit_slot=3072' "$report_txt"
grep -Fq 'syscall_exit_view[0].result_register_slot=10' "$report_txt"
grep -Fq 'syscall_exit_view[0].errno_slot=11' "$report_txt"
grep -Fq 'syscall_exit_view[0].status_slot=12' "$report_txt"
grep -Fq 'syscall_exit_view[0].argument_count=6' "$report_txt"
grep -Fq 'syscall_exit_view[0].syscall_return_view_declared=1' "$report_txt"
grep -Fq 'syscall_exit_view[0].syscall_exit_view_declared=1' "$report_txt"
grep -Fq 'syscall_exit_view[0].syscall_exit_declared=1' "$report_txt"
grep -Fq 'syscall_exit_view[0].syscall_exit_window_declared=1' "$report_txt"
grep -Fq 'syscall_exit_view[0].syscall_exit_view_planned=0' "$report_txt"
grep -Fq 'syscall_exit_view[0].syscall_exit_planned=0' "$report_txt"
grep -Fq 'syscall_exit_view[0].syscall_exit_commit_planned=0' "$report_txt"
grep -Fq 'syscall_exit_view[0].runtime_entry_syscall_exit_view_allowed=0' "$report_txt"
grep -Fq 'syscall_exit_view[0].syscall_exit_allowed=0' "$report_txt"
grep -Fq 'syscall_exit_view[0].syscall_exit_commit_allowed=0' "$report_txt"
grep -Fq 'syscall_exit_view[0].no_effect=1' "$report_txt"

printf 'kernel_runtime_entry_syscall_exit_view_report_runner: ok\n'
