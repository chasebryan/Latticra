...
require_contains 'release_toolchain_availability_audit_passed=0' "$status"
require_contains 'release_toolchain_ready=0' "$status"
...
require_contains 'release_toolchain_availability_audit_passed=0' "$readiness"
require_contains 'release_toolchain_ready=0' "$readiness"
require_contains 'rpmbuild_available=0' "$readiness"
require_contains 'rpm_available=0' "$readiness"
require_contains 'release_artifact_build_tool_available=0' "$readiness"
require_contains 'release_artifact_query_tool_available=0' "$readiness"
...
require_contains 'release_toolchain_availability_audit_passed=0' "$ledger"
require_contains 'release_toolchain_ready=0' "$ledger"
require_contains 'rpmbuild_available=0' "$ledger"
require_contains 'rpm_available=0' "$ledger"
