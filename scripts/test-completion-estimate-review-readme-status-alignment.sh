...
require_contains '| Public documentation posture | Strong but still evolving; around 94% planning estimate |' README.md
require_contains 'CURRENT_ESTIMATE_MATHEMATICAL_REBASE_2026_05_28.md' README.md
require_contains '| Latticra Seal | Local evidence, receipts, signed receipt proof-path planning, hybrid envelope self-tests, and denied-by-default runtime boundaries |' README.md
