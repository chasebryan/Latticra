...
require_contains '| Current public estimate | Roughly 47% overall system planning estimate |' README.md
require_contains '| Foundation documents and contracts | Mature relative to implementation; around 96% planning estimate |' README.md
require_contains '| Public documentation posture | Strong but still evolving; around 93% planning estimate |' README.md
require_contains 'CURRENT_ESTIMATE_MATHEMATICAL_REBASE_2026_05_27.md' README.md
require_contains '| Latticra Seal | Local evidence, receipts, hybrid envelope self-tests, and denied-by-default runtime boundaries |' README.md
...
require_contains '| Overall Latticra system | 47% |' STATUS.md
require_contains '| Latticra Seal / local evidence layer | 44% |' STATUS.md
require_contains '| Security-hardening implementation | 13% |' STATUS.md
require_contains '| Public product readiness | 12% |' STATUS.md
...
require_contains '| Overall Latticra system | 47% |' docs/status/CURRENT_STATUS.md
require_contains '| Public product readiness | 12% |' docs/status/CURRENT_STATUS.md
