...
tmpdir="$(mktemp -d "${TMPDIR:-/tmp}/latticra-kernel-runtime-entry-recovery-closeout-observation-view-report.XXXXXX")"
trap 'rm -rf "$tmpdir"' EXIT INT HUP TERM

report_bin="$tmpdir/latticra-kernel-runtime-entry-recovery-closeout-observation-view-report"
report_txt="$tmpdir/latticra-kernel-runtime-entry-recovery-closeout-observation-view-report.txt"
...
cc $CFLAGS \
  ...
  tools/kernel_runtime_entry_recovery_closeout_observation_view_report.c \
  -o "$report_bin"

"$report_bin" > "$report_txt"

grep -Fq 'LATTICRA KERNEL RUNTIME ENTRY RECOVERY CLOSEOUT OBSERVATION VIEW REPORT' "$report_txt"
grep -Fq 'recovery_closeout_observation_view_status=runtime-entry-recovery-closeout-observation-view-seed-ready' "$report_txt"
...
grep -Fq 'evidence_level=48' "$report_txt"
grep -Fq 'recovery_closeout_observation_view[0].process_label=kernel-report-process-metadata' "$report_txt"
grep -Fq 'recovery_closeout_observation_view[0].recovery_closeout_observation_view_class=kernel-report-runtime-entry-recovery-closeout-observation-view' "$report_txt"
grep -Fq 'recovery_closeout_observation_view[0].recovery_closeout_observation_view_token=0' "$report_txt"
grep -Fq 'recovery_closeout_observation_view[0].recovery_outcome_observation_view_token=0' "$report_txt"
grep -Fq 'recovery_closeout_observation_view[0].recovery_disposition_observation_view_token=0' "$report_txt"
grep -Fq 'recovery_closeout_observation_view[0].recovery_outcome_observation_slot=14336' "$report_txt"
grep -Fq 'recovery_closeout_observation_view[0].recovery_closeout_observation_slot=15360' "$report_txt"
grep -Fq 'recovery_closeout_observation_view[0].recovery_outcome_slot=35' "$report_txt"
grep -Fq 'recovery_closeout_observation_view[0].recovery_closeout_slot=36' "$report_txt"
grep -Fq 'recovery_closeout_observation_view[0].recovery_closeout_observation_declared=1' "$report_txt"
grep -Fq 'recovery_closeout_observation_view[0].recovery_closeout_observation_planned=0' "$report_txt"
grep -Fq 'recovery_closeout_observation_view[0].runtime_entry_recovery_closeout_observation_view_allowed=0' "$report_txt"
grep -Fq 'recovery_closeout_observation_view[0].runtime_entry_recovery_outcome_observation_view_allowed=0' "$report_txt"
grep -Fq 'recovery_closeout_observation_view[0].recovery_closeout_observation_allowed=0' "$report_txt"
grep -Fq 'recovery_closeout_observation_view[0].recovery_closeout_allowed=0' "$report_txt"
grep -Fq 'recovery_closeout_observation_view[0].recovery_outcome_observation_allowed=0' "$report_txt"
grep -Fq 'recovery_closeout_observation_view[0].recovery_outcome_allowed=0' "$report_txt"
grep -Fq 'recovery_closeout_observation_view[0].no_effect=1' "$report_txt"

printf 'kernel_runtime_entry_recovery_closeout_observation_view_report_runner: ok\n'
