...
tmpdir="$(mktemp -d "${TMPDIR:-/tmp}/latticra-kernel-runtime-entry-recovery-disposition-observation-view-report.XXXXXX")"
trap 'rm -rf "$tmpdir"' EXIT INT HUP TERM

report_bin="$tmpdir/latticra-kernel-runtime-entry-recovery-disposition-observation-view-report"
report_txt="$tmpdir/latticra-kernel-runtime-entry-recovery-disposition-observation-view-report.txt"
...
grep -Fq 'LATTICRA KERNEL RUNTIME ENTRY RECOVERY DISPOSITION OBSERVATION VIEW REPORT' "$report_txt"
grep -Fq 'recovery_disposition_observation_view_status=runtime-entry-recovery-disposition-observation-view-seed-ready' "$report_txt"
...
grep -Fq 'evidence_level=46' "$report_txt"
grep -Fq 'recovery_disposition_observation_view[0].process_label=kernel-report-process-metadata' "$report_txt"
grep -Fq 'recovery_disposition_observation_view[0].recovery_disposition_observation_view_class=kernel-report-runtime-entry-recovery-disposition-observation-view' "$report_txt"
grep -Fq 'recovery_disposition_observation_view[0].recovery_disposition_observation_view_token=0' "$report_txt"
grep -Fq 'recovery_disposition_observation_view[0].recovery_plan_observation_view_token=0' "$report_txt"
grep -Fq 'recovery_disposition_observation_view[0].recovery_boundary_observation_view_token=0' "$report_txt"
grep -Fq 'recovery_disposition_observation_view[0].recovery_plan_observation_slot=12288' "$report_txt"
grep -Fq 'recovery_disposition_observation_view[0].recovery_disposition_observation_slot=13312' "$report_txt"
grep -Fq 'recovery_disposition_observation_view[0].recovery_disposition_slot=34' "$report_txt"
grep -Fq 'recovery_disposition_observation_view[0].recovery_disposition_observation_declared=1' "$report_txt"
grep -Fq 'recovery_disposition_observation_view[0].recovery_disposition_observation_planned=0' "$report_txt"
grep -Fq 'recovery_disposition_observation_view[0].runtime_entry_recovery_disposition_observation_view_allowed=0' "$report_txt"
grep -Fq 'recovery_disposition_observation_view[0].recovery_disposition_observation_allowed=0' "$report_txt"
grep -Fq 'recovery_disposition_observation_view[0].recovery_disposition_allowed=0' "$report_txt"
grep -Fq 'recovery_disposition_observation_view[0].recovery_plan_observation_allowed=0' "$report_txt"
grep -Fq 'recovery_disposition_observation_view[0].no_effect=1' "$report_txt"

printf 'kernel_runtime_entry_recovery_disposition_observation_view_report_runner: ok\n'
