...
require_contains 'v1_release_required_gate_count=22' "$doc"
...
require_contains 'v1_release_evidence_blocker_count=8' "$doc"
require_contains 'v1_release_product_completion_blocker_count=8' "$doc"
...
require_contains 'release_signing_identity_reference_present=0' "$doc"
...
require_contains 'production_nadia_ready=0' "$doc"
require_contains 'q_seal_runtime_crypto_ready=0' "$doc"
...
require_contains 'v1_release_evidence_blocker_count=8' "$status"
require_contains 'v1_release_product_completion_blocker_count=8' "$status"
...
require_contains 'rpmbuild_available=0' "$status"
require_contains 'rpm_available=0' "$status"
require_contains 'release_signing_identity_reference_present=0' "$status"
require_contains 'sbom_evidence_candidate_valid=0' "$status"
require_contains 'multi_vm_evidence_candidate_valid=0' "$status"
require_contains 'production_nadia_ready=0' "$status"
require_contains 'q_seal_runtime_crypto_ready=0' "$status"
...
require_output_contains 'v1_release_required_gate_count=22' "$output"
...
require_output_contains 'rpmbuild_toolchain_missing' "$output"
require_output_contains 'rpm_toolchain_missing' "$output"
...
require_output_contains 'v1_release_evidence_blocker_count=8' "$output"
require_output_contains 'v1_release_product_completion_blocker_count=8' "$output"
...
require_output_contains 'fedora_production_readiness_evidence_complete=0' "$output"
require_output_contains 'production_nadia_ready=0' "$output"
