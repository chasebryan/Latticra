...
usage() {
  cat <<'USAGE'
Usage:
  nadia-prompt-evaluation-result-release-receipt-review-disposition-release-contract.sh [options]

Options:
  --prompt-evaluation-result-release-receipt-review-disposition <file>  Stage-37 Nadia prompt-evaluation result release receipt review disposition contract
  --request-class <label>                                               Operator request classification label
  --release-family <label>                                              Planned prompt-evaluation result release receipt review disposition release family label
  --release-format <label>                                              Planned prompt-evaluation result release receipt review disposition release format label
  --output <dir>                                                        Output directory for prompt-evaluation result release receipt review disposition release contracts

Creates Nadia Stage-38 prompt-evaluation result release receipt review
disposition release contract metadata only. It verifies the
prompt-evaluation result release receipt review disposition contract and
records planned review-disposition-release requirements before any
review-disposition release record, release decision, release publication,
release packaging, release receipt, disposition record, review record,
receipt record, model-output access, runtime invocation, prompt evaluation,
dialogue generation, token generation, or inference boundary. It does not
create releases, publish releases, package releases, create receipts, sign
receipts, create dispositions, read or record model output, record generated
...
fail() {
  printf 'nadia prompt evaluation result release receipt review disposition release contract: %s\n' "$1" >&2
  exit "${2:-1}"
}
...
require_field() {
  ...
  expected="$2"
  message="$3"
  actual=$(field_or_unknown "$key" "$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_ABS")
...
reject_boundary_label() {
  ...
  case "$normalized" in
    *sex*|*sexual*|*porn*|*erotic*|*nude*|*nudity*|*nsfw*|*fetish*|*adult-content*)
      fail "$name is outside Nadia prompt-evaluation-result-release-receipt-review-disposition-release boundary" 65
      ;;
  esac
}

PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION=""
REQUEST_CLASS="awareness-education"
RELEASE_FAMILY="operator-reviewed-prompt-evaluation-result-release-receipt-review-disposition-release"
RELEASE_FORMAT="contract-only-offline-evaluation-result-release-receipt-review-disposition-release"
OUTPUT=""

while [ "$#" -gt 0 ]; do
  case "$1" in
    --prompt-evaluation-result-release-receipt-review-disposition)
      [ "$#" -ge 2 ] || fail "missing value for --prompt-evaluation-result-release-receipt-review-disposition" 64
      PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION="$2"
      shift 2
      ;;
    --request-class)
...
if [ -z "$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION" ] && [ -f "reports/nadia/prompt-evaluation-result-release-receipt-review-disposition/latest-prompt-evaluation-result-release-receipt-review-disposition-contract.txt" ]; then
  PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION="reports/nadia/prompt-evaluation-result-release-receipt-review-disposition/latest-prompt-evaluation-result-release-receipt-review-disposition-contract.txt"
fi

[ -n "$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION" ] || fail "prompt evaluation result release receipt review disposition contract is required" 64
[ -f "$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION" ] || fail "prompt evaluation result release receipt review disposition contract not found: $PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION" 66
...
if [ -z "$OUTPUT" ]; then
  OUTPUT="reports/nadia/prompt-evaluation-result-release-receipt-review-disposition-release"
fi
mkdir -p "$OUTPUT"
OUT_DIR=$(CDPATH= cd -- "$OUTPUT" && pwd -P)

TS=${NADIA_PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_RELEASE_TIMESTAMP:-$(date -u +"%Y%m%dT%H%M%SZ")}
REPORT="$OUT_DIR/nadia-prompt-evaluation-result-release-receipt-review-disposition-release-contract-$TS.txt"

PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_ABS=$(cd "$(dirname -- "$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION")" && printf '%s/%s\n' "$(pwd -P)" "$(basename -- "$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION")")
PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_MEASUREMENT=$(measure_file "$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_ABS")

require_field stage 37-prompt-evaluation-result-release-receipt-review-disposition-contract "prompt evaluation result release receipt review disposition stage must be 37-prompt-evaluation-result-release-receipt-review-disposition-contract"
require_field prompt_evaluation_result_release_receipt_review_disposition_contract_status contract_only "prompt evaluation result release receipt review disposition contract must remain contract-only"
require_field prompt_evaluation_result_release_receipt_review_disposition_stage contract-only "prompt evaluation result release receipt review disposition stage must be contract-only"
require_field prompt_evaluation_result_release_receipt_review_disposition_authority 0 "prompt evaluation result release receipt review disposition authority must remain denied"
require_field prompt_evaluation_result_release_receipt_review_disposition_allowed 0 "prompt evaluation result release receipt review disposition must remain disallowed"
require_field prompt_evaluation_result_release_receipt_review_disposition_recorded 0 "prompt evaluation result release receipt review disposition must not be recorded"
require_field prompt_evaluation_result_release_receipt_review_disposition_created 0 "prompt evaluation result release receipt review disposition must not be created"
require_field prompt_evaluation_result_release_receipt_review_disposition_performed 0 "prompt evaluation result release receipt review disposition must not be performed"
require_field prompt_evaluation_result_release_receipt_review_disposition_metadata_present 1 "prompt evaluation result release receipt review disposition metadata must be present"
require_field prompt_evaluation_result_release_receipt_review_disposition_decision blocked_contract_only "prompt evaluation result release receipt review disposition decision must be blocked_contract_only"
require_field prompt_evaluation_result_release_receipt_review_disposition_evidence_present 1 "prompt evaluation result release receipt review disposition evidence must be present"
require_field prompt_evaluation_result_release_receipt_review_disposition_source_policy operator-reviewed-offline "prompt evaluation result release receipt review disposition source policy must be operator-reviewed-offline"
require_field prompt_evaluation_result_release_receipt_review_disposition_plan_recorded 1 "prompt evaluation result release receipt review disposition plan must be recorded"
require_field prompt_evaluation_result_release_receipt_review_disposition_result_recorded 0 "prompt evaluation result release receipt review disposition result must remain absent"
require_field prompt_evaluation_result_release_receipt_review_disposition_runtime_invoked 0 "prompt evaluation result release receipt review disposition runtime must not be invoked"
...
require_field requires_future_prompt_evaluation_result_release_receipt_review_disposition_release_contract 1 "future prompt evaluation result release receipt review disposition release contract must be required"
require_field prompt_evaluation_result_release_receipt_review_disposition_promotion_allowed 0 "prompt evaluation result release receipt review disposition must not allow promotion"
require_field requires_prompt_evaluation_result_release_receipt_review_disposition_schema_policy 1 "prompt evaluation result release receipt review disposition schema policy must be required"
require_field requires_prompt_evaluation_result_release_receipt_review_disposition_denial_policy 1 "prompt evaluation result release receipt review disposition denial policy must be required"
require_field requires_prompt_evaluation_result_release_receipt_review_disposition_release_policy 1 "prompt evaluation result release receipt review disposition release policy must be required"
...
PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_CONTRACT_STATUS=$(field_or_unknown prompt_evaluation_result_release_receipt_review_disposition_contract_status "$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_ABS")
PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_STAGE=$(field_or_unknown prompt_evaluation_result_release_receipt_review_disposition_stage "$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_ABS")
PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_FAMILY=$(field_or_unknown prompt_evaluation_result_release_receipt_review_disposition_family "$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_ABS")
PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_FORMAT=$(field_or_unknown prompt_evaluation_result_release_receipt_review_disposition_format "$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_ABS")
PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_STAGE=$(field_or_unknown prompt_evaluation_result_release_receipt_review_stage "$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_ABS")
PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_STAGE=$(field_or_unknown prompt_evaluation_result_release_receipt_stage "$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_ABS")
PROMPT_EVALUATION_RESULT_RELEASE_STAGE=$(field_or_unknown prompt_evaluation_result_release_stage "$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_ABS")
PROMPT_EVALUATION_RESULT_DISPOSITION_STAGE=$(field_or_unknown prompt_evaluation_result_disposition_stage "$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_ABS")
PROMPT_EVALUATION_RESULT_REVIEW_STAGE=$(field_or_unknown prompt_evaluation_result_review_stage "$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_ABS")
PROMPT_EVALUATION_RESULT_STAGE=$(field_or_unknown prompt_evaluation_result_stage "$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_ABS")
...
prompt_evaluation_result_release_receipt_review_disposition_release_family=$RELEASE_FAMILY
prompt_evaluation_result_release_receipt_review_disposition_release_format=$RELEASE_FORMAT
...
[inputs]
prompt_evaluation_result_release_receipt_review_disposition=$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_ABS
prompt_evaluation_result_release_receipt_review_disposition_measurement=$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_MEASUREMENT
prompt_evaluation_result_release_receipt_review_disposition_stage_required=37-prompt-evaluation-result-release-receipt-review-disposition-contract
prompt_evaluation_result_release_receipt_review_disposition_contract_status=$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_CONTRACT_STATUS
...
prompt_evaluation_result_release_receipt_review_disposition_family=$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_FAMILY
prompt_evaluation_result_release_receipt_review_disposition_format=$PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_FORMAT
...
[prompt_evaluation_result_release_receipt_review_disposition_release_contract]
...
[prompt_evaluation_result_release_receipt_review_disposition_release_requirements]
...
[prompt_evaluation_result_release_receipt_review_disposition_release_denial_boundary]
prompt_evaluation_result_release_receipt_review_disposition_release_authority=0
prompt_evaluation_result_release_receipt_review_disposition_release_allowed=0
prompt_evaluation_result_release_receipt_review_disposition_release_open_authority=0
prompt_evaluation_result_release_receipt_review_disposition_release_read_authority=0
prompt_evaluation_result_release_receipt_review_disposition_release_write_authority=0
prompt_evaluation_result_release_receipt_review_disposition_release_execute_authority=0
prompt_evaluation_result_release_receipt_review_disposition_release_runtime_authority=0
prompt_evaluation_result_release_receipt_review_disposition_release_prompt_evaluation_authority=0
prompt_evaluation_result_release_receipt_review_disposition_release_token_generation_authority=0
prompt_evaluation_result_release_receipt_review_disposition_release_inference_authority=0
prompt_evaluation_result_release_receipt_review_disposition_release_generation_authority=0
prompt_evaluation_result_release_receipt_review_disposition_release_recording_authority=0
prompt_evaluation_result_release_receipt_review_disposition_release_performed=0
prompt_evaluation_result_release_receipt_review_disposition_release_created=0
...
cp "$REPORT" "$OUT_DIR/latest-prompt-evaluation-result-release-receipt-review-disposition-release-contract.txt"

printf 'NADIA_PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_RELEASE_CONTRACT=%s\n' "$REPORT"
printf 'NADIA_PROMPT_EVALUATION_RESULT_RELEASE_RECEIPT_REVIEW_DISPOSITION_RELEASE_RECORDED=0\n'
