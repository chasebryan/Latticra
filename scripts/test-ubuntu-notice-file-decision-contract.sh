...
debian_copyright_mapping_contract='docs/UBUNTU_DEBIAN_COPYRIGHT_NOTICE_MAPPING_CONTRACT.md'
...
require_file "$debian_copyright_mapping_contract"
...
require_contains 'ubuntu_debian_copyright_notice_mapping_contract_present=1' "$debian_copyright_mapping_contract"
