...
debian_agpl_present="$(contains 'License: AGPL-3.0-or-later' packaging/ubuntu/debian/copyright)"
debian_cc_by_present="$(contains 'License: CC-BY-4.0' packaging/ubuntu/debian/copyright)"
...
debian_copyright_agpl_mapping_present=$debian_agpl_present
debian_copyright_cc_by_mapping_present=$debian_cc_by_present
