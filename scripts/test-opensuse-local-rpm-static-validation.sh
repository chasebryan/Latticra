...
require_contains 'docs/OPENSUSE_RPM_PAYLOAD_INSPECTION_CONTRACT.md' docs/OPENSUSE_LOCAL_RPM_STATIC_VALIDATION.md
require_contains 'docs/OPENSUSE_RPM_INSTALL_REMOVE_TRANSCRIPT_CONTRACT.md' docs/OPENSUSE_LOCAL_RPM_STATIC_VALIDATION.md
...
require_contains 'scripts/test-opensuse-rpm-payload-inspection-contract.sh' docs/OPENSUSE_LOCAL_RPM_STATIC_VALIDATION.md
require_contains 'scripts/test-opensuse-rpm-install-remove-transcript-contract.sh' docs/OPENSUSE_LOCAL_RPM_STATIC_VALIDATION.md
...
require_contains 'Add openSUSE RPM build-evidence intake denial disposition closeout archive gate review contract' docs/OPENSUSE_LOCAL_RPM_STATIC_VALIDATION.md
