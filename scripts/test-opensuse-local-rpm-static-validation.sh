...
require_contains 'Add openSUSE RPM build-evidence intake denial disposition closeout archive gate contract' docs/OPENSUSE_LOCAL_RPM_STATIC_VALIDATION.md
