...
require_contains 'cli_commitment_output=redacted' docs/LATTICRA_SEAL_HYBRID_ENVELOPE_IMPLEMENTATION.md
require_contains 'cli_record_buffer_zeroized=1' docs/LATTICRA_SEAL_HYBRID_ENVELOPE_IMPLEMENTATION.md
require_contains 'cli_committed_ciphertext_buffer_zeroized=1' docs/LATTICRA_SEAL_HYBRID_ENVELOPE_IMPLEMENTATION.md
require_contains 'cli_committed_secret_outputs_zeroized=1' docs/LATTICRA_SEAL_HYBRID_ENVELOPE_IMPLEMENTATION.md
require_contains 'cli_recovered_plaintext_buffer_zeroized=1' docs/LATTICRA_SEAL_HYBRID_ENVELOPE_IMPLEMENTATION.md
require_contains 'cli_committed_recovered_plaintext_buffer_zeroized=1' docs/LATTICRA_SEAL_HYBRID_ENVELOPE_IMPLEMENTATION.md
require_contains 'cli_committed_tamper_plaintext_buffer_zeroized=1' docs/LATTICRA_SEAL_HYBRID_ENVELOPE_IMPLEMENTATION.md
require_contains 'cli_committed_detached_commitment_tampering_rejected_before_decrypt=1' docs/LATTICRA_SEAL_HYBRID_ENVELOPE_IMPLEMENTATION.md
...
require_contains 'cli_commitment_output=redacted' docs/status/SEAL_HYBRID_ENVELOPE_STATUS.md
require_contains 'cli_committed_ciphertext_buffer_zeroized=1' docs/status/SEAL_HYBRID_ENVELOPE_STATUS.md
require_contains 'cli_committed_secret_outputs_zeroized=1' docs/status/SEAL_HYBRID_ENVELOPE_STATUS.md
require_contains 'cli_committed_recovered_plaintext_buffer_zeroized=1' docs/status/SEAL_HYBRID_ENVELOPE_STATUS.md
require_contains 'cli_committed_tamper_plaintext_buffer_zeroized=1' docs/status/SEAL_HYBRID_ENVELOPE_STATUS.md
require_contains 'cli_committed_detached_commitment_tampering_rejected_before_decrypt=1' docs/status/SEAL_HYBRID_ENVELOPE_STATUS.md
