...
require_contains 'nadia_command_surface_audit_present=1' "$contract"
...
require_contains 'nadia_command_surface_audit_present=1' "$status"
...
require_contains 'nadia_command_surface_audit_present=1' "$script"
...
require_contains 'nadia_command_surface_audit_present=1' "$out"
