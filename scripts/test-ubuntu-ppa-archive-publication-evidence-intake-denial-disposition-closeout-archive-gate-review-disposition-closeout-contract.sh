...
require_file() {
  file="$1"
  if [ ! -f "$file" ]; then
    printf 'ubuntu ppa/archive publication evidence intake denial disposition closeout archive gate review disposition closeout contract: missing file: %s\n' "$file" >&2
    exit 1
  fi
}
...
require_contains() {
  ...
  if ! grep -Fq -- "$pattern" "$file"; then
    printf 'ubuntu ppa/archive publication evidence intake denial disposition closeout archive gate review disposition closeout contract: missing required pattern in %s: %s\n' "$file" "$pattern" >&2
    exit 1
  fi
}
...
require_no_ubuntu_artifacts() {
  ...
  if find "$dir" \( -name '*.deb' -o -name '*.dsc' -o -name '*.changes' -o -name '*.build' -o -name '*.buildinfo' \) -print | grep -q .; then
    printf 'ubuntu ppa/archive publication evidence intake denial disposition closeout archive gate review disposition closeout contract: unexpected Ubuntu package artifact under %s\n' "$dir" >&2
    exit 1
  fi
}

contract='docs/UBUNTU_PPA_ARCHIVE_PUBLICATION_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_CONTRACT.md'
...
workflow='.github/workflows/ubuntu-ppa-archive-publication-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-closeout-contract.yml'
...
require_contains 'Status: no-effect publication evidence intake denial disposition closeout archive gate review disposition closeout contract' "$contract"
...
require_contains 'publication_evidence_denial_archive_gate_review_disposition_closeout_identifier' "$contract"
...
require_contains 'publication_evidence_denial_archive_gate_review_disposition_closeout_decision' "$contract"
require_contains 'publication_evidence_denial_archive_gate_review_disposition_closeout_reason' "$contract"
require_contains 'publication_evidence_denial_archive_gate_review_disposition_closeout_reviewer' "$contract"
...
require_contains 'ubuntu_ppa_archive_publication_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_contract: ok' "$contract"
...
do
  require_contains 'ubuntu_ppa_archive_publication_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_contract_present=1' "$file"
  require_contains 'ubuntu_publication_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_contract_present=1' "$file"
  require_contains 'publication_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_state=closed-out-upheld-no-effect' "$file"
  require_contains 'publication_evidence_denial_archive_gate_review_disposition_closeout_present=1' "$file"
...
require_contains 'ubuntu_publication_evidence_intake_denial_archive_gate_review_disposition_closeout_present=1' "$status"
require_contains 'ubuntu_publication_evidence_intake_denial_archive_gate_review_disposition_closed_out=1' "$status"
require_contains 'ubuntu_publication_denial_archive_record_write_allowed=0' "$status"
require_contains 'ubuntu_publication_evidence_intake_denial_archive_gate_review_disposition_closeout_present=1' packaging/ubuntu/README.md
require_contains 'ubuntu_publication_evidence_intake_denial_archive_gate_review_disposition_closed_out=1' packaging/ubuntu/README.md
require_contains 'ubuntu_publication_denial_archive_record_write_allowed=0' packaging/ubuntu/README.md

require_contains 'sh scripts/test-ubuntu-ppa-archive-publication-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-closeout-contract.sh' docs/QUICK_START_CHEATSHEET.md
require_contains 'Ubuntu PPA Evidence Intake Denial Archive Gate Review Disposition Closeout Contract' "$workflow"
require_contains 'Run Ubuntu PPA archive publication evidence intake denial disposition closeout archive gate review disposition closeout guard' "$workflow"
require_contains 'sh scripts/test-ubuntu-ppa-archive-publication-evidence-intake-denial-disposition-closeout-archive-gate-review-disposition-closeout-contract.sh' "$workflow"

require_no_ubuntu_artifacts packaging/ubuntu

sh -n "$0"

printf 'ubuntu_ppa_archive_publication_evidence_intake_denial_disposition_closeout_archive_gate_review_disposition_closeout_contract: ok\n'
