...
makefile='Makefile'
next_phrase='Add a macOS reset/uninstall live-runner denied-dispatch review contract that keeps review-only dispatch denial evidence separate from any effects.'
previous_phrase='Add a macOS reset/uninstall live-runner denied-dispatch transcript contract that records the no-op runner denial without enabling deletion.'
...
require_contains 'live_runner_denied_dispatch_transcript_recorded=1' "$doc"
...
require_contains 'live_runner_denied_dispatch_transcript_dispatch_performed=0' "$doc"
require_contains 'live_runner_denied_dispatch_transcript_deletion_enabled=0' "$doc"
require_contains 'live_runner_denied_dispatch_transcript_receipt_write_enabled=0' "$doc"
require_contains 'live_runner_denied_dispatch_transcript_absence_report_write_enabled=0' "$doc"
require_contains 'live_runner_denied_dispatch_transcript_denial_reason=failed-preflight-and-denied-interface' "$doc"
require_contains 'live_runner_denied_dispatch_transcript_noop_denial_path_exercised=1' "$doc"
...
require_contains 'live_runner_denied_dispatch_transcript_requires_denial_reason=1' "$doc"
...
require_contains 'live_runner_denied_dispatch_transcript_result_denial_reason=met' "$doc"
require_contains 'live_runner_denied_dispatch_transcript_result_no_deletion=met' "$doc"
require_contains 'live_runner_denied_dispatch_transcript_entry_2=runner_interface_denied' "$doc"
require_contains 'live_runner_denied_dispatch_transcript_entry_4=dispatch_blocked' "$doc"
require_contains 'live_runner_denied_dispatch_transcript_phase_5_status=future-review-only' "$doc"
...
require_contains 'live_runner_denied_dispatch_transcript_contract_decision=dispatch-denied-no-effects-recorded' "$status"
require_contains 'live_runner_denied_dispatch_transcript_dispatch_attempted=0' "$status"
require_contains 'live_runner_denied_dispatch_transcript_dispatch_denied=1' "$status"
require_contains 'live_runner_denied_dispatch_transcript_dispatch_performed=0' "$status"
require_contains 'live_runner_denied_dispatch_transcript_deletion_enabled=0' "$status"
require_contains 'live_runner_denied_dispatch_transcript_denial_reason=failed-preflight-and-denied-interface' "$status"
require_contains 'live_runner_denied_dispatch_transcript_requires_denial_reason=1' "$status"
require_contains 'live_runner_denied_dispatch_transcript_result_denial_reason=met' "$status"
require_contains 'runtime_authority_granted=0' "$status"
require_contains "$next_phrase" "$status"
...
require_contains 'live_runner_denied_dispatch_transcript_dispatch_performed=0' "$readme"
...
require_contains 'live_runner_denied_dispatch_transcript_contract_state=recorded-no-effect' "$readme_status"
require_contains 'live_runner_denied_dispatch_transcript_dispatch_denied=1' "$readme_status"
require_contains 'live_runner_denied_dispatch_transcript_dispatch_performed=0' "$readme_status"
require_contains 'live_runner_denied_dispatch_transcript_deletion_enabled=0' "$readme_status"
...
require_contains "$previous_phrase" "$transfer_plan"
...
require_contains 'live_runner_denied_dispatch_transcript_dispatch_performed=0' "$transfer_status"
require_contains 'live_runner_denied_dispatch_transcript_deletion_enabled=0' "$transfer_status"
require_contains 'Current live-runner denied-dispatch transcript lane' "$transfer_status"
require_contains "$previous_phrase" "$transfer_status"
require_contains "$next_phrase" "$transfer_status"

require_contains 'next_lane=macos-reset-uninstall-live-runner-denied-dispatch-review-contract' "$noop_script"
...
require_contains 'live_runner_denied_dispatch_transcript_contract_decision=dispatch-denied-no-effects-recorded' "$script"
require_contains 'live_runner_denied_dispatch_transcript_dispatch_attempted=0' "$script"
require_contains 'live_runner_denied_dispatch_transcript_dispatch_enabled=0' "$script"
require_contains 'live_runner_denied_dispatch_transcript_dispatch_performed=0' "$script"
require_contains 'live_runner_denied_dispatch_transcript_deletion_enabled=0' "$script"
require_contains 'live_runner_denied_dispatch_transcript_requires_no_root=1' "$script"
...
require_output_contains "$output" 'live_runner_denied_dispatch_transcript_dispatch_attempted=0'
require_output_contains "$output" 'live_runner_denied_dispatch_transcript_dispatch_denied=1'
require_output_contains "$output" 'live_runner_denied_dispatch_transcript_dispatch_performed=0'
require_output_contains "$output" 'live_runner_denied_dispatch_transcript_deletion_enabled=0'
require_output_contains "$output" 'live_runner_denied_dispatch_transcript_denial_reason=failed-preflight-and-denied-interface'
