...
require_file() {
  file="$1"
  if [ ! -f "$file" ]; then
    printf 'ubuntu ppa/archive publication evidence intake denial disposition contract: missing file: %s\n' "$file" >&2
    exit 1
  fi
}
...
require_contains() {
  ...
  if ! grep -Fq -- "$pattern" "$file"; then
    printf 'ubuntu ppa/archive publication evidence intake denial disposition contract: missing required pattern in %s: %s\n' "$file" "$pattern" >&2
    exit 1
  fi
}
...
require_no_ubuntu_artifacts() {
  ...
  if find "$dir" \( -name '*.deb' -o -name '*.dsc' -o -name '*.changes' -o -name '*.build' -o -name '*.buildinfo' \) -print | grep -q .; then
    printf 'ubuntu ppa/archive publication evidence intake denial disposition contract: unexpected Ubuntu package artifact under %s\n' "$dir" >&2
    exit 1
  fi
}

contract='docs/UBUNTU_PPA_ARCHIVE_PUBLICATION_EVIDENCE_INTAKE_DENIAL_DISPOSITION_CONTRACT.md'
...
workflow='.github/workflows/ubuntu-ppa-archive-publication-evidence-intake-denial-disposition-contract.yml'
...
require_contains 'Status: no-effect publication evidence intake denial disposition contract' "$contract"
...
require_contains 'ubuntu_ppa_archive_publication_evidence_intake_denial_disposition_contract: ok' "$contract"
...
require_contains "$closeout_contract" "$review_contract"
...
require_contains "$archive_gate_contract" "$review_contract"
...
require_contains 'publication_evidence_denial_disposition_closeout_present=1' "$status"
require_contains 'publication_evidence_denial_disposition_closeout_decision=closeout-upheld-denial' "$status"
require_contains 'publication_evidence_intake_denial_disposition_state=closed-upheld-no-effect' "$status"
require_contains 'publication_evidence_denial_disposition_present=1' "$status"
require_contains 'publication_evidence_denial_disposition_decision=close-upheld-denial' "$status"
...
require_contains 'ubuntu_publication_evidence_intake_denial_closed=1' "$status"
...
require_contains 'ubuntu_publication_evidence_intake_denial_archived=0' "$status"
...
require_contains 'publication_evidence_denial_disposition_closeout_present=1' packaging/ubuntu/README.md
require_contains 'publication_evidence_denial_disposition_closeout_decision=closeout-upheld-denial' packaging/ubuntu/README.md
require_contains 'publication_evidence_intake_denial_disposition_state=closed-upheld-no-effect' packaging/ubuntu/README.md
require_contains 'publication_evidence_denial_disposition_present=1' packaging/ubuntu/README.md
require_contains 'publication_evidence_denial_disposition_decision=close-upheld-denial' packaging/ubuntu/README.md
...
require_contains 'ubuntu_publication_evidence_intake_denial_closed=1' packaging/ubuntu/README.md
...
require_contains 'ubuntu_publication_evidence_intake_denial_archived=0' packaging/ubuntu/README.md
...
require_contains 'publication_evidence_denial_disposition_closeout_present=1' README.md
require_contains 'publication_evidence_denial_disposition_closeout_decision=closeout-upheld-denial' README.md
require_contains 'publication_evidence_intake_denial_disposition_state=closed-upheld-no-effect' README.md
require_contains 'publication_evidence_denial_disposition_present=1' README.md
require_contains 'publication_evidence_denial_disposition_decision=close-upheld-denial' README.md
...
require_contains 'Ubuntu PPA Archive Publication Evidence Intake Denial Disposition Contract' "$workflow"
require_contains 'sh scripts/test-ubuntu-ppa-archive-publication-evidence-intake-denial-disposition-contract.sh' "$workflow"
...
printf 'ubuntu_ppa_archive_publication_evidence_intake_denial_disposition_contract: ok\n'
