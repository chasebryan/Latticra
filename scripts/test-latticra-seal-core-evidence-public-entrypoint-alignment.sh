...
require_contains 'core evidence report -> public status update -> status surface -> status index alignment -> public entrypoint alignment' "$record"
...
require_contains 'foundation_index_mentions_seal_core_evidence=1' "$record"
...
require_contains 'guarded policy-decision status surface' "$record"
...
require_contains 'SEAL_CORE_EVIDENCE_PUBLIC_ENTRYPOINT_ALIGNMENT.md' docs/FOUNDATION_INDEX.md
require_contains 'SEAL_CORE_EVIDENCE_STATUS.md' docs/FOUNDATION_INDEX.md
require_contains 'SEAL_CORE_EVIDENCE_INDEX_ALIGNMENT.md' docs/FOUNDATION_INDEX.md
require_contains 'SEAL_CORE_EVIDENCE_PUBLIC_ENTRYPOINT_ALIGNMENT.md' docs/status/README.md
