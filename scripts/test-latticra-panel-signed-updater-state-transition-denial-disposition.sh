...
require_contains 'Panel signed-updater state transition denial disposition review' "$review_doc"
require_contains 'Panel signed-updater state transition denial disposition review' "$review_status"
...
require_contains 'panel-signed-updater-state-transition-denial-disposition-review' "$review_script"
require_contains 'panel-signed-updater-state-transition-denial-disposition-review' "$review_test"
