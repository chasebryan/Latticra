...
usage() {
  cat <<'USAGE'
Usage:
  macos-reset-uninstall-live-runner-acceptance-denial-disposition-closeout-audit-review-contract.sh

Emits the no-effect macOS reset/uninstall live-runner acceptance-denial
disposition closeout audit review contract. It reviews the no-effect closeout
audit as stdout evidence only and keeps runner dispatch, deletion, receipt
writes, absence-report writes, network access, root action, runtime authority,
and host mutation disabled.
USAGE
}
...
reset_uninstall_live_runner_acceptance_denial_disposition_closeout_audit_review_contract_status=ok
...
live_runner_acceptance_denial_disposition_closeout_audit_review_scope=review-no-effect-closeout-audit-only
live_runner_acceptance_denial_disposition_closeout_audit_review_source=macos-reset-uninstall-live-runner-acceptance-denial-disposition-closeout-audit-contract
live_runner_acceptance_denial_disposition_closeout_audit_review_source_contract=macos-reset-uninstall-live-runner-acceptance-denial-disposition-closeout-audit-contract
...
live_runner_acceptance_denial_disposition_closeout_audit_review_closed_gate_reviewed=1
live_runner_acceptance_denial_disposition_closeout_audit_review_denial_reason_present=1
live_runner_acceptance_denial_disposition_closeout_audit_review_denial_reason_reviewed=1
...
live_runner_acceptance_denial_disposition_closeout_audit_review_effect=none
