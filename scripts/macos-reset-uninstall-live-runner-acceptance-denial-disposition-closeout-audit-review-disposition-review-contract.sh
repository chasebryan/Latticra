...
usage() {
  cat <<'USAGE'
Usage:
  macos-reset-uninstall-live-runner-acceptance-denial-disposition-closeout-audit-review-disposition-review-contract.sh

Emits the no-effect macOS reset/uninstall live-runner acceptance-denial
disposition closeout audit review disposition review contract. It reviews the
recorded no-effect closeout audit review disposition as stdout evidence only
...
reset_uninstall_live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_contract_status=ok
...
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_scope=review-no-effect-closeout-audit-review-disposition-only
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_source=macos-reset-uninstall-live-runner-acceptance-denial-disposition-closeout-audit-review-disposition-contract
...
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_disposition_requires_future_review=1
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_closed_gate_reviewed=1
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_denial_reason_present=1
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_denial_reason_reviewed=1
...
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_effect=none
...
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_opens_dispatch=0
...
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_result_closeout_audit_review=met
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_result_closeout_audit=met
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_result_closeout=met
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_result_acceptance_denial_disposition_review=met
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_result_closed_gate=met
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_result_no_effect_disposition=met
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_result_review_only=met
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_result_stdout_only=met
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_result_no_effects=met
...
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_result_no_receipt_write=met
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_result_no_absence_report_write=met
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_result_no_network=met
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_result_no_root=met
...
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_phase_1=load_acceptance_denial_disposition_closeout_audit_review_disposition
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_phase_2=review_no_effect_closeout_audit_review_disposition
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_phase_3=confirm_closed_dispatch_boundary
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_phase_4=handoff_to_acceptance_denial_disposition_closeout_audit_review_disposition_closeout
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_phase_1_status=contract-only
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_phase_2_status=review-only
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_phase_3_status=blocked-no-effect
live_runner_acceptance_denial_disposition_closeout_audit_review_disposition_review_phase_4_status=future-closeout-only
