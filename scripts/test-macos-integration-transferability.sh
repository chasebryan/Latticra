...
require_contains 'Add a macOS reset/uninstall operator-intent contract' "$plan"
...
require_contains 'Add a macOS reset/uninstall operator-intent contract' "$status"
