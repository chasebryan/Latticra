...
require_contains 'live_runner_denied_dispatch_transcript_recorded=1' "$status"
...
require_contains 'live_runner_denied_dispatch_transcript_dispatch_allowed=0' "$status"
