...
require_contains 'Add a macOS reset/uninstall effect-authorization contract' "$plan"
...
require_contains 'Add a macOS reset/uninstall effect-authorization contract' "$status"
