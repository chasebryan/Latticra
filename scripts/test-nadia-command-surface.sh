...
require_output_contains 'command=status stage=46' "$commands_out"
...
require_output_contains 'stage=46-prompt-evaluation-result-release-receipt-review-disposition-release-receipt-review-disposition-release-receipt-review-disposition-release-contract' "$status_out"
