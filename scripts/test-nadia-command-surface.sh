...
require_output_contains 'command=status stage=43' "$commands_out"
...
require_output_contains 'stage=43-prompt-evaluation-result-release-receipt-review-disposition-release-receipt-review-disposition-release-receipt-contract' "$status_out"
