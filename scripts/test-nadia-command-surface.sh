...
require_output_contains 'command=status stage=41' "$commands_out"
...
require_output_contains 'stage=41-prompt-evaluation-result-release-receipt-review-disposition-release-receipt-review-disposition-contract' "$status_out"
