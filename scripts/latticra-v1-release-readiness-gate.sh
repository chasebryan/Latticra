...
require_contains 'v1_evidence_blocker_audit_present=1' docs/LATTICRA_V1_0_0_EVIDENCE_BLOCKER_AUDIT_CONTRACT.md
require_contains 'v1_evidence_blocker_audit_present=1' docs/status/LATTICRA_V1_0_0_EVIDENCE_BLOCKER_AUDIT_STATUS.md
...
EVIDENCE_BLOCKER_AUDIT_OUTPUT="$(
  sh scripts/latticra-v1-evidence-blocker-audit.sh
)"
EVIDENCE_BLOCKER_AUDIT_PRESENT="$(output_value v1_evidence_blocker_audit_present "$EVIDENCE_BLOCKER_AUDIT_OUTPUT")"
EVIDENCE_BLOCKER_AUDIT_PASSED="$(output_value v1_evidence_blocker_audit_passed "$EVIDENCE_BLOCKER_AUDIT_OUTPUT")"
EVIDENCE_BLOCKER_DETAIL_COUNT="$(output_value v1_evidence_detail_blocker_count "$EVIDENCE_BLOCKER_AUDIT_OUTPUT")"
EVIDENCE_BLOCKER_DETAILS="$(output_value v1_evidence_detail_blockers "$EVIDENCE_BLOCKER_AUDIT_OUTPUT")"
...
v1_evidence_blocker_audit_present=$EVIDENCE_BLOCKER_AUDIT_PRESENT
v1_evidence_blocker_audit_passed=$EVIDENCE_BLOCKER_AUDIT_PASSED
v1_evidence_detail_blocker_count=$EVIDENCE_BLOCKER_DETAIL_COUNT
v1_evidence_detail_blockers=$EVIDENCE_BLOCKER_DETAILS
