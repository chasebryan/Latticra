...
require_contains 'Fedora disposable VM local RPM validation' "$readme"
require_contains 'one evidence-backed host-facing validation path' "$readme"
require_contains 'disposable_vm_validation_completed=1' "$readme"
require_contains 'live_host_validation_completed=1' "$readme"
...
require_contains 'RPM install, RPM verification, RPM removal, and post-removal absence verification' "$readme"
...
require_contains 'The only install-readiness statement currently supported by evidence is disposable Fedora VM local RPM validation' "$readme"
