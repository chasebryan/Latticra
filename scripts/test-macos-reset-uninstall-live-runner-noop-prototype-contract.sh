...
require_contains 'Add a macOS reset/uninstall live-runner acceptance-denial transcript contract that records the closed acceptance gate without dispatching effects.' "$status"
...
require_contains 'next_lane=macos-reset-uninstall-live-runner-acceptance-denial-transcript-contract' "$interface_script"
