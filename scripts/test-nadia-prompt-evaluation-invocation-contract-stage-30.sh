...
require_contains '| Nadia offline AI foundation | 68% |' "$readme"
...
require_contains '| Nadia offline AI foundation | 68% |' "$root_status"
require_contains '| Nadia offline AI foundation | 68% |' "$current_status"
...
require_contains 'Stage-31, Stage-32, Stage-33, and Stage-34 console surfaces are metadata-only' "$ui_model"
...
require_contains 'stage=34-prompt-evaluation-result-release-contract' "$apply_script"
require_contains 'stage=34-prompt-evaluation-result-release-contract' "$panel_config"
