...
require_contains '| Nadia offline AI foundation | 75% |' "$readme"
...
require_contains '| Nadia offline AI foundation | 75% |' "$root_status"
require_contains '| Nadia offline AI foundation | 75% |' "$current_status"
