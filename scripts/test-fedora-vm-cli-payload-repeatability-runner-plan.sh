...
require_contains 'Run the prevention surface consistency guard.' "$doc"
...
require_contains 'Execute latticra --prevention-evidence without root.' "$doc"
require_contains 'Execute latticra --prevention-gate without root.' "$doc"
require_contains 'Execute latticra --prevention-fixtures without root.' "$doc"
...
require_contains 'cli_prevention_research_output_recorded=1' "$doc"
require_contains 'cli_prevention_boundary_output_recorded=1' "$doc"
require_contains 'cli_prevention_evidence_output_recorded=1' "$doc"
require_contains 'cli_prevention_gate_output_recorded=1' "$doc"
require_contains 'cli_prevention_fixtures_output_recorded=1' "$doc"
require_contains 'cli_prevention_method_output_recorded=1' "$doc"
require_contains 'cli_prevention_surface_consistency_guard_passed=1' "$doc"
...
require_contains 'installed prevention research, boundary, evidence, gate, fixture, and method surfaces' "$status"
...
require_contains 'cli_prevention_research_repeatability_planned=1' "$status"
require_contains 'cli_prevention_boundary_repeatability_planned=1' "$status"
require_contains 'cli_prevention_evidence_repeatability_planned=1' "$status"
require_contains 'cli_prevention_gate_repeatability_planned=1' "$status"
require_contains 'cli_prevention_fixtures_repeatability_planned=1' "$status"
require_contains 'cli_prevention_method_repeatability_planned=1' "$status"
