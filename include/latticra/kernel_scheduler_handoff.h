#ifndef LATTICRA_KERNEL_SCHEDULER_HANDOFF_H
#define LATTICRA_KERNEL_SCHEDULER_HANDOFF_H
...
#define LATTICRA_KERNEL_SCHEDULER_HANDOFF_LABEL_MAX 64u
#define LATTICRA_KERNEL_SCHEDULER_HANDOFF_MAX 8u
#define LATTICRA_KERNEL_SCHEDULER_HANDOFF_REPORT_MAX 32768u

typedef struct {
    latticra_kernel_scheduler_dispatch_request_t scheduler_dispatch_request;
    size_t requested_handoff_count;
} latticra_kernel_scheduler_handoff_request_t;
...
typedef struct {
    ...
    char process_label[LATTICRA_KERNEL_SCHEDULER_HANDOFF_LABEL_MAX];
    char handoff_class[LATTICRA_KERNEL_SCHEDULER_HANDOFF_LABEL_MAX];
    char handoff_status[LATTICRA_KERNEL_SCHEDULER_HANDOFF_LABEL_MAX];
    char authority_status[LATTICRA_KERNEL_SCHEDULER_HANDOFF_LABEL_MAX];
    int declared;
    int handoff_planned;
...
} latticra_kernel_scheduler_handoff_entry_t;

typedef struct {
    latticra_status_t status;
    char handoff_status[LATTICRA_KERNEL_SCHEDULER_HANDOFF_LABEL_MAX];
    char policy_status[LATTICRA_KERNEL_SCHEDULER_HANDOFF_LABEL_MAX];
    latticra_kernel_scheduler_dispatch_result_t scheduler_dispatch;
    latticra_kernel_scheduler_handoff_entry_t handoffs[
        LATTICRA_KERNEL_SCHEDULER_HANDOFF_MAX];
    ...
    int host_effect_allowed;
    unsigned int evidence_level;
} latticra_kernel_scheduler_handoff_result_t;
