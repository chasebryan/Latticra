...
typedef enum {
    ...
    LATTICRA_LIR_NODE_LAT_STATE = 9,
    LATTICRA_LIR_NODE_LAT_POLICY = 10,
    LATTICRA_LIR_NODE_LAT_TRANSITION = 11,
    LATTICRA_LIR_NODE_LAT_ASSERTION = 12,
    LATTICRA_LIR_NODE_LAT_REQUIREMENT = 13,
    LATTICRA_LIR_NODE_LAT_EFFECT_DECLARATION = 14
...
typedef enum {
    ...
    LATTICRA_LIR_EDGE_TRANSITIONS_FROM = 5
