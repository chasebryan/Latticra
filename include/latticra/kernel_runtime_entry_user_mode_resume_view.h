#ifndef LATTICRA_KERNEL_RUNTIME_ENTRY_USER_MODE_RESUME_VIEW_H
#define LATTICRA_KERNEL_RUNTIME_ENTRY_USER_MODE_RESUME_VIEW_H
...
#define LATTICRA_KERNEL_RUNTIME_ENTRY_USER_MODE_RESUME_VIEW_LABEL_MAX 64u
#define LATTICRA_KERNEL_RUNTIME_ENTRY_USER_MODE_RESUME_VIEW_MAX 8u
#define LATTICRA_KERNEL_RUNTIME_ENTRY_USER_MODE_RESUME_VIEW_REPORT_MAX 65536u
...
typedef struct {
    size_t user_mode_resume_view_index;
    ...
    int resume_frame_declared;
    int instruction_pointer_declared;
    int stack_pointer_declared;
    char process_label[
        LATTICRA_KERNEL_RUNTIME_ENTRY_USER_MODE_RESUME_VIEW_LABEL_MAX];
    char user_mode_resume_view_class[
        LATTICRA_KERNEL_RUNTIME_ENTRY_USER_MODE_RESUME_VIEW_LABEL_MAX];
    char user_mode_resume_view_status[
        LATTICRA_KERNEL_RUNTIME_ENTRY_USER_MODE_RESUME_VIEW_LABEL_MAX];
    char authority_status[
        LATTICRA_KERNEL_RUNTIME_ENTRY_USER_MODE_RESUME_VIEW_LABEL_MAX];
    int declared;
    int user_mode_resume_view_planned;
...
} latticra_kernel_runtime_entry_user_mode_resume_view_entry_t;
