...
#define LATTICRA_KERNEL_IPC_TABLE_PORT_MAX 8u
...
typedef struct {
    ...
    char owner_process_label[LATTICRA_KERNEL_IPC_TABLE_LABEL_MAX];
    char peer_process_label[LATTICRA_KERNEL_IPC_TABLE_LABEL_MAX];
    char queue_status[LATTICRA_KERNEL_IPC_TABLE_LABEL_MAX];
...
} latticra_kernel_ipc_table_port_t;
...
typedef struct {
    ...
    latticra_kernel_ipc_table_port_t ports[LATTICRA_KERNEL_IPC_TABLE_PORT_MAX];
    size_t port_count;
    int no_effect;
