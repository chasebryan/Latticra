#ifndef LATTICRA_KERNEL_RUNTIME_ENTRY_SYSCALL_DISPATCH_VIEW_H
#define LATTICRA_KERNEL_RUNTIME_ENTRY_SYSCALL_DISPATCH_VIEW_H
...
#define LATTICRA_KERNEL_RUNTIME_ENTRY_SYSCALL_DISPATCH_VIEW_LABEL_MAX 64u
#define LATTICRA_KERNEL_RUNTIME_ENTRY_SYSCALL_DISPATCH_VIEW_MAX 8u
#define LATTICRA_KERNEL_RUNTIME_ENTRY_SYSCALL_DISPATCH_VIEW_REPORT_MAX 65536u
...
typedef struct {
    size_t syscall_dispatch_view_index;
    ...
    int syscall_dispatch_declared;
    int syscall_argument_window_declared;
    ...
    char process_label[
        LATTICRA_KERNEL_RUNTIME_ENTRY_SYSCALL_DISPATCH_VIEW_LABEL_MAX];
    char syscall_dispatch_view_class[
        LATTICRA_KERNEL_RUNTIME_ENTRY_SYSCALL_DISPATCH_VIEW_LABEL_MAX];
    char syscall_dispatch_view_status[
        LATTICRA_KERNEL_RUNTIME_ENTRY_SYSCALL_DISPATCH_VIEW_LABEL_MAX];
    char authority_status[
        LATTICRA_KERNEL_RUNTIME_ENTRY_SYSCALL_DISPATCH_VIEW_LABEL_MAX];
    int declared;
    int syscall_dispatch_view_planned;
    int syscall_dispatch_view_built;
    int syscall_dispatch_view_installed;
    int syscall_dispatch_planned;
    int syscall_argument_copy_planned;
...
} latticra_kernel_runtime_entry_syscall_dispatch_view_entry_t;
...
typedef struct {
    ...
    latticra_kernel_runtime_entry_syscall_dispatch_view_entry_t
        syscall_dispatch_views[
            LATTICRA_KERNEL_RUNTIME_ENTRY_SYSCALL_DISPATCH_VIEW_MAX];
    size_t syscall_dispatch_view_count;
    int no_effect;
    int runtime_entry_syscall_dispatch_view_allowed;
    int runtime_entry_syscall_gate_view_allowed;
    int runtime_entry_privilege_level_view_allowed;
