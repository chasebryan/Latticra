#ifndef LATTICRA_KERNEL_RUNTIME_ENTRY_RECOVERY_DISPOSITION_OBSERVATION_VIEW_H
#define LATTICRA_KERNEL_RUNTIME_ENTRY_RECOVERY_DISPOSITION_OBSERVATION_VIEW_H
...
#define LATTICRA_KERNEL_RUNTIME_ENTRY_RECOVERY_DISPOSITION_OBSERVATION_VIEW_LABEL_MAX 112u
#define LATTICRA_KERNEL_RUNTIME_ENTRY_RECOVERY_DISPOSITION_OBSERVATION_VIEW_MAX 8u
#define LATTICRA_KERNEL_RUNTIME_ENTRY_RECOVERY_DISPOSITION_OBSERVATION_VIEW_REPORT_MAX 65536u
...
typedef struct {
    ...
    size_t requested_recovery_disposition_observation_view_count;
} latticra_kernel_runtime_entry_recovery_disposition_observation_view_request_t;

typedef struct {
    size_t recovery_disposition_observation_view_index;
    unsigned long recovery_disposition_observation_view_token;
    unsigned long recovery_plan_observation_view_token;
    unsigned long recovery_boundary_observation_view_token;
    unsigned long persistence_boundary_observation_view_token;
    ...
    unsigned long persistence_boundary_slot;
    unsigned long recovery_boundary_slot;
    unsigned long recovery_plan_observation_slot;
    unsigned long recovery_disposition_observation_slot;
    unsigned long recovery_epoch_slot;
    unsigned long recovery_reason_slot;
    unsigned long recovery_plan_slot;
    unsigned long recovery_disposition_slot;
    unsigned long recovery_authority_slot;
    int persistence_boundary_observation_view_declared;
    int quiescent_return_observation_view_declared;
    int recovery_boundary_observation_view_declared;
    int recovery_plan_observation_view_declared;
    int recovery_disposition_observation_view_declared;
    int persistence_boundary_observation_declared;
    int persistence_boundary_declared;
    int quiescent_return_observation_declared;
    int quiescent_return_declared;
    int recovery_boundary_observation_declared;
    int recovery_boundary_declared;
    int recovery_plan_observation_declared;
    int recovery_plan_declared;
    int recovery_disposition_observation_declared;
    int recovery_disposition_declared;
    int recovery_authority_observation_declared;
    char process_label[
        LATTICRA_KERNEL_RUNTIME_ENTRY_RECOVERY_DISPOSITION_OBSERVATION_VIEW_LABEL_MAX];
    char recovery_disposition_observation_view_class[
        LATTICRA_KERNEL_RUNTIME_ENTRY_RECOVERY_DISPOSITION_OBSERVATION_VIEW_LABEL_MAX];
    char recovery_disposition_observation_view_status[
        LATTICRA_KERNEL_RUNTIME_ENTRY_RECOVERY_DISPOSITION_OBSERVATION_VIEW_LABEL_MAX];
    char authority_status[
        LATTICRA_KERNEL_RUNTIME_ENTRY_RECOVERY_DISPOSITION_OBSERVATION_VIEW_LABEL_MAX];
    int declared;
    int recovery_disposition_observation_view_planned;
    int recovery_disposition_observation_planned;
    int recovery_plan_observation_planned;
    int recovery_plan_planned;
    int recovery_boundary_observation_planned;
    int recovery_boundary_planned;
    int recovery_disposition_planned;
    int persistence_boundary_observation_planned;
    int persistence_boundary_planned;
    int persistence_commit_planned;
...
typedef struct {
    ...
    latticra_kernel_runtime_entry_recovery_disposition_observation_view_entry_t
        recovery_disposition_observation_views[
...
latticra_kernel_runtime_entry_recovery_disposition_observation_view_evaluate(
    const latticra_kernel_runtime_entry_recovery_disposition_observation_view_request_t
        *request,
    latticra_kernel_runtime_entry_recovery_disposition_observation_view_result_t
        *result);
...
latticra_kernel_runtime_entry_recovery_disposition_observation_view_report(
    const latticra_kernel_runtime_entry_recovery_disposition_observation_view_result_t
        *result,
    char *buffer,
    size_t buffer_len);
