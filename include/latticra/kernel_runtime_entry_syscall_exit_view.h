#ifndef LATTICRA_KERNEL_RUNTIME_ENTRY_SYSCALL_EXIT_VIEW_H
#define LATTICRA_KERNEL_RUNTIME_ENTRY_SYSCALL_EXIT_VIEW_H
...
#define LATTICRA_KERNEL_RUNTIME_ENTRY_SYSCALL_EXIT_VIEW_LABEL_MAX 64u
#define LATTICRA_KERNEL_RUNTIME_ENTRY_SYSCALL_EXIT_VIEW_MAX 8u
#define LATTICRA_KERNEL_RUNTIME_ENTRY_SYSCALL_EXIT_VIEW_REPORT_MAX 65536u
...
typedef struct {
    size_t syscall_exit_view_index;
    ...
    unsigned long syscall_exit_view_rank;
    ...
    unsigned long status_slot;
    unsigned long argument_count;
    int syscall_return_view_declared;
    int syscall_exit_view_declared;
    int syscall_return_declared;
    int syscall_exit_declared;
    int syscall_exit_window_declared;
    int user_mode_exit_declared;
    int kernel_mode_exit_declared;
    char process_label[
        LATTICRA_KERNEL_RUNTIME_ENTRY_SYSCALL_EXIT_VIEW_LABEL_MAX];
    char syscall_exit_view_class[
        LATTICRA_KERNEL_RUNTIME_ENTRY_SYSCALL_EXIT_VIEW_LABEL_MAX];
    char syscall_exit_view_status[
        LATTICRA_KERNEL_RUNTIME_ENTRY_SYSCALL_EXIT_VIEW_LABEL_MAX];
    char authority_status[
        LATTICRA_KERNEL_RUNTIME_ENTRY_SYSCALL_EXIT_VIEW_LABEL_MAX];
    int declared;
    int syscall_exit_view_planned;
    int syscall_exit_planned;
    int syscall_exit_commit_planned;
    int return_state_commit_planned;
    int process_wake_planned;
...
} latticra_kernel_runtime_entry_syscall_exit_view_entry_t;
...
typedef struct {
    ...
    size_t syscall_exit_view_count;
    int no_effect;
    int runtime_entry_syscall_exit_view_allowed;
    int runtime_entry_syscall_return_view_allowed;
    int runtime_entry_syscall_dispatch_view_allowed;
