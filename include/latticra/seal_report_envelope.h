...
#define LATTICRA_SEAL_REPORT_ENVELOPE_RENDER_MAX 8192u
...
typedef enum {
    ...
    LATTICRA_SEAL_REPORT_ENVELOPE_DENIED_CRYPTO_GRADUATION_GATE = 10
...
typedef struct {
    ...
    char crypto_graduation_profile[LATTICRA_SEAL_REPORT_ENVELOPE_PROFILE_MAX];
    char assurance_baseline_profile[LATTICRA_SEAL_REPORT_ENVELOPE_PROFILE_MAX];
    char crypto_graduation_gate_state[LATTICRA_SEAL_REPORT_ENVELOPE_STATE_MAX];
