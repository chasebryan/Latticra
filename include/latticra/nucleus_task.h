...
typedef struct {
    ...
    char execution_status[LATTICRA_NUCLEUS_TASK_LABEL_MAX];
    char effect_status[LATTICRA_NUCLEUS_TASK_LABEL_MAX];
    char runtime_status[LATTICRA_NUCLEUS_TASK_LABEL_MAX];
