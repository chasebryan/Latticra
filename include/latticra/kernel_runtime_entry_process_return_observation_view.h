#ifndef LATTICRA_KERNEL_RUNTIME_ENTRY_PROCESS_RETURN_OBSERVATION_VIEW_H
#define LATTICRA_KERNEL_RUNTIME_ENTRY_PROCESS_RETURN_OBSERVATION_VIEW_H
...
#define LATTICRA_KERNEL_RUNTIME_ENTRY_PROCESS_RETURN_OBSERVATION_VIEW_LABEL_MAX 80u
#define LATTICRA_KERNEL_RUNTIME_ENTRY_PROCESS_RETURN_OBSERVATION_VIEW_MAX 8u
#define LATTICRA_KERNEL_RUNTIME_ENTRY_PROCESS_RETURN_OBSERVATION_VIEW_REPORT_MAX 65536u
...
typedef struct {
    size_t process_return_observation_view_index;
    ...
    unsigned long process_return_observation_view_rank;
    ...
    unsigned long process_return_epoch_slot;
    unsigned long process_return_reason_slot;
    unsigned long process_state_slot;
    ...
    int process_state_observation_declared;
    int process_return_reason_declared;
    char process_label[
        LATTICRA_KERNEL_RUNTIME_ENTRY_PROCESS_RETURN_OBSERVATION_VIEW_LABEL_MAX];
    char process_return_observation_view_class[
        LATTICRA_KERNEL_RUNTIME_ENTRY_PROCESS_RETURN_OBSERVATION_VIEW_LABEL_MAX];
    char process_return_observation_view_status[
        LATTICRA_KERNEL_RUNTIME_ENTRY_PROCESS_RETURN_OBSERVATION_VIEW_LABEL_MAX];
    char authority_status[
        LATTICRA_KERNEL_RUNTIME_ENTRY_PROCESS_RETURN_OBSERVATION_VIEW_LABEL_MAX];
    int declared;
    int process_return_observation_view_planned;
...
typedef struct {
    ...
    latticra_kernel_runtime_entry_process_return_observation_view_entry_t
        process_return_observation_views[
...
latticra_kernel_runtime_entry_process_return_observation_view_default_request(
    latticra_kernel_runtime_entry_process_return_observation_view_request_t *request);

latticra_status_t
latticra_kernel_runtime_entry_process_return_observation_view_evaluate(
    const latticra_kernel_runtime_entry_process_return_observation_view_request_t *request,
    latticra_kernel_runtime_entry_process_return_observation_view_result_t *result);

latticra_status_t
latticra_kernel_runtime_entry_process_return_observation_view_report(
    const latticra_kernel_runtime_entry_process_return_observation_view_result_t *result,
    char *buffer,
    size_t buffer_len);
