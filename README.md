...
- [`docs/L_UI_DECODED_NUL_ACCEPTANCE_CONTRACT.md`](docs/L_UI_DECODED_NUL_ACCEPTANCE_CONTRACT.md) — escaped decoded NUL acceptance rules after length-carrying AST string storage.
- [`docs/L_UI_DECODED_NUL_ACCEPTANCE_IMPLEMENTATION_PLAN.md`](docs/L_UI_DECODED_NUL_ACCEPTANCE_IMPLEMENTATION_PLAN.md) — parser validation changes, decode helper changes, AST/report expectations, diagnostic compatibility, source spans, and exact tests before accepting escaped `\x00`.
- [`docs/L_UI_DECODED_NUL_ACCEPTANCE_IMPLEMENTATION.md`](docs/L_UI_DECODED_NUL_ACCEPTANCE_IMPLEMENTATION.md) — escaped decoded NUL acceptance for L-UI source-backed AST strings.
- [`docs/L_UI_SOURCE_BUFFER_LITERAL_NUL_POLICY_CONTRACT.md`](docs/L_UI_SOURCE_BUFFER_LITERAL_NUL_POLICY_CONTRACT.md) — policy keeping literal source-buffer NUL rejected while escaped decoded NUL remains accepted.
