...
The proof-object lane now includes [Proof Object 1](docs/LATTICRA_PROOF_OBJECT_1_EMERGENT_PARTICLE_MASS.md), [Proof Object 2](docs/LATTICRA_PROOF_OBJECT_2_HIGGS_COUNTERPLAY.md), [Proof Object 3](docs/LATTICRA_PROOF_OBJECT_3_HIGGS_CAUSAL_CLOSURE_NO_GO.md), [Proof Object 4](docs/LATTICRA_PROOF_OBJECT_4_IDENTITY_REPLAY_IMPEDANCE.md), the [Candidate Particle Table](docs/LATTICRA_IDENTITY_REPLAY_IMPEDANCE_CANDIDATE_PARTICLE_TABLE.md), the [L0 Mass-Ratio Runner](docs/LATTICRA_IDENTITY_REPLAY_IMPEDANCE_TOY_SUBSTRATE_L0_MASS_RATIO_RUNNER.md), the [L1 Constrained Search](docs/LATTICRA_IDENTITY_REPLAY_IMPEDANCE_L1_CONSTRAINED_SUBSTRATE_SEARCH.md), the [L2 Pre-Registered Holdout](docs/LATTICRA_IDENTITY_REPLAY_IMPEDANCE_L2_PREREGISTERED_SUBSTRATE_LAW_BLINDED_HOLDOUT.md), the [L3 Holdout Intake](docs/LATTICRA_IDENTITY_REPLAY_IMPEDANCE_L3_EXTERNAL_BLINDED_HOLDOUT_INTAKE.md), the [L4 Execution Gate](docs/LATTICRA_IDENTITY_REPLAY_IMPEDANCE_L4_BLINDED_HOLDOUT_EXECUTION_GATE.md), the [L5 Evidence Review](docs/LATTICRA_IDENTITY_REPLAY_IMPEDANCE_L5_BLINDED_HOLDOUT_ORACLE_EVIDENCE_REVIEW.md), the [Model-1 Dynamic Substrate Runner](docs/LATTICRA_IDENTITY_REPLAY_MODEL1_DYNAMIC_SUBSTRATE_RUNNER.md), the [Model-1 Bounded Range Falsifier](docs/LATTICRA_IDENTITY_REPLAY_MODEL1_BOUNDED_RANGE_FALSIFIER.md), the [Model-2 Hierarchical Substrate Pre-Registration](docs/LATTICRA_IDENTITY_REPLAY_MODEL2_HIERARCHICAL_SUBSTRATE_PREREGISTRATION.md), the [Model-2 Prediction Runner](docs/LATTICRA_IDENTITY_REPLAY_MODEL2_PREDICTION_RUNNER.md), the [Model-2 Prediction Failure Analysis](docs/LATTICRA_IDENTITY_REPLAY_MODEL2_PREDICTION_FAILURE_ANALYSIS.md), the [Model-3 Worthiness Gate](docs/LATTICRA_IDENTITY_REPLAY_MODEL3_WORTHINESS_GATE.md), the [Model-3 Topological Amplification Pre-Registration](docs/LATTICRA_IDENTITY_REPLAY_MODEL3_TOPOLOGICAL_AMPLIFICATION_PREREGISTRATION.md), the [Model-3 Prediction Runner](docs/LATTICRA_IDENTITY_REPLAY_MODEL3_PREDICTION_RUNNER.md), the [Model-3 Rejection Analysis](docs/LATTICRA_IDENTITY_REPLAY_MODEL3_REJECTION_ANALYSIS.md), the [Model-3 Failure Visual Suite](docs/LATTICRA_IDENTITY_REPLAY_MODEL3_FAILURE_VISUAL_SUITE.md), the [Refined Model-3 Pre-Registration](docs/LATTICRA_IDENTITY_REPLAY_MODEL3_REFINED_PREREGISTRATION.md), and the [Higgs Challenge One Page](docs/LATTICRA_HIGGS_CHALLENGE_ONE_PAGE.md). The original Latticra claim is identity-replay impedance: mass as the replay-stable cost for a projected localized identity to remain itself under substrate update, with Higgs treated as effective physics that a deeper substrate ledger must reproduce.
...
| Review the constrained substrate search | [L1 Constrained Search](docs/LATTICRA_IDENTITY_REPLAY_IMPEDANCE_L1_CONSTRAINED_SUBSTRATE_SEARCH.md) |
| Inspect the pre-registered holdout gate | [L2 Pre-Registered Holdout](docs/LATTICRA_IDENTITY_REPLAY_IMPEDANCE_L2_PREREGISTERED_SUBSTRATE_LAW_BLINDED_HOLDOUT.md) |
| Inspect the external holdout intake | [L3 Holdout Intake](docs/LATTICRA_IDENTITY_REPLAY_IMPEDANCE_L3_EXTERNAL_BLINDED_HOLDOUT_INTAKE.md) |
| Inspect the blinded holdout execution gate | [L4 Execution Gate](docs/LATTICRA_IDENTITY_REPLAY_IMPEDANCE_L4_BLINDED_HOLDOUT_EXECUTION_GATE.md) |
| Inspect the oracle evidence review | [L5 Evidence Review](docs/LATTICRA_IDENTITY_REPLAY_IMPEDANCE_L5_BLINDED_HOLDOUT_ORACLE_EVIDENCE_REVIEW.md) |
| Run the dynamic replay substrate split | [Model-1 Dynamic Substrate Runner](docs/LATTICRA_IDENTITY_REPLAY_MODEL1_DYNAMIC_SUBSTRATE_RUNNER.md) |
| Inspect the bounded Model-1 conclusion | [Model-1 Bounded Range Falsifier](docs/LATTICRA_IDENTITY_REPLAY_MODEL1_BOUNDED_RANGE_FALSIFIER.md) |
| Inspect the Model-2 range-capacity gate | [Model-2 Hierarchical Substrate Pre-Registration](docs/LATTICRA_IDENTITY_REPLAY_MODEL2_HIERARCHICAL_SUBSTRATE_PREREGISTRATION.md) |
| Inspect the first Model-2 prediction rejection | [Model-2 Prediction Runner](docs/LATTICRA_IDENTITY_REPLAY_MODEL2_PREDICTION_RUNNER.md) |
| Inspect the Model-2 failure shape | [Model-2 Prediction Failure Analysis](docs/LATTICRA_IDENTITY_REPLAY_MODEL2_PREDICTION_FAILURE_ANALYSIS.md) |
| Review the Model-3 admission gate | [Model-3 Worthiness Gate](docs/LATTICRA_IDENTITY_REPLAY_MODEL3_WORTHINESS_GATE.md) |
| Inspect the Model-3 capacity gate | [Model-3 Topological Amplification Pre-Registration](docs/LATTICRA_IDENTITY_REPLAY_MODEL3_TOPOLOGICAL_AMPLIFICATION_PREREGISTRATION.md) |
