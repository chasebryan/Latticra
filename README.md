...
- [`docs/L_UI_PARSER_STRING_ESCAPE_DIAGNOSTICS_CONTRACT.md`](docs/L_UI_PARSER_STRING_ESCAPE_DIAGNOSTICS_CONTRACT.md) — future parser-level invalid string escape diagnostics, diagnostic codes, source spans, messages, hints, and compatibility rules.
