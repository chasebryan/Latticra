...
- [`docs/L_UI_AST_LENGTH_CARRYING_STRING_STORAGE_CONTRACT.md`](docs/L_UI_AST_LENGTH_CARRYING_STRING_STORAGE_CONTRACT.md) — future explicit decoded byte lengths for L-UI AST purpose and text values before AST string storage is extended.
