...
| --- | --- |
| Edge edition checkpoint | `v0.2.0edge` |
| Current public estimate | Roughly 47% overall system planning estimate |
...
| Public documentation posture | Strong but still evolving; around 93% planning estimate |
| Latticra Seal | Local evidence, receipts, hybrid envelope self-tests, and denied-by-default runtime boundaries |
...
The latest mathematical estimate rebase is [`docs/status/CURRENT_ESTIMATE_MATHEMATICAL_REBASE_2026_05_27.md`](docs/status/CURRENT_ESTIMATE_MATHEMATICAL_REBASE_2026_05_27.md).
