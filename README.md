...
Latticra Seal
  ...
  Current posture: report-only runtime dry-run and guarded allowlist candidate-denial paths.
...
Do not publish exploit details, secrets, payloads, or private infrastructure information in public issues, pull requests, discussions, screenshots, logs, social posts, or comments.
