...
| Public/source consistency | Static HTML and public summaries match source Markdown. | HTML and Markdown are close but use different posture words. | Public HTML is stronger than source Markdown. | Changed HTML page, source Markdown, [`DOCUMENTATION_TRACEABILITY_MATRIX.md`](DOCUMENTATION_TRACEABILITY_MATRIX.md) |
