...
Status: Latticra Seal unsigned request case contract
Scope: case-specific contract after the unknown tool case fixture. This document does not implement runtime behavior, policy behavior, tool behavior, host behavior, network behavior, cryptographic behavior, signature verification, or authority grants.
