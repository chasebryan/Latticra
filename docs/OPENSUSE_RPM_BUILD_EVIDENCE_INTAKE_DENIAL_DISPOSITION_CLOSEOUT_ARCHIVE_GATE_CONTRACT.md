...
Scope: keep archive and re-request closed for the closed-out openSUSE RPM build-evidence intake denial while RPM validation promotion remains blocked.

## Purpose

This contract records the no-effect archive gate for the closed-out openSUSE RPM build-evidence intake denial disposition.

The goal is narrow: a closed-out denied build-evidence intake record is not archivable, re-requestable, promotable, or usable as openSUSE RPM validation evidence while the validation promotion blocker matrix remains closed.
...
## openSUSE Archive Gate

Current openSUSE RPM build-evidence intake denial archive gate remains closed:
...
openSUSE build, lint, artifact, payload, install/remove, OBS, submit-request, and official-package evidence remains denied, closed out, unarchived, unaccepted, and unusable as build-lane opening evidence.
...
The local RPM build gate remains closed. This archive gate contract only records that archive and re-request stay blocked after closeout while the validation promotion blocker matrix remains closed.
