...
Scope: user, operator, reviewer, contributor, packager, security reviewer, academic or presentation reader, subsystem implementer, public-site reader, and handbook reader routes.
...
| Academic or presentation reader | [`../build/presentation/latticra-motion/video/latticra-motion-presentation.mp4`](../build/presentation/latticra-motion/video/latticra-motion-presentation.mp4), [`../build/presentation/latticra-academic/video/latticra-academic-presentation.mp4`](../build/presentation/latticra-academic/video/latticra-academic-presentation.mp4), [`VISUAL_THEOREM_ENGINES.md`](VISUAL_THEOREM_ENGINES.md) | [`latticra-system-substrate/README.md`](latticra-system-substrate/README.md), [`FOUNDATION_INDEX.md`](FOUNDATION_INDEX.md) | Reader can watch the motion overview, then connect theorem-language claims back to source records. | Presentation wording outruns current status, source records, or non-claims. |
