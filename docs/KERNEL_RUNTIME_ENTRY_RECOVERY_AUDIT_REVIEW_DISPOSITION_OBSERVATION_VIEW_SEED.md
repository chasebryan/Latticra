...
observation view. It follows the recovery audit review observation view and
keeps the OS-readiness chain report-only.
...
The guard is
`scripts/test-kernel-runtime-entry-recovery-audit-review-disposition-observation-view.sh`.
The report runner is
`scripts/test-kernel-runtime-entry-recovery-audit-review-disposition-observation-view-report-runner.sh`.
