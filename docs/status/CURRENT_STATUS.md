...
```text
Signing authorization metadata implementation, with no signing, verification, private-key handling, host behavior, network behavior, capability enforcement, or runtime authority
```
