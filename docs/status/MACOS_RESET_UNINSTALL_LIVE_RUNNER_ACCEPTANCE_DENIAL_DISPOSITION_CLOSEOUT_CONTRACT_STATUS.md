...
Status: no-effect reset/uninstall live-runner acceptance-denial disposition closeout contract status
Date: 2026-05-26 CDT
Scope: status checkpoint after adding the macOS reset/uninstall live-runner acceptance-denial disposition closeout contract.
...
macos_reset_uninstall_live_runner_acceptance_denial_disposition_closeout_contract_guard_present=1
