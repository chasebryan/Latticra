...
```text
Latticra Seal now has a report-only runtime gate path, sealed report-envelope metadata, signature-request metadata, and core negative-test evidence for AI-era tool-boundary planning.
```
