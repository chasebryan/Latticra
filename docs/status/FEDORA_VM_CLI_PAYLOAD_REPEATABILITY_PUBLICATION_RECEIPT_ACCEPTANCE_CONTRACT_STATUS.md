# Fedora VM CLI Payload Repeatability Publication Receipt Acceptance Contract Status

Status: receipt acceptance contract/status alignment
Date: 2026-05-27
Scope: status record for the Fedora VM CLI payload repeatability publication receipt acceptance contract.

## Summary

Latticra now has a static acceptance contract for the future Fedora VM CLI payload repeatability publication receipt record.

The contract separates a valid receipt candidate from an accepted receipt.
