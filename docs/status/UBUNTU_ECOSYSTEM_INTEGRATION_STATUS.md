...
The Ubuntu Debian copyright notice mapping contract records that `packaging/ubuntu/debian/copyright` still needs a reviewed binary, documentation, third-party, generated-artifact, and NOTICE mapping before package notice promotion.
