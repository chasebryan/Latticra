...
The guarded follow-on is now the Model-3 Topological Amplification Pre-Registration, which passes the dynamic-range capacity gate and authorizes a prediction-only runner.
