...
That target should define the public API, semantic result structs, semantic error enum, diagnostic mapping, reports, rail checks, field checks, binding checks, text checks, and exact tests before semantic validation code.
