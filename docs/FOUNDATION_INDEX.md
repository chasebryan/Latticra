...
That target should decide whether `\x00` can become accepted now that AST storage has explicit lengths, and what parser diagnostic, AST, report, and compatibility rules are required.
