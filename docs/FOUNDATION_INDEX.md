...
That target should decide whether literal NUL bytes in source buffers remain permanently forbidden or receive their own length-aware source input policy.
