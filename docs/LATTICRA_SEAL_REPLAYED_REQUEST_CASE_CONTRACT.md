...
Status: Latticra Seal replayed request case contract
Scope: case-specific contract after the stale request case fixture. This document does not implement runtime behavior, policy behavior, tool behavior, host behavior, network behavior, cryptographic behavior, replay detection, or authority grants.
