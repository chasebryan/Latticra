...
**Edition:** Working Draft 0.16 — 2026-05-26<br>
**Role:** Project-level technical handbook for Latticra, Latticra Seal trust-boundary metadata, authority-neutral Ed25519 verification evidence, metadata-only capability/effect/handoff/report/envelope/signature-request/signing-operation classification and status guards, disposable Fedora VM CLI payload validation evidence, Latticra Console host/receipt/signature/OS/VM contract surfaces, Runtime Boundary Lat/LIR provenance records, Nucleus, Nadia Stage-47 contract-only offline-AI release/receipt/review/disposition metadata, Panel, platform install validation lanes, Lat/LIR contract surfaces, receipts, reports, and future runtime-boundary research.
...
- Nadia Stage-47 offline AI contract metadata
