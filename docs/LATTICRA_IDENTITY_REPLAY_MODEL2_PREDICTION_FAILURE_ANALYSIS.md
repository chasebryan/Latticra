...
The guarded follow-on is now the Model-3 Topological Amplification Pre-Registration, which locks the target-blind amplification law before target loading.
