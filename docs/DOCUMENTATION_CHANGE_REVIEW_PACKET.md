...
Scope: documentation-only changes that affect public wording, reader routes, product-facing pages, non-claims, status mirrors, platform posture, installer posture, package posture, subsystem landing pages, or documentation navigation.
