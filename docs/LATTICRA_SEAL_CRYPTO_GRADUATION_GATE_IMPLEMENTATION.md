...
The next valid Latticra Seal cryptographic slice is to carry crypto-graduation-gated signer invocation evidence into the signing operation and policy decision report chains as read-only evidence.
