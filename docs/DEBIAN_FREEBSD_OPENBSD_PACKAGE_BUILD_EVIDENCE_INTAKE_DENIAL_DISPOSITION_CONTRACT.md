# Debian, FreeBSD, and OpenBSD Package Build-Evidence Intake Denial Disposition Contract

Status: active package build-evidence intake denial disposition contract
Scope: define disposition of reviewed Debian, FreeBSD, and OpenBSD package build-evidence intake denial while the validation promotion blocker matrix is closed.

## Purpose

This contract records the no-effect disposition of a reviewed Debian, FreeBSD, and OpenBSD package build-evidence intake denial.

The goal is narrow: after denial review upholds the denial, this disposition closes that reviewed denial as no-effect and keeps re-request, build-lane opening, evidence acceptance, package validation promotion, and package readiness blocked.
...
package_build_evidence_intake_denial_disposition_contract_present=1
...
## Debian Denial Disposition

Current Debian build-evidence intake denial disposition closes the upheld denial:
...
Debian build evidence remains denied, closed, unaccepted, and unusable as build-lane opening evidence.

## FreeBSD Denial Disposition

Current FreeBSD build-evidence intake denial disposition closes the upheld denial:
...
FreeBSD ports evidence remains denied, closed, unaccepted, and unusable as build-lane opening evidence.

## OpenBSD Denial Disposition

Current OpenBSD build-evidence intake denial disposition closes the upheld denial:
...
OpenBSD ports evidence remains denied, closed, unaccepted, unusable as build-lane opening evidence, and unable to enable `PERMIT_PACKAGE`.
...
The package-build gate remains closed. This denial disposition contract only records that the reviewed denial was closed as an upheld no-effect disposition while the blocker matrix remains closed.
...
```sh
sh scripts/test-debian-freebsd-openbsd-package-build-evidence-intake-denial-disposition-contract.sh
```

Expected output:

```text
debian_freebsd_openbsd_package_build_evidence_intake_denial_disposition_contract: ok
```
