...
with deterministic fields for status, aggregate error, stage errors, module name, source length, validity, parser counts, model counts, transition source index metadata, no-effect flags, and source spans.
