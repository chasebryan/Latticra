...
require_contains 'required_promotion_items_total = 19u' latticra-q-seal/src/q_seal_ml_kem_ci_promotion_evidence.c
...
require_contains 'required_promotion_items_total=19' latticra-q-seal/docs/LATTICRA_Q_SEAL_ML_KEM_CI_PROMOTION_EVIDENCE.md
