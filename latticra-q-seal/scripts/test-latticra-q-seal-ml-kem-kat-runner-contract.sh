...
require_contains 'replay_transcript_gate_bound = 1u' latticra-q-seal/src/q_seal_ml_kem_kat_runner_contract.c
...
require_contains 'required_kat_runner_contract_items_total = 47u' latticra-q-seal/src/q_seal_ml_kem_kat_runner_contract.c
...
require_contains 'replay_transcript_gate_bound=1' latticra-q-seal/evidence/ML_KEM_KAT_RUNNER_CONTRACT.md
...
require_contains 'required_kat_runner_contract_items_total=47' latticra-q-seal/docs/LATTICRA_Q_SEAL_ML_KEM_KAT_RUNNER_CONTRACT.md
