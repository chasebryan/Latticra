...
const char *latticra_kernel_state_label(latticra_kernel_state_kind_t state) {
    switch (state) {
        ...
        case LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_OBSERVATION_VIEW_READY:
            return "runtime-entry-recovery-audit-review-observation-view-ready";
        case LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_OBSERVATION_VIEW_READY:
            return "runtime-entry-recovery-audit-review-disposition-observation-view-ready";
        case LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_OBSERVATION_VIEW_READY:
            return "runtime-entry-recovery-audit-review-disposition-review-observation-view-ready";
        case LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_CLOSEOUT_OBSERVATION_VIEW_READY:
            return "runtime-entry-recovery-audit-review-disposition-review-closeout-observation-view-ready";
        case LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_CLOSEOUT_ARCHIVE_GATE_OBSERVATION_VIEW_READY:
            return "runtime-entry-recovery-audit-review-disposition-review-closeout-archive-gate-observation-view-ready";
        case LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_CLOSEOUT_ARCHIVE_GATE_REVIEW_OBSERVATION_VIEW_READY:
            return "runtime-entry-recovery-audit-review-disposition-review-closeout-archive-gate-review-observation-view-ready";
        case LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_OBSERVATION_VIEW_READY:
            return "runtime-entry-recovery-audit-review-disposition-review-closeout-archive-gate-review-disposition-observation-view-ready";
        case LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_OBSERVATION_VIEW_READY:
            return "runtime-entry-recovery-audit-review-disposition-review-closeout-archive-gate-review-disposition-closeout-observation-view-ready";
        case LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_OBSERVATION_VIEW_READY:
            return "runtime-entry-recovery-audit-review-disposition-review-closeout-archive-gate-review-disposition-closeout-archive-gate-observation-view-ready";
        default:
            return "unknown";
    }
}
...
static int is_allowed_transition(
    ...
    if (current_state == LATTICRA_KERNEL_STATE_SCHEDULER_HANDOFF_READY &&
        target_state == LATTICRA_KERNEL_STATE_SCHEDULER_ACTIVATION_READY) return 1;
    if (current_state == LATTICRA_KERNEL_STATE_SCHEDULER_ACTIVATION_READY &&
        target_state == LATTICRA_KERNEL_STATE_SCHEDULER_RUN_ENTRY_READY) return 1;
    if (current_state == LATTICRA_KERNEL_STATE_SCHEDULER_RUN_ENTRY_READY &&
    ...
    if (current_state == LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_OBSERVATION_VIEW_READY &&
        target_state == LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_OBSERVATION_VIEW_READY) return 1;
    if (current_state == LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_OBSERVATION_VIEW_READY &&
        target_state == LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_OBSERVATION_VIEW_READY) return 1;
    if (current_state == LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_OBSERVATION_VIEW_READY &&
        target_state == LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_OBSERVATION_VIEW_READY) return 1;
    if (current_state == LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_OBSERVATION_VIEW_READY &&
        target_state == LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_CLOSEOUT_OBSERVATION_VIEW_READY) return 1;
    if (current_state == LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_CLOSEOUT_OBSERVATION_VIEW_READY &&
        target_state == LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_CLOSEOUT_ARCHIVE_GATE_OBSERVATION_VIEW_READY) return 1;
    if (current_state == LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_CLOSEOUT_ARCHIVE_GATE_OBSERVATION_VIEW_READY &&
        target_state == LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_CLOSEOUT_ARCHIVE_GATE_REVIEW_OBSERVATION_VIEW_READY) return 1;
    if (current_state == LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_CLOSEOUT_ARCHIVE_GATE_REVIEW_OBSERVATION_VIEW_READY &&
        target_state == LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_OBSERVATION_VIEW_READY) return 1;
    if (current_state == LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_OBSERVATION_VIEW_READY &&
        target_state == LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_OBSERVATION_VIEW_READY) return 1;
    if (current_state == LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_OBSERVATION_VIEW_READY &&
        target_state == LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_DISPOSITION_REVIEW_CLOSEOUT_ARCHIVE_GATE_REVIEW_DISPOSITION_CLOSEOUT_ARCHIVE_GATE_OBSERVATION_VIEW_READY) return 1;
    return 0;
}
...
static int state_requires_scheduler_activation(latticra_kernel_state_kind_t state) {
    return state >= LATTICRA_KERNEL_STATE_SCHEDULER_ACTIVATION_READY;
}

static int state_requires_scheduler_run_entry(latticra_kernel_state_kind_t state) {
    return state >= LATTICRA_KERNEL_STATE_SCHEDULER_RUN_ENTRY_READY;
}

static int state_requires_runtime_entry_admission(
    latticra_kernel_state_kind_t state) {
    return state >= LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_ADMISSION_READY;
}
...
static int state_requires_runtime_entry_recovery_audit_review_observation_view(
    latticra_kernel_state_kind_t state) {
    return state >=
        LATTICRA_KERNEL_STATE_RUNTIME_ENTRY_RECOVERY_AUDIT_REVIEW_OBSERVATION_VIEW_READY;
}

static int state_requires_runtime_entry_recovery_audit_review_disposition_observation_view(
    latticra_kernel_state_kind_t state) {
    return state >=
...
static int
state_requires_runtime_entry_recovery_audit_review_disposition_review_observation_view(
    latticra_kernel_state_kind_t state) {
    return state >=
...
static int
state_requires_runtime_entry_recovery_audit_review_disposition_review_closeout_observation_view(
    latticra_kernel_state_kind_t state) {
    return state >=
...
static int
state_requires_runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_observation_view(
    latticra_kernel_state_kind_t state) {
    return state >=
...
static int
state_requires_runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_observation_view(
    latticra_kernel_state_kind_t state) {
    return state >=
...
static int
state_requires_runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_observation_view(
    latticra_kernel_state_kind_t state) {
    return state >=
...
static int
state_requires_runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_closeout_observation_view(
    latticra_kernel_state_kind_t state) {
    return state >=
...
static int
state_requires_runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_closeout_archive_gate_observation_view(
    latticra_kernel_state_kind_t state) {
    return state >=
...
latticra_status_t latticra_kernel_state_transition(
    ...
    latticra_kernel_runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_closeout_archive_gate_observation_view_request_t
        runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_closeout_archive_gate_observation_view_request;
    ...
    scheduler_activation_request = request->scheduler_activation_request;
    scheduler_activation_request.scheduler_handoff_request =
        scheduler_handoff_request;
    scheduler_run_entry_request = request->scheduler_run_entry_request;
    scheduler_run_entry_request.scheduler_activation_request =
        scheduler_activation_request;
    runtime_entry_admission_request = request->runtime_entry_admission_request;
    runtime_entry_admission_request.scheduler_run_entry_request =
        scheduler_run_entry_request;
    ...
    if (state_requires_scheduler_activation(request->target_state)) {
        scheduler_activation_request.scheduler_handoff_request =
            scheduler_handoff_request;
        status = latticra_kernel_scheduler_activation_evaluate(
            &scheduler_activation_request, &result->scheduler_activation);
        if (status != LATTICRA_STATUS_OK) {
            result->status = status;
            state_copy(result->state_status, sizeof(result->state_status),
    ...
    if (state_requires_scheduler_run_entry(request->target_state)) {
        scheduler_run_entry_request.scheduler_activation_request =
            scheduler_activation_request;
        status = latticra_kernel_scheduler_run_entry_evaluate(
            &scheduler_run_entry_request, &result->scheduler_run_entry);
        if (status != LATTICRA_STATUS_OK) {
            result->status = status;
            state_copy(result->state_status, sizeof(result->state_status),
                "scheduler-run-entry-not-ready");
            state_copy(result->transition_status, sizeof(result->transition_status), "blocked");
            return status;
        }
    ...
    if (state_requires_runtime_entry_admission(request->target_state)) {
        runtime_entry_admission_request.scheduler_run_entry_request =
            scheduler_run_entry_request;
    ...
    if (state_requires_runtime_entry_frame(request->target_state)) {
        runtime_entry_frame_request.runtime_entry_admission_request =
            runtime_entry_admission_request;
        status = latticra_kernel_runtime_entry_frame_evaluate(
            &runtime_entry_frame_request,
            &result->runtime_entry_frame);
        if (status != LATTICRA_STATUS_OK) {
            result->status = status;
            state_copy(result->state_status, sizeof(result->state_status),
                "runtime-entry-frame-not-ready");
            state_copy(result->transition_status, sizeof(result->transition_status), "blocked");
            return status;
        }
        result->runtime_entry_admission =
    ...
    if (state_requires_runtime_entry_recovery_audit_review_observation_view(
            request->target_state)) {
        runtime_entry_recovery_audit_review_observation_view_request.
            runtime_entry_recovery_audit_observation_view_request =
            runtime_entry_recovery_audit_observation_view_request;
        status =
            latticra_kernel_runtime_entry_recovery_audit_review_observation_view_evaluate(
                &runtime_entry_recovery_audit_review_observation_view_request,
                &result->runtime_entry_recovery_audit_review_observation_view);
        if (status != LATTICRA_STATUS_OK) {
            result->status = status;
            state_copy(result->state_status, sizeof(result->state_status),
                "runtime-entry-recovery-audit-review-observation-view-not-ready");
            state_copy(result->transition_status,
                sizeof(result->transition_status), "blocked");
            return status;
        }
    ...
    if (state_requires_runtime_entry_recovery_audit_review_disposition_observation_view(
            request->target_state)) {
        runtime_entry_recovery_audit_review_disposition_observation_view_request.
            runtime_entry_recovery_audit_review_observation_view_request =
            runtime_entry_recovery_audit_review_observation_view_request;
    ...
    if (state_requires_runtime_entry_recovery_audit_review_disposition_review_observation_view(
            request->target_state)) {
        runtime_entry_recovery_audit_review_disposition_review_observation_view_request.
            runtime_entry_recovery_audit_review_disposition_observation_view_request =
            runtime_entry_recovery_audit_review_disposition_observation_view_request;
    ...
    if (state_requires_runtime_entry_recovery_audit_review_disposition_review_closeout_observation_view(
            request->target_state)) {
        runtime_entry_recovery_audit_review_disposition_review_closeout_observation_view_request.
            runtime_entry_recovery_audit_review_disposition_review_observation_view_request =
            runtime_entry_recovery_audit_review_disposition_review_observation_view_request;
    ...
    if (state_requires_runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_observation_view(
            request->target_state)) {
        runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_observation_view_request.
            runtime_entry_recovery_audit_review_disposition_review_closeout_observation_view_request =
            runtime_entry_recovery_audit_review_disposition_review_closeout_observation_view_request;
    ...
    if (state_requires_runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_observation_view(
            request->target_state)) {
        runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_observation_view_request.
            runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_observation_view_request =
            runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_observation_view_request;
    ...
    if (state_requires_runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_observation_view(
            request->target_state)) {
        runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_observation_view_request.
            runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_observation_view_request =
            runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_observation_view_request;
    ...
    if (state_requires_runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_closeout_observation_view(
            request->target_state)) {
        runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_closeout_observation_view_request.
            runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_observation_view_request =
            runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_observation_view_request;
    ...
    if (state_requires_runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_closeout_archive_gate_observation_view(
            request->target_state)) {
        runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_closeout_archive_gate_observation_view_request.
            runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_closeout_observation_view_request =
            runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_closeout_observation_view_request;
        status =
            latticra_kernel_runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_closeout_archive_gate_observation_view_evaluate(
                &runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_closeout_archive_gate_observation_view_request,
                &result->runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_closeout_archive_gate_observation_view);
        if (status != LATTICRA_STATUS_OK) {
            result->status = status;
            state_copy(result->state_status, sizeof(result->state_status),
                "runtime-entry-recovery-audit-review-disposition-review-closeout-archive-gate-review-disposition-closeout-archive-gate-observation-view-not-ready");
            state_copy(result->transition_status,
                sizeof(result->transition_status), "blocked");
            return status;
        }
...
latticra_status_t latticra_kernel_state_report(
    ...
    written = snprintf(buffer, buffer_len,
        ...
        "runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_closeout_archive_gate_observation_view_status=%s\n"
        "evidence_level=%u\n",
        result->state_status,
        result->gate_status,
        ...
        result->runtime_entry_recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_closeout_archive_gate_observation_view.
            recovery_audit_review_disposition_review_closeout_archive_gate_review_disposition_closeout_archive_gate_observation_view_status,
