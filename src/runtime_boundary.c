    ...
    for (index = 0u; index < lir->edge_count && index < LATTICRA_LIR_EDGE_MAX; index++) {
        if (result->record.lat_lir_has_first_edge == 0) {
            ...
            if (lir->edges[index].from_index < lir->node_count &&
                ...
                result->record.lat_lir_first_edge_from_node_parent_index = lir->nodes[from_index].parent_index;
                result->record.lat_lir_first_edge_from_node_first_child_index = lir->nodes[from_index].first_child_index;
                result->record.lat_lir_first_edge_from_node_child_count = lir->nodes[from_index].child_count;
            ...
            if (lir->edges[index].to_index < lir->node_count &&
                ...
                result->record.lat_lir_first_edge_to_node_parent_index = lir->nodes[to_index].parent_index;
                result->record.lat_lir_first_edge_to_node_first_child_index = lir->nodes[to_index].first_child_index;
                result->record.lat_lir_first_edge_to_node_child_count = lir->nodes[to_index].child_count;
...
latticra_status_t latticra_runtime_boundary_report(const latticra_runtime_boundary_result_t *result, char *buffer, size_t buffer_len) {
    ...
    extra = snprintf(buffer + used, buffer_len - used,
        ...
        (unsigned long)result->record.lat_lir_first_edge_from_node_parent_index,
        (unsigned long)result->record.lat_lir_first_edge_from_node_first_child_index,
        (unsigned long)result->record.lat_lir_first_edge_from_node_child_count,
        ...
        (unsigned long)result->record.lat_lir_first_edge_to_node_parent_index,
        (unsigned long)result->record.lat_lir_first_edge_to_node_first_child_index,
        (unsigned long)result->record.lat_lir_first_edge_to_node_child_count,
